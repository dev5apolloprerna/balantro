        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-x-8 gap-y-8 lg:gap-y-0 items-start py-4">
            ...
            <div class="lg:col-span-2" data-aos="fade-up" data-aos-delay="300">
                ...
                <ul class="space-y-3 text-sm">
                    <li>
                        <a href="{{ route('company') }}" class="text-black hover:translate-x-1 transition-all block py-1 font-medium">About
                            Us</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('company') }}#how-we-work"
                    ...
                    <li>
                        <a href="{{ route('faqs') }}" class="text-black hover:translate-x-1 transition-all block py-1 font-medium">FAQs</a>
                    </li>
                    <li>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full pb-2">
        <div class="w-full relative z-20">
            ...
            <div class="flex gap-6 mb-4 text-[11px] font-bold text-black/90">
                ...
                <a href="{{ route('privacypolicy') }}" class="hover:underline">Privacy Policy <sup class="text-[8px] font-bold">+</sup></a>
