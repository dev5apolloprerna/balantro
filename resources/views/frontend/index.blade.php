...
<div id="intro-overlay">
    ...
    <div class="intro-container" id="intro-container">
        <img src="images/Balantro%20logo%20final%20deliverables_Only%20Black.png" alt="Balantro" class="intro-logo-img" />
...
<div class="main-stack-wrapper">
              ...
              <span data-aos="zoom-in"
                ...
                Balantro 2.0
                    ...
                    <h1
                        ...
                        <span class="title-gradient animate-gradient-text">We'll Handle the Rest.</span>
                    </h1>

                    <p class="text-lg md:text-xl text-slate-300 mb-8 max-w-2xl leading-relaxed animate-fade-in-up delay-200">
                        <!-- Structured financial clarity delivered consistently. Not just software, but a complete system
                        running your books. -->
                        From bookkeeping to filings, From GST to compliance. Balantro manages your entire financial operations so
                        you can stay focused on what actually grows your business.
                    </p>
                ...
                <div
                    ...
                    <div
                            ...
                            <div class="owl-transform-wrapper drop-shadow-[0_0_30px_rgba(14,165,233,0.6)]">
                                <svg width="200" height="200" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <g class="animate-svg-wing-left" transform-origin="100 100">
                                        <path d="M40 80 C20 60 10 90 20 120 C30 140 60 130 80 110" fill="url(#wingGradient)"
                                            stroke="#38bdf8" stroke-width="1" opacity="0.8" />
                                    </g>
                                    <g class="animate-svg-wing-right" transform-origin="100 100">
                                        <path d="M160 80 C180 60 190 90 180 120 C170 140 140 130 120 110" fill="url(#wingGradient)"
                                            stroke="#38bdf8" stroke-width="1" opacity="0.8" />
                                    </g>

                                    <!-- Body Shape -->
                                    <defs>
                                        <linearGradient id="bodyGradient" x1="100" y1="40" x2="100" y2="160"
                                        ...
                                        <radialGradient id="eyeGlow" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse"
                                    ...
                                    <!-- Chest Plate Details -->
                                    <path d="M80 120 L100 140 L120 120" stroke="#38bdf8" stroke-width="1" fill="none"
                                        class="animate-pulse" />
                                    <path d="M85 110 L100 125 L115 110" stroke="#38bdf8" stroke-width="1" opacity="0.5" fill="none" />

                                    <!-- Head/Face -->
                                    <path d="M70 60 L60 40 L85 55" fill="#0f172a" stroke="#38bdf8" stroke-width="1" />
                                    <!-- Left Ear -->
                                    <path d="M130 60 L140 40 L115 55" fill="#0f172a" stroke="#38bdf8" stroke-width="1" />
                                    <!-- Right Ear -->

                                    <!-- Eyes -->
                                    <circle cx="85" cy="85" r="12" fill="#02040a" stroke="#38bdf8" stroke-width="2" />
                                    <circle cx="115" cy="85" r="12" fill="#02040a" stroke="#38bdf8" stroke-width="2" />

                                    <!-- Glowing Pupils -->
                                    <circle cx="85" cy="85" r="5" fill="#22d3ee" class="animate-cyber-blink" />
                                    <circle cx="115" cy="85" r="5" fill="#22d3ee" class="animate-cyber-blink" />
                        ...
                        <div class="animate-mobile-sequence w-[260px] md:w-[300px] h-[540px] md:h-[620px] relative z-10">
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <div class="mb-8">
                                            ...
                                            <!-- Row 1 -->
                                            <div class="flex items-center justify-between mb-3 group cursor-pointer animate-mobile-row">
                                    ...
                                    <!-- Dynamic Pill -->
                                    <div class="absolute top-0 left-1/2 transform -translate-x-1/2 h-6 w-32 bg-black rounded-b-xl z-20">
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <section id="section-intelligence-reveal" class="scroll-section flex-col relative bg-[#02040a]">
        ...
        <div class="absolute inset-0 z-0">
            ...
            <div
                class="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-balantro-secondary/10 blur-[160px] rounded-full animate-float-slow"
        ...
        <div class="max-w-6xl mx-auto px-4 relative z-10 text-center">
            <div class="animate-on-entry">
                <h2 class="font-display text-5xl md:text-7xl lg:text-8xl font-bold tracking-tighter leading-[1.1]">
                    ...
                    <span class="animate-from-bottom block title-gradient animate-gradient-text pb-4">into clear financial
                        intelligence.</span>
                </h2>
                <div class="mt-12 flex justify-center">
                    <div class="w-px h-24 bg-gradient-to-b from-balantro-secondary to-transparent animate-bounce"></div>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="group relative animate-from-bottom will-change-transform">
                    ...
                    <div
                        ...
                        <p class="text-slate-400 leading-relaxed font-medium">
                            Send documents via WhatsApp, email, or portal. Instant sync. Zero friction. Total security.
                        </p>
                        <!-- <div
                ...
                <div class="group relative animate-from-bottom will-change-transform">
                    ...
                    <div
                        ...
                        <p class="text-slate-400 leading-relaxed font-medium">
                            AI sorts every transaction. Our experts verify it. 100% accuracy. Every time.
                        </p>
                        <!-- <div
                ...
                <div class="group relative animate-from-bottom will-change-transform">
                    ...
                    <div
                        ...
                        <p class="text-slate-400 leading-relaxed font-medium">
                            Real-time sales, margins, and cash flow on any device, anywhere, anytime.
                        </p>
                        <!-- <div
                ...
                <div class="group relative animate-from-bottom will-change-transform">
                    ...
                    <div
                        ...
                        <p class="text-slate-400 leading-relaxed font-medium">
                            Monthly MIS reports that don't just show numbers they explain what to do next.
                        </p>
                        <!-- <div
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center animate-on-entry">
            ...
            Product Experience
                ...
                <h2
                    ...
                    <span
                        class="inline-block py-1 text-transparent bg-clip-text bg-gradient-to-r from-balantro-secondary to-white">One
                        Clean View.</span>
                </h2>
            </div>
            ...
            <div class="relative max-w-4xl mx-auto group animate-from-bottom">
                <!-- Border Glow -->
                <div class="absolute -inset-[1px] bg-gradient-to-b from-white/20 to-transparent rounded-2xl blur-sm"></div>
                ...
                <div
                    ...
                    <img src="images/video_poster.png" alt="Balantro Dashboard Video"
    ...
    <section id="section-why-choose" class="scroll-section flex-row items-stretch relative bg-[#0a0f1c]">
        ...
        <div class="hidden md:block w-1/2 h-full relative overflow-hidden group animate-from-left">
            <!-- Parallax Background -->
            <img src="images/why_us_stadium.png" alt="State of the art financial management"
        ...
        <div class="w-full md:w-1/2 relative z-10 p-8 lg:p-12 flex flex-col justify-center animate-from-right">
            ...
            <span
              ...
              The Balantro Advantage
                ...
                <p class="text-slate-400 text-base max-w-lg leading-relaxed">
                    Most businesses don't need more software. They need a system that actually works with real experts behind
                    it.
                </p>
            </div>
            ...
            <div class="space-y-6 lg:space-y-8 relative z-20">
                ...
                <div class="flex gap-6 group cursor-default" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-white mb-2 group-hover:text-balantro-secondary transition-colors">
                            Accounting-First, Always
                        </h3>

                        <p class="text-slate-400 text-sm leading-relaxed max-w-sm">
                            Clean books before everything else. Accurate numbers mean stress-free audits, confident decisions, and
                ...
                <div class="flex gap-6 group cursor-default" data-aos="fade-up" data-aos-delay="300">
                    <div class="relative flex-shrink-0 w-14 h-14">
                        <div
                            class="absolute inset-0 bg-balantro-primary/20 rounded-2xl blur-lg group-hover:bg-balantro-primary/40 transition-all duration-500 animate-pulse"
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-white mb-2 group-hover:text-balantro-primary transition-colors">
                            We Own the Outcome.
                        </h3>

                        <p class="text-slate-400 text-sm leading-relaxed max-w-sm">
                            We don't advise and disappear. We execute, follow up, and fix without you having to chase anyone.
                        </p>
                    </div>
                </div>
                <!-- Item 3 -->
                <div class="flex gap-6 group cursor-default" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <div>
                        ...
                        <p class="text-slate-400 text-sm leading-relaxed max-w-sm">
                            AI handles the speed. Our experts handle the judgment. You get the best of both without managing
                            either.
                        </p>
                    </div>
                </div>
                ...
                <div class="flex gap-6 group cursor-default" data-aos="fade-up" data-aos-delay="500">
                    ...
                    <div>
                        ...
                        <p class="text-slate-400 text-sm leading-relaxed max-w-sm">
                            Your finances don't depend on one person's memory. Our system runs seamlessly even when teams change.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <section class="scroll-section flex-col relative !bg-[#889EB5]">
        ...
        <div class="absolute inset-0 z-0">
            <img src="images/chain_link.png" alt="Services background"
            ...
            <div class="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
                <div>
                    ...
                    <p class="text-[#334155] max-w-xl text-lg font-medium" data-aos="fade-up" data-aos-delay="100">
                        One system. Your Complete financial control.
                    </p>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div data-aos="fade-up" data-aos-delay="300"
                    ...
                    <p class="text-[#334155] leading-relaxed mb-8 font-medium">
                        Your numbers, clean and current every single day.
                    </p>
                ...
                <div data-aos="fade-up" data-aos-delay="400"
                    ...
                    <p class="text-[#334155] leading-relaxed mb-8 font-medium">
                        Every filing. Every deadline. Zero penalties.
                    </p>
                    <ul class="space-y-2 text-sm text-[#475569] font-medium">
                        <li class="flex items-center gap-2">
                            <div class="w-1.5 h-1.5 rounded-full bg-[#0f172a]"></div>
                ...
                <div data-aos="fade-up" data-aos-delay="500"
                    ...
                    <h3 class="text-2xl font-bold text-[#0f172a] mb-4">
                        Financial Reports<br />& Insights
                    </h3>
                    <p class="text-[#334155] leading-relaxed mb-8 font-medium">
                        Stop guessing. Start deciding with real numbers.
                    </p>
                    <ul class="space-y-2 text-sm text-[#475569] font-medium">
                        <li class="flex items-center gap-2">
                            <div class="w-1.5 h-1.5 rounded-full bg-[#0f172a]"></div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 animate-on-entry">
            <div class="text-center mb-20">
                <h2 class="font-display text-4xl md:text-5xl font-bold text-white mb-8" data-aos="fade-up">
                    ...
                    <span class="text-slate-500">Experts Who Decide.</span>
                </h2>
                ...
                <div class="flex items-center justify-center gap-8" data-aos="fade-up" data-aos-delay="200">
                    <span
                        ...
                        Efficiency through automation.</span>
                    ...
                    <span
                        ...
                        Accuracy through accountability.</span>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-10 gap-x-12 text-left">
                ...
                <div class="flex gap-6 group">
                    ...
                    <div>
                        <h4 class="text-lg font-bold text-white mb-2 group-hover:text-balantro-secondary transition-colors">
                            Centralized Collection
                        </h4>
                        <p class="text-sm text-slate-400 leading-relaxed">
                            One place for everything.
                            App, Web Portal, or WhatsApp documents reach us instantly, securely, and without follow-up.
                        </p>
                    </div>
                </div>
                ...
                <div class="flex gap-6 group">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-400 leading-relaxed">
                            AI sorts. Experts confirm.
                            Every transaction is categorized by ML and verified by our team. Zero errors accepted.
                        </p>
                    </div>
                </div>
                ...
                <div class="flex gap-6 group">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-400 leading-relaxed">
                            No step skipped. Ever.
                            Every task follows a fixed path so quality never depends on who is working.
                        </p>
                    </div>
                </div>
                ...
                <div class="flex gap-6 group">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-400 leading-relaxed">
                            Two eyes on everything critical.
                            Maker-Checker controls on every key transaction. Because accuracy is non-negotiable.
                        </p>
                    </div>
                </div>
                ...
                <div class="flex gap-6 group">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-400 leading-relaxed">
                            Report built for action.
                            Real time dashboard reveal trends, bottlenecks and business opportunities with clarity.
                        </p>
                    </div>
                </div>
                ...
                <div class="flex gap-6 group">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-400 leading-relaxed">
                            ...
                            Enterprise based encryption on every file and every transfer. Always protected.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <section class="scroll-section flex-col border-y border-white/20 !bg-[#0f1d3a] relative">
        ...
        <div
            ...
            <h2
                class="font-display text-2xl md:text-3xl font-bold text-white mb-16 tracking-wide uppercase text-center w-full"
                data-aos="fade-up">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-y-12 gap-x-0 text-center">
                <div class="group relative px-2 sm:px-6 border-r border-white/10">
                    <div
                        class="text-5xl md:text-6xl font-bold font-display text-transparent bg-clip-text bg-gradient-to-b from-white to-slate-500 mb-4 group-hover:text-balantro-secondary transition-colors duration-500 stat-number"
                        data-target="250">
                        0
                    </div>
                ...
                <div class="group relative px-2 sm:px-6 md:border-r border-white/10">
                    <div
                        class="text-5xl md:text-6xl font-bold font-display text-transparent bg-clip-text bg-gradient-to-b from-white to-slate-500 mb-4 group-hover:text-balantro-secondary transition-colors duration-500 animate-pulse stat-number"
                        data-target="10000">
                        0
                    </div>
    ...
    <section class="scroll-section flex-row items-stretch relative bg-balantro-navy">
            ...
            <span
              ...
              Client Success Stories
                ...
                <h2 class="font-display text-2xl lg:text-3xl font-bold text-white mb-3 leading-tight">
                    What We Deliver <br />
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-white to-slate-400">for Clients</span>
                </h2>
                ...
                <div
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <div class="text-xs text-balantro-secondary uppercase tracking-widest font-semibold opacity-80">
                ...
                <div
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <div class="text-xs text-balantro-primary uppercase tracking-widest font-semibold opacity-80">
                                E-commerce Founder
                            </div>
                        </div>
                    </div>
        ...
        <div class="w-full md:w-1/2 h-full md:h-full relative overflow-hidden group animate-from-right">
            <!-- Parallax Background -->
            <img src="images/deliverables_goal.png" alt="Client success results"
                class="absolute inset-0 w-full h-full object-cover transform scale-105 transition-transform duration-[3s] group-hover:scale-100 opacity-100 object-center" />
    ...
    <section class="scroll-section flex-col relative">
        ...
        <div
            class="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(34,211,238,0.15),transparent_70%)] z-0 animate-pulse"
            style="animation-duration: 4s"></div>
        <div class="absolute inset-0 opacity-30 z-0" style="
        ...
        <div class="max-w-6xl mx-auto px-4 text-center relative z-10 animate-on-entry">
            ...
            <p class="text-lg md:text-xl text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed" data-aos="fade-up"
                data-aos-delay="100">
                Balantro handles your books, compliance and reports so that you can focus on what truly matters - "Growth"
            </p>

            <div class="flex flex-col sm:flex-row gap-6 justify-center items-center" data-aos="fade-up"
                data-aos-delay="200">
                <a href="#"
                    class="w-full sm:w-auto px-12 py-6 rounded-full bg-gradient-to-r from-balantro-secondary to-balantro-primary text-balantro-navy font-bold text-xl transition-all hover:brightness-110 hover:scale-105 shadow-[0_0_40px_rgba(34,211,238,0.4)]">
                    Talk to Our Team
                </a>
                <!-- <a href="#"
            ...
            <svg class="w-6 h-6 text-balantro-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                mm.add("(min-width: 769px)", () => {
                    const masterTL = gsap.timeline({
                        scrollTrigger: {
                            ...
                            start: "top top",
                            end: () => `+=${sections.length * 150}%`, // Reduced scroll length for quicker transitions
                            pin: true,
                                        ...
                                        counter, {
                                            ...
                                            onUpdate: () => {
                                                if (target === 10000) {
                                                    ...
                                                    num.innerText = Math.round(counter.value) + "%";
                                                } else if (target === 250) {
                                                    num.innerText = Math.round(counter.value) + "+";
                                                } else {
                                                    num.innerText = Math.round(counter.value);
