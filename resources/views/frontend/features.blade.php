    ...
    <section class="flex flex-col w-full overflow-hidden relative z-10">
        ...
        <div class="inner-section-vh relative flex flex-col lg:flex-row group w-full bg-[#0a0f1c]" data-aos="fade-up">
            ...
            <div class="lg:absolute lg:top-0 lg:bottom-0 lg:left-0 lg:w-1/2 h-[400px] lg:h-auto z-0 overflow-hidden">
                ...
                <img src="{{ asset('images/feature_document_flow_1772037567784.png') }}" alt="Document Flow"
        ...
        <div class="inner-section-vh relative flex flex-col lg:flex-row group w-full bg-[#02040a]" data-aos="fade-up">
            ...
            <div
                ...
                <img src="{{ asset('images/feature_accounting_1772037717788.png') }}" alt="Accounting Workflow"
                    class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
            </div>
        ...
        <div class="inner-section-vh relative flex flex-col lg:flex-row group w-full bg-[#0a0f1c]" data-aos="fade-up">
            ...
            <div class="lg:absolute lg:top-0 lg:bottom-0 lg:left-0 lg:w-1/2 h-[400px] lg:h-auto z-0 overflow-hidden">
                ...
                <img src="{{ asset('images/feature_compliance_1772037926108.png') }}" alt="Compliance Tracking"
                    class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
            </div>
        ...
        <div class="inner-section-vh relative flex flex-col lg:flex-row group w-full bg-[#02040a]" data-aos="fade-up">
            ...
            <div
                ...
                <img src="{{ asset('images/feature_review_1772038721625.png') }}" alt="Review System"
                    class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
            </div>
        ...
        <div class="inner-section-vh relative flex flex-col lg:flex-row group w-full bg-[#0a0f1c]" data-aos="fade-up">
            ...
            <div class="lg:absolute lg:top-0 lg:bottom-0 lg:left-0 lg:w-1/2 h-[400px] lg:h-auto z-0 overflow-hidden">
                ...
                <img src="{{ asset('images/feature_reporting_1772038110744.png') }}" alt="Reporting and Insights"
                    class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
            </div>
        ...
        <div class="inner-section-vh relative flex flex-col lg:flex-row group w-full bg-[#02040a]" data-aos="fade-up">
            ...
            <div
                ...
                <img src="{{ asset('images/feature_security_1772038463975.png') }}" alt="Secure Access"
                    class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
            </div>
