...
<section class="inner-hero-vh relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 flex flex-col items-center text-center">
        ...
        <h1
            ...
            Built on Intelligence. <br class="hidden sm:block" />
        ...
        <p
            ...
            Beyond bookkeeping lies a better way to run your business.<br>
            <span class="text-white font-medium">We build financial systems that bring clarity, control, and
                confidence.</span>
        </p>
                ...
                <div class="lg:col-span-6 flex flex-col gap-8" data-aos="fade-left">
                    ...
                    <div
                        ...
                        <ul class="space-y-4">
                            <li class="flex items-start gap-4">
                                <svg class="w-6 h-6 text-balantro-secondary shrink-0" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                            ...
                            <li class="flex items-start gap-4">
                                ...
                                <span class="text-slate-300 text-base">Compliance should run quietly in the background</span>
                            </li>
                            <li class="flex items-start gap-4">
                                <svg class="w-6 h-6 text-balantro-secondary shrink-0" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                  ...
                  Methodology
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4">
                            <div class="flex items-center gap-3 text-slate-300 p-3 rounded-lg bg-black/40 border border-white/5">
                            ...
                            <div class="flex items-center gap-3 text-slate-300 p-3 rounded-lg bg-black/40 border border-white/5">
                                <span class="text-emerald-400 font-bold shrink-0">➔</span>
                                <span class="text-sm font-medium">We act as your Partner</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="w-full px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          Our Delivery Model
            ...
            <div class="relative w-full max-w-7xl mx-auto text-left" data-aos="fade-up" data-aos-delay="100">
                ...
                <div
                    class="mt-24 p-px bg-gradient-to-r from-transparent via-[#fbbf24]/30 to-transparent rounded-3xl max-w-4xl mx-auto"
                    data-aos="fade-up" data-aos-delay="200">
