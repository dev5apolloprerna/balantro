...
<section class="inner-hero-vh relative overflow-hidden">
    <div class="absolute inset-0 z-0 bg-[#02040a]">
        ...
        <div
            class="absolute top-1/4 left-1/4 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-[#fbbf24]/20 rounded-full blur-[120px] pointer-events-none animate-pulse"
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="space-y-16">
                ...
                <div data-aos="fade-up">
                    <h3 class="text-2xl font-display font-bold text-[#fbbf24] mb-8 border-b border-white/10 pb-4">Getting
                        Started</h3>
                    <div class="space-y-6">
                        ...
                        <div
                            ...
                            <p class="text-slate-400 text-sm leading-relaxed">
                                If you struggle with maintaining clean books, experience delays in monthly closing, or feel uncertain
                                about your financial accuracy despite having a team, virtual accounting provides the structure and
                                oversight you need.
                            </p>
                        </div>
                        ...
                        <div
                            ...
                            <p class="text-slate-400 text-sm leading-relaxed">
                                Yes. The transition is designed to be seamless. We handle the handover process, data migration, and
                                initial auditing to ensure continuity without disrupting your ongoing business operations.
                            </p>
                        </div>
                ...
                <div data-aos="fade-up" data-aos-delay="100">
                    <h3 class="text-2xl font-display font-bold text-[#fbbf24] mb-8 border-b border-white/10 pb-4">Accounting &
                        Compliance</h3>
                    <div class="space-y-6">
                        ...
                        <div
                            ...
                            <p class="text-slate-400 text-sm leading-relaxed">
                                Accounts are updated continuously as transactions occur. Detailed reconciliation and the formalized
                                monthly close process happen on a fixed schedule, ensuring you have accurate data within the first
                                week of every new month.
                            </p>
                        </div>
                        ...
                        <div
                            ...
                            <p class="text-slate-400 text-sm leading-relaxed">
                                Our process involves multiple tiers. Automated systems handle data entry and initial checks, while
                                dedicated accounting professionals and senior domain experts review the books for compliance,
                ...
                <div data-aos="fade-up" data-aos-delay="200">
                    <h3 class="text-2xl font-display font-bold text-[#fbbf24] mb-8 border-b border-white/10 pb-4">Pricing &
                        Engagement</h3>
                    <div class="space-y-6">
                        ...
                        <div
                            ...
                            <p class="text-slate-400 text-sm leading-relaxed">
                                Pricing is based on the scale and complexity of your operations. We assess factors like monthly
                                transaction volume, compliance requirements, and business size to provide a transparent, fixed monthly
                                retainer.
                            </p>
                        </div>
                        ...
                        <div
                            ...
                            <p class="text-slate-400 text-sm leading-relaxed">
                                Absolutely. Our engagement models are elastic. Whether you're upgrading to more complex compliance
                                reporting or expanding transaction volume, our backend scales up to support your growing needs without
                                needing to hire a completely new internal team.
                            </p>
                        </div>
                ...
                <div data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div class="space-y-6">
                        ...
                        <div
                            ...
                            <p class="text-slate-400 text-sm leading-relaxed">
                                Yes. We use enterprise-grade cloud platforms for accounting and document management. All data is
                                encrypted, strictly access-controlled, and backed up continuously to ensure no data loss or
                        ...
                        <div
                            ...
                            <p class="text-slate-400 text-sm leading-relaxed">
                                Access is provisioned on a strict role-based policy. Only the assigned account managers and authorized
                                reviewers handling your file can access your data. We adhere to rigorous internal IT and
