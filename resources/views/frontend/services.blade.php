                    ...
                    <div class="w-full lg:w-1/2 flex flex-col gap-6" data-aos="fade-left">
                        <div
                            ...
                            <div class="absolute inset-0 z-0">
                                ...
                                <img src="{{ asset('images/feature_reporting_1772038110744.png') }}"
                        ...
                        <div
                            ...
                            <div class="absolute inset-0 z-0">
                                ...
                                <img src="{{ asset('images/deliverables_goal.png') }}" alt="Deliverables & Goals"
                                    class="w-full h-full object-cover opacity-30 group-hover:scale-105 group-hover:opacity-40 transition-all duration-700 blur-[2px] group-hover:blur-0 mix-blend-screen" />
                            </div>
                            <!-- Content Area -->
                            <div class="relative z-10">
                    ...
                    <div class="w-full lg:w-1/2 flex flex-col gap-6" data-aos="fade-right">
                        <div
                            ...
                            <div class="absolute inset-0 z-0">
                                ...
                                <img src="{{ asset('images/feature_compliance_1772037926108.png') }}"
                        ...
                        <div
                            ...
                            <div class="absolute inset-0 z-0">
                                ...
                                <img src="{{ asset('images/feature_review_1772038721625.png') }}" alt="Compliance Review"
                                    class="w-full h-full object-cover opacity-30 group-hover:scale-105 group-hover:opacity-40 transition-all duration-700 blur-[2px] group-hover:blur-0 mix-blend-screen" />
                            </div>
                            <!-- Content Area -->
                            <div class="relative z-10">
