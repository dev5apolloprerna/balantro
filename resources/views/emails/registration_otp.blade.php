...
<body style="background:#f3f4f6;font-family:Arial,sans-serif;color:#1f2937;padding:24px">
    <div style="max-width:560px;margin:auto;background:#fff;border-radius:12px;padding:32px">
        ...
        <p style="font-size:32px;font-weight:bold;letter-spacing:8px;text-align:center;color:#0891b2">{{ $otp }}</p>
        <p>This code expires in {{ $expiryMinutes }} minutes. If you did not request this account, you can ignore this email.</p>
    </div>
</body>
</html>