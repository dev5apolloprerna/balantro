    ...
    <div class="container py-3">
        <div class="flex items-center justify-between gap-3">
            ...
            <div>
                ...
                <a href="{{ route('reports.voucher-history.export-pdf', $queryParams) }}" title="Export into PDF" class="group btn inline-block relative text-black dark:text-white px-4 py-2 text-sm rounded-md border border-gray-700
                ...
                <a href="{{ route('reports.voucher-history.export-excel', $queryParams) }}" title="Export into Excel" class="group btn inline-block relative text-black dark:text-white px-4 py-2 text-sm rounded-md border border-gray-700
                                transition duration-1000 ease-in-out
                                transition-property: all;
                                hover:border-[#34d399]
        ...
        <form id="filterForm" method="GET" action="{{ route('reports.voucher_history') }}"
                        ...
                        <td colspan="8" class="px-4 py-3">
                            <div class="flex flex-wrap items-center justify-end gap-6 text-sm">
                                <span class="text-gray-700 dark:text-gray-300">Total Dr:
                                    <strong
                                        class="text-gray-900 dark:text-gray-100 dark:text-emerald-300">{{ $inr($totalDr) }}</strong></span>
                                <span class="text-gray-700 dark:text-gray-300">Total Cr:
                                    <strong class="text-gray-900 dark:text-gray-100 dark:text-red-400">{{ $inr($totalCr) }}</strong></span>
                                <span class="text-gray-700 dark:text-gray-300">Diff:
                                    <strong
                                        class="text-gray-900 dark:text-gray-100">
                                        {{ $inr(abs($diff)) }} {{ $diff >= 0 ? 'Dr' : 'Cr' }}
                                    </strong></span>
                            </div>
                        </td>
                    </tr>
