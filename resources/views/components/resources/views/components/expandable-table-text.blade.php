...
<button type="button"
    ...
    title="{{ $displayText }}"
    {{ $attributes->class(['block w-full cursor-pointer text-left focus-visible:rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500']) }}>
