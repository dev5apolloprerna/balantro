<div class="relative p-4 w-full max-w-2xl max-h-full">
  <div class="relative bg-white dark:bg-dark-2 rounded-2xl shadow-lg">
    ...
    <div class="flex items-center justify-between p-4 md:p-5 border-b border-gray-200 dark:border-gray-600 rounded-t">
      <h6 class="font-semibold text-gray-900 dark:text-white">{{ __('managers.clients.assign_modal.title') }}</h6>
      <button type="button"
        ...
        <span class="sr-only">{{ __('managers.clients.assign_modal.close_btn') }}</span>
      </button>
    </div>
    <!-- Modal Body -->
    <div class="p-4 md:p-5 space-y-4">
      <div class="mb-3">
        <label class="block text-gray-700 dark:text-gray-300 mb-2">{{ __('managers.clients.assign_modal.supervisor_label') }}</label>
      ...
      <div class="mb-3">
        <label class="block text-gray-700 dark:text-gray-300 mb-2">{{ __('managers.clients.assign_modal.data_entry_operator_label') }}</label>
    ...
    <div class="flex justify-end gap-4 p-4 md:p-5 border-t border-gray-200 dark:border-gray-600 rounded-b">
      <button type="button"
              ...
              data-action="click->manager--client--allocate-supervisor-deo#hideModal">
        {{ __('managers.clients.assign_modal.cancel_btn') }}
      </button>
      <button type="button"
        ...
        {{ __('managers.clients.assign_modal.assign_btn') }}
      </button>
    </div>
  </div>
</div>