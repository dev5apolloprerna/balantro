<form action="{{ route('manager.messages.store') }}" method="POST" class="flex flex-col gap-2" data-controller="message"
    ...
    <div id="file-preview-container" class="hidden mb-2" data-message-target="filePreviewContainer">
        <div class="flex items-center gap-2 bg-neutral-100 dark:bg-neutral-700 rounded-lg px-3 py-2 overflow-x-scroll">
            ...
            <button type="button"
                ...
                data-action="click->message#clearAllFiles" title="{{ __('chat.messages.file_input.clear_all') }}">
    ...
    <div class="flex items-center gap-2">
        ...
        <div class="flex-1 relative">
            ...
            @can('index', App\Http\Controllers\Managers\MessagesController::class)
                <button type="submit"
