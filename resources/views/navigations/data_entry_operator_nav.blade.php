<ul class="space-y-1 px-2">
    ...
    <li>
        <a href="{{ route('deo.messages.index') }}" title="Chat"
            class="nav-item flex items-center p-3 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 {{ Route::is('deo.*') ? 'active bg-gray-200 dark:bg-gray-600' : '' }}">
            <i class="fas fa-comment-dots menu-icon  text-xl mr-3"></i>
            <span class="nav-text flex-1">Chat</span>
        </a>
    </li>
    <li>
        <a href="{{ route('data_entry_operators.bulkuploadsales') }}" title="Financial Management"
            class="nav-item flex items-center p-3 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 {{ (Route::is('data_entry_operators.*') || Route::is('sales.*') || Route::is('purchase.*') || Route::is('bank.*') || Route::is('cn.*') || Route::is('dn.*') || Route::is('journal.*')) ? 'active bg-gray-200 dark:bg-gray-600' : '' }}">
            <i class="fas fa-upload menu-icon  text-xl mr-3"></i>
            <span class="nav-text flex-1">Financial Management</span>
        </a>
    </li>
    <li>
        <a href="{{ route('transaction_processing.processing_sales') }}" title="Transaction Management"
            class="nav-item flex items-center p-3 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 {{ Route::is('transaction_processing.*') ? 'active bg-gray-200 dark:bg-gray-600' : '' }}">
