...
<ul class="space-y-2 px-2 md:px-2 sidebar-list">
    <li>
        <a href="{{ route('home') }}" data-tooltip="Dashboard" title="Dashboard"
            class="nav-item flex items-center justify-start px-3 py-3 gap-3 box-border rounded-lg text-black dark:text-gray-300 hover:bg-white/10  theme-transition transition-all duration-300  {{ Route::is('home')
                ? 'active 
            ...
            <img src="{{ asset('assets/images/dashboard.png') }}" class="w-6">
    ...
    <li>
        <a href="{{ route('documents.index') }}" data-tooltip="Documents" 
            class="nav-item flex items-center justify-start px-3 py-3 gap-3 box-border rounded-lg text-black dark:text-gray-300 hover:bg-white/10  theme-transition transition-all duration-300  {{ Route::is('documents.*')
                ? 'active
                        bg-gradient-to-r from-[#22d3ee]/20 via-[#22d3ee]/10 to-transparent
                        border border-[#22d3ee]/50
            shadow-[0_0_10px_#22d3ee40] text-black dark:text-white'
                : '' }}">
            {{-- <i class="fa-solid fa-file-lines menu-icon text-xl w-6 text-center "></i> --}}
            <img src="{{ asset('assets/images/document.png') }}" class="w-6">
    ...
    <!-- {{ Route::is('reports.*') ? 'open' : '' }} -->
    <li class="relative reports-dropdown {{ Route::is('reports.*') ? 'active' : '' }}">
        <details class="group">
            <summary data-tooltip="Reports" title="Reports"
                class="cursor-pointer w-full list-none flex items-center justify-between px-3 py-3 rounded-lg text-black dark:text-gray-300 hover:bg-white/10  theme-transition transition-all duration-300  {{ Route::is('reports.*') ? 'active' : '' }}">
                <div class="flex items-center gap-3">
                    <!-- <i class="fas fa-file-alt text-xl w-6 text-center drop-shadow-[0_0_6px_#22d3ee]"></i> -->
                    {{-- <i class="fas fa-file-alt text-xl w-6 text-center "></i> --}}
                    <img src="{{ asset('assets/images/reports.png') }}" class="w-6">
            ...
            <ul class="submenu  ml-4 mt-2 space-y-1 p-2 min-w-[180px]">
                <li>
                    <a href="{{ route('reports.balance_sheet') }}" title="Balance Sheet"
                        class="flex items-center gap-2 px-3 py-2 rounded-md text-black dark:text-gray-300 whitespace-nowrap before:w-1 before:h-4 before:bg-cyan-400 before:rounded before:mr-2 before:opacity-0 hover:before:opacity-100 dark:text-gray-300 hover:bg-white/10  theme-transition transition-all duration-300  {{ Route::is('reports.balance_sheet')
                ...
                <li>
                    <a href="{{ route('reports.pl') }}" title="Profit & Loss"
                        class="flex items-center gap-2 px-3 py-2 rounded-md text-black dark:text-gray-300 whitespace-nowrap before:w-1 before:h-4 before:bg-cyan-400 before:rounded before:mr-2 before:opacity-0 hover:before:opacity-100 dark:text-gray-300 hover:bg-white/10  theme-transition transition-all duration-300  {{ Route::is('reports.pl')
                            ? 'active bg-white/20 dark:bg-white/10 
                        border border-cyan-400/30 
                        shadow-[0_0_10px_#22d3ee40] text-black dark:text-white'
                ...
                <li>
                    <a href="{{ route('reports.ledger') }}" title="All Ledger"
                        class="flex items-center gap-2 px-3 py-2 rounded-md text-black dark:text-gray-300 whitespace-nowrap before:w-1 before:h-4 before:bg-cyan-400 before:rounded before:mr-2 before:opacity-0 hover:before:opacity-100 dark:text-gray-300 hover:bg-white/10  theme-transition transition-all duration-300  {{ Route::is('reports.ledger')
                            ? 'active bg-white/20 dark:bg-white/10 
                        border border-cyan-400/30 
                        shadow-[0_0_10px_#22d3ee40] text-black dark:text-white'
    ...
    <li>
        <a href="{{ route('clients.suspense') }}" data-tooltip="Bank Suspense"
            class="nav-item flex items-center justify-start px-3 py-3 gap-3 box-border rounded-lg text-black dark:text-gray-300 hover:bg-white/10  theme-transition transition-all duration-300  {{ Route::is('clients.suspense')
                ? 'active 
                         bg-gradient-to-r from-[#22d3ee]/20 via-[#22d3ee]/10 to-transparent
                        border border-[#22d3ee]/50
            shadow-[0_0_10px_#22d3ee40] text-black dark:text-white'
                : '' }}">
            <img src="{{ asset('assets/images/action.png') }}" class="w-6">
            {{-- <i class="fas fa-exclamation-triangle text-xl w-6 text-center text-yellow-400 "></i> --}}
            <span class="nav-text flex-1 text-black dark:text-white">Action</span>
            @if (Route::is('clients.suspense'))
                <span class="absolute inset-0 bg-cyan-400/10 blur-md opacity-20 pointer-events-none"></span>
            @endif
        </a>
    </li>
    <li>
        <a href="{{ route('client.messages.index') }}" data-tooltip="Chat"
            class="nav-item flex items-center justify-start px-3 py-3 gap-3 box-border rounded-lg text-black dark:text-gray-300 hover:bg-white/10  theme-transition transition-all duration-300  {{ Route::is('client.*')
                ? 'active
                        bg-gradient-to-r from-[#22d3ee]/20 via-[#22d3ee]/10 to-transparent
                        border border-[#22d3ee]/50
            shadow-[0_0_10px_#22d3ee40] text-black dark:text-white'
                : '' }}">
            <img src="{{ asset('assets/images/chat.png') }}" class="w-6">
            {{-- <i class="fas fa-comment-dots menu-icon text-xl w-6 text-center "></i> --}}
