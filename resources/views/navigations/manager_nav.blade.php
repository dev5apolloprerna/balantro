<ul class="space-y-1 px-2">
    ...
    <li>
        <a href="{{ route('manager.messages.index') }}" title="Chat"
            class="nav-item flex items-center p-3 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 {{ Route::is('manager.*') ? 'active bg-gray-200 dark:bg-gray-600' : '' }}">
