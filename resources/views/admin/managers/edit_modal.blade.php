<div id="editModal" class="hidden fixed inset-0 z-50 items-center justify-center bg-slate-950/60 p-4 backdrop-blur-sm">
    ...
    <div class="balantro-modal-panel relative w-full max-w-2xl rounded-2xl bg-white text-slate-900 shadow-xl dark:bg-slate-900 dark:text-white">
        ...
        <form id="editForm" method="POST" class="px-6 py-5 space-y-5"> @csrf @method('PUT')
            ...
            <div> <label class="block text-sm font-medium mb-1">Name <span class="text-red-500">*</span></label> <input
                    id="edit_name" name="name" type="text"
                    class="w-full rounded-md border border-slate-300 bg-white dark:border-slate-700 dark:bg-slate-800 dark:text-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500">
            </div>
