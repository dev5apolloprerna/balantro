{{-- <div x-data="{
    ...
    // global modal refs created in x-init
}" x-init="// Expose modal controllers (defined inside each included modal)
window.assignGroupsRef = $refs.assignGroupsModal
window.assignPermsRef = $refs.assignPermsModal" class="mx-auto max-w-[1400px] px-3 sm:px-6 lg:px-8"> --}}
<!-- Header -->
<div class="container mx-auto px-4">
    <div class="flex justify-between items-center mb-6">
        ...
        {{-- @can('create', App\Http\Controllers\Admin\ClientsController::class) --}}
        @if(auth()->user()->can('clients.create') || $user->role === \App\Models\User::ROLES['super_admin'])
                <button type="button" data-modal-open="client-form"
                    ...
                    {{-- <x-icon name="heroicons-outline-plus" class="h-5 w-5" /> --}}
    ...
    {{-- Create / Edit Client Modal (existing) --}}
    @include('admin.clients.modals.create', ['client' => $client ?? null])
            ...
            <div class="shadow rounded-2xl overflow-hidden">
                <div class="">
                    ...
                    <div id="supervisor-table">
                        @include('admin.clients.client_table', ['clients' => $clients])
...
{{-- <div class="hidden">
    <div x-ref="assignGroupsModal">
        @include('admin.clients.modals.assign_groups')
    </div>
    <div x-ref="assignPermsModal">
        @include('admin.clients.modals.assign_permissions')
    </div>
</div> --}}
{{-- </div> --}}
