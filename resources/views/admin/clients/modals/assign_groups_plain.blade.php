{{-- resources/views/admin/clients/modals/assign_groups_plain.blade.php --}}
    ...
    <form method="dialog" class="w-full">
        <div class="rounded-2xl bg-white dark:bg-neutral-800 shadow-xl">
            <div class="flex items-center justify-between border-b px-5 py-3 dark:border-neutral-700">
                <h3 class="text-lg font-semibold text-neutral-900 dark:text-white">{{ __('Assign Groups') }}</h3>
                <button type="button"
            ...
            <div class="space-y-3 p-5">
                ...
                <div id="ag-groups-list" class="space-y-2">
                    {{-- Filled by JS from /clients/{id}/groups --}}
                </div>
            </div>
            ...
            <div class="flex items-center justify-end gap-3 border-t px-5 py-3 dark:border-neutral-700">
                ...
                <button type="button" id="ag-save"
                    class="rounded-lg bg-primary-600 px-4 py-2 font-semibold text-white hover:bg-primary-700">{{ __('Save') }}</button>
            </div>
        </div>
    </form>
</dialog>
