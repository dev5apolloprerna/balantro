...
@section('content')
    ...
    <div class="dashboard-main-body">
        ...
        <div class="container py-3">
            ...
            <form method="POST" action="{{ route('clients.reports.pnl', $guid ?? '') }}"
                ...
                <div>
                    ...
                    <select id="rangeSel" name="range"
                        ...
                        <option value="current_year" {{ $rangeSel === 'current_year' ? 'selected' : '' }}>Current Year
                        </option>
                        ...
                        <option value="current_quarter"{{ $rangeSel === 'current_quarter' ? 'selected' : '' }}>Current
                            Quarter
                        </option>
                        <option value="last_quarter" {{ $rangeSel === 'last_quarter' ? 'selected' : '' }}>Last Quarter
                        </option>
