...
<div class="dashboard-main-body">
    <div class="container py-3">
        ...
        <form method="POST" action="{{ route('clients.reports.pnl', $guid ?? '') }}" id="filterForm"
            ...
            <div class="relative"
                ...
                <ul x-show="open" @click.outside="open = false"
                    ...
                    <li>
                        <button type="button"
                            @click="selected = 'current_year'; open = false; handleRangeChange('current_year')"
                            class="w-full text-left px-4 py-2 text-sm
                            transition-all duration-200
                            text-gray-800 dark:text-white
                            hover:bg-black/10 dark:hover:bg-white/10
                            hover:text-[#22d3ee]"
                            :class="selected === 'current_year'
                    ...
                    <li>
                        <button type="button"
                            @click="selected = 'last_year'; open = false; handleRangeChange('last_year')"
                            class="w-full text-left px-4 py-2 text-sm
                            transition-all duration-200
                            text-gray-800 dark:text-white
                            hover:bg-black/10 dark:hover:bg-white/10
                            hover:text-[#22d3ee]"
                            :class="selected === 'last_year'
                                ? 'bg-[#22d3ee]/20 text-[#22d3ee]'
                                : ''">
