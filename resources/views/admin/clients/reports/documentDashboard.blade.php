...
<div class="dashboard-main-body">
    <div class="mb-4 mt-2">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <!-- Uploaded Card -->
            <a href="{{ route('documents.index', ['client_id' => $user->id, 'status' => 'uploaded']) }}" type="submit" class="group block w-full text-left focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-xl card-hover color-0">
            ...
            <!-- Completed Card -->
            <a href="{{ route('documents.index', ['client_id' => $user->id, 'status' => 'processing']) }}" class="block">
               <div class="relative  rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden min-h-[92px] transition-all duration-300 hover:shadow-md">
                    <div class="p-4 pl-6">
                        <div class="flex items-start justify-between">
                            <div class="pr-3 flex-1">
            ...
            <!-- Accepted Card -->
            <a href="{{ route('documents.index', ['client_id' => $user->id, 'status' => 'approved']) }}" class="block">
                <div class="relative  rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden min-h-[92px] transition-all duration-300 hover:shadow-md">
                    <div class="p-4 pl-6">
                        <div class="flex items-start justify-between">
                            <div class="pr-3 flex-1">
            ...
            <!-- Rejected Card -->
            <a href="{{ route('documents.index', ['client_id' => $user->id, 'status' => 'rejected']) }}" class="block">
                <div class="relative  rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden min-h-[92px] transition-all duration-300 hover:shadow-md">
                    <div class="p-4 pl-6">
                        <div class="flex items-start justify-between">
                            <div class="pr-3 flex-1">
