<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
    <div class="mt-4 sm:ml-auto flex flex-wrap items-center gap-2" role="tablist">
        <a href="{{ route('clients.dashboard', $guid ?? '') }}" style="padding-top: 0.40rem;"
		...
		<a href="{{ route('clients.documents.dashboard', $guid ?? '') }}" style="padding-top: 0.40rem;"
            class="h-9 px-3 text-sm rounded-md border transition
        ...
        <a href="{{ route('clients.reports.balanceSheet', $guid ?? '') }}" style="padding-top: 0.40rem;"
            class="h-9 px-3 text-sm rounded-md border transition
        ...
        <a href="{{ route('clients.reports.pnl', $guid ?? '') }}" style="padding-top: 0.40rem;"
            class="h-9 px-3 text-sm rounded-md border transition
        ...
        <a href="{{ route('clients.reports.ledger', $guid ?? '') }}" style="padding-top: 0.40rem;"
            class="h-9 px-3 text-sm rounded-md border transition
