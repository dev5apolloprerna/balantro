@forelse ($data_entry_operators as $deo)
    ...
    <tr class="hover:bg-slate-50/50 dark:hover:bg-slate-700/30">
        <td class="px-2 py-1 font-medium text-slate-900 dark:text-slate-100">{{ $deo->name }}</td>
        <td class="px-2 py-1 text-slate-700 dark:text-slate-200">{{ $deo->email }}</td>
        <td class="px-2 py-1 text-slate-700 dark:text-slate-200">{{ $deo->managers->pluck('name')->join(', ') ?: '—' }}
        </td>
        <td class="px-2 py-1 text-slate-700 dark:text-slate-200">
            {{ $deo->supervisors->pluck('name')->join(', ') ?: '—' }}</td>
        <td class="px-2 py-1">
