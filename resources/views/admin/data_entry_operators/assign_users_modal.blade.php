  ...
  <div class="relative p-4 w-full max-w-2xl max-h-full">
    <div class="relative bg-white dark:bg-dark-2 rounded-2xl shadow-lg">
      ...
      <div class="flex items-center justify-between p-4 md:p-5 border-b border-gray-200 dark:border-gray-600 rounded-t">
        <h6 class="font-semibold text-gray-900 dark:text-white">{{ __('admin.data_entry_operators.modal.title') }}</h6>
        <button type="button"
          ...
          <span class="sr-only">{{ __('admin.data_entry_operators.modal.close_btn') }}</span>
        </button>
      </div>
      <!-- Modal Body -->
      <div class="p-4 md:p-5 space-y-4">
        <div class="mb-3">
          <label class="block text-sm font-semibold text-neutral-600 dark:text-neutral-200 mb-2">{{ __('admin.data_entry_operators.modal.manager_lable') }}</label>
        ...
        <div class="mb-3">
          <label class="block text-sm font-semibold text-neutral-600 dark:text-neutral-200 mb-2">{{ __('admin.data_entry_operators.modal.supervisor_label') }}</label>
      ...
      <div class="flex items-center justify-end gap-4 p-4 md:p-5 border-t border-gray-200 dark:border-gray-600 rounded-b">
        <button type="button"
                ...
                data-action="click->admin--data-entry-operator--allocate-users#hideModal">
          {{ __('admin.data_entry_operators.modal.close_btn') }}
        </button>
        <button type="button"
                disabled
          ...
          {{ __('admin.data_entry_operators.modal.assign_btn') }}
        </button>
      </div>
    </div>
  </div>
