        ...
        <div class="grid grid-cols-1 lg:grid-cols-12">
            <div class="col-span-12">
                <div class="card !border-0 rounded-lg overflow-hidden bg-white dark:bg-neutral-800">
                    ...
                    <div class="overflow-x-auto overflow-y-auto h-[calc(100%-120px)] rounded-lg border border-gray-200 dark:border-gray-700 group-block">
...
.dark #ledgerModal select option{
        ...
        $(document).ready(function() {
            $('#sampleDownload').change(function() {
                ...
                if (type == 'with-item') {
                    ...
                    window.downloadFile("/samples/Sales-with-item-sample-file.xlsx");
                }
                if (type == 'without-item') {
                    // window.location.href = window.downloadFile("/samples/Sales-without-item-sample-file.xlsx");
                    window.downloadFile("/samples/Sales-without-item-sample-file.xlsx");
                }
                // reset dropdown
                $(this).val('');
            });
    ...
    <script>
        ...
        function validateManualSalesInvoice() {
            ...
            if ($('input[name="entry_mode"]:checked').val() === 'item') {
            ...
            if ($('input[name="entry_mode"]:checked').val() === 'item') {
                ...
                rows.each(function(index) {
                    ...
                    const checks = [
                        ...
                        ['.rate', `Please enter Rate in row ${index + 1}`]
                    ];
        ...
        $('#saveRow').click(function() {
            ...
            if (!validateManualSalesInvoice()) return;
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    ...
                    const msg = errors
                        ...
                        : (xhr.responseJSON?.message || 'Unable to save the invoice. Please try again.');
