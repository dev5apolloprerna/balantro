                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-800 tabular-nums">
                        ...
                        <tr data-cheque="{{ $row->cheque_no }}"
                            ...
                            <td class="px-3 py-2">
                                ...
                                @else
                                    <button type="button"  {{ $row->is_suspense == 1 ? 'disabled' : '' }}
...
@include('admin.bulkupload.bank.edit_modal')
                        ...
                        <div>
                            ...
                            <select name="Parent"
                                ...
                                @foreach($parents as $parent)
                                    <option value="{{ $parent->strParents }}">
                                        {{ $parent->strParents }}
                                    </option>
                                @endforeach
...
@include('admin.bulkupload.bank.suspense_modal')
