<form action="{{ isset($user->id) ? route('admin.users.update', $user) : route('admin.users.store') }}" method="POST" class="space-y-6">
    @csrf
    @if(isset($user->id))
        @method('PUT')
    @endif
            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    <h3 class="text-sm font-medium text-red-800">
                        {{ trans_choice('There is :count error|There are :count errors', $errors->count()) }} prohibited this user from being saved:
                    </h3>
    ...
    @lang('devise.confirmations.send_instructions')
