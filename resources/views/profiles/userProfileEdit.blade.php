...
@section('content')
    <div class="lg:col-span-3">
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
            ...
            <form method="POST" action="{{ route('profile.userProfileUpdate') }}" class="space-y-6"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2 mt-4">
                        ...
                        <textarea name="address" id="address" rows="4" placeholder="Enter your complete address"
                            class="w-full px-4 py-4 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-vertical leading-relaxed">{{ old('address', $profile->address ?? '') }}</textarea>
                    </div>
                </div>
