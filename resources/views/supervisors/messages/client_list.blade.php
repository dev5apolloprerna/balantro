{{-- resources/views/supervisors/messages/client_list.blade.php --}}
    ...
    <div id="clientList" class="flex-1 overflow-y-auto divide-y divide-gray-200 dark:divide-gray-800">
        @forelse($clients as $c)
            ...
            <a href="{{ route('supervisor.messages.index', ['client' => $c->client_user_id]) }}"
                class="block px-3 py-3 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors {{ $active ? 'bg-indigo-50 dark:bg-indigo-900/20 border-r-2 border-indigo-500' : '' }}">
