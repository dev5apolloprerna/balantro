...
// app/javascript/flatpickr.js
var require_flatpickr = __commonJS({
  "app/javascript/flatpickr.js"(exports, module) {
    !function(e, n) {
      ...
      function m3(e2, n2) {
        var t2 = d3("div", "numInputWrapper"), a2 = d3("input", "numInput " + e2), i2 = d3("span", "arrowUp"), o2 = d3("span", "arrowDown");
      ...
      } }, D2 = { D: "", F: "", G: "(\\d\\d|\\d)", H: "(\\d\\d|\\d)", J: "(\\d\\d|\\d)\\w+", K: "", M: "", S: "(\\d\\d|\\d)", U: "(.+)", W: "(\\d\\d|\\d)", Y: "(\\d{4})", Z: "(.+)", d: "(\\d\\d|\\d)", h: "(\\d\\d|\\d)", i: "(\\d\\d|\\d)", j: "(\\d\\d|\\d)", l: "", m: "(\\d\\d|\\d)", n: "(\\d\\d|\\d)", s: "(\\d\\d|\\d)", u: "(.+)", w: "(\\d\\d|\\d)", y: "(\\d{2})" }, w = { Z: function(e2) {
        ...
        return function(e3, n3, i2, o3) {
          if (0 === e3 || e3) {
            ...
            if (e3 instanceof Date) l2 = new Date(e3.getTime());
              ...
              var d4 = n3 || (t2 || a).dateFormat, u2 = String(e3).trim();
              if ("today" === u2) l2 = /* @__PURE__ */ new Date(), i2 = true;
              else if (t2 && t2.parseDate) l2 = t2.parseDate(e3, d4);
              else if (/Z$/.test(u2) || /GMT$/.test(u2)) l2 = new Date(e3);
              else {
                for (var f2 = void 0, m4 = [], g2 = 0, p2 = 0, h2 = ""; g2 < d4.length; g2++) {
                  var w2 = d4[g2], b2 = "\\" === w2, C2 = "\\" === d4[g2 - 1] || b2;
                  if (D2[w2] && !C2) {
                    h2 += D2[w2];
                    var M3 = new RegExp(h2).exec(e3);
                    M3 && (f2 = true) && m4["Y" !== w2 ? "push" : "unshift"]({ fn: v[w2], val: M3[++p2] });
                  } else b2 || (h2 += ".");
                }
                l2 = t2 && t2.noCalendar ? new Date((/* @__PURE__ */ new Date()).setHours(0, 0, 0, 0)) : new Date((/* @__PURE__ */ new Date()).getFullYear(), 0, 1, 0, 0, 0, 0), m4.forEach(function(e4) {
      ...
      function k(p2, v2) {
        ...
        function _(e2) {
          if (0 === w2.selectedDates.length) {
            var n2 = void 0 === w2.config.minDate || M2(/* @__PURE__ */ new Date(), w2.config.minDate) >= 0 ? /* @__PURE__ */ new Date() : new Date(w2.config.minDate.getTime()), t2 = E(w2.config);
          ...
          void 0 !== e2 && "blur" !== e2.type && function(e3) {
            ...
            var i2 = parseFloat(a3.getAttribute("min")), l2 = parseFloat(a3.getAttribute("max")), c2 = parseFloat(a3.getAttribute("step")), s2 = parseInt(a3.value, 10), d4 = e3.delta || (n3 ? 38 === e3.which ? 1 : -1 : 0), u2 = s2 + c2 * d4;
            if (void 0 !== a3.value && 2 === a3.value.length) {
              var f2 = a3 === w2.hourElement, m4 = a3 === w2.minuteElement;
              u2 < i2 ? (u2 = l2 + u2 + r(!f2) + (r(f2) && r(!w2.amPM)), m4 && L(void 0, -1, w2.hourElement)) : u2 > l2 && (u2 = a3 === w2.hourElement ? u2 - l2 - r(!w2.amPM) : i2, m4 && L(void 0, 1, w2.hourElement)), w2.amPM && f2 && (1 === c2 ? u2 + s2 === 23 : Math.abs(u2 - s2) > c2) && (w2.amPM.textContent = w2.l10n.amPM[r(w2.amPM.textContent === w2.l10n.amPM[0])]), a3.value = o(u2);
            }
          }(e2);
        ...
        function O() {
          if (void 0 !== w2.hourElement && void 0 !== w2.minuteElement) {
            ...
            var o2 = void 0 !== w2.config.minTime || w2.config.minDate && w2.minDateHasTime && w2.latestSelectedDateObj && 0 === M2(w2.latestSelectedDateObj, w2.config.minDate, true), l2 = void 0 !== w2.config.maxTime || w2.config.maxDate && w2.maxDateHasTime && w2.latestSelectedDateObj && 0 === M2(w2.latestSelectedDateObj, w2.config.maxDate, true);
            if (void 0 !== w2.config.maxTime && void 0 !== w2.config.minTime && w2.config.minTime > w2.config.maxTime) {
              var c2 = y3(w2.config.minTime.getHours(), w2.config.minTime.getMinutes(), w2.config.minTime.getSeconds()), s2 = y3(w2.config.maxTime.getHours(), w2.config.maxTime.getMinutes(), w2.config.maxTime.getSeconds()), d4 = y3(t2, a2, i2);
              if (d4 > s2 && d4 < c2) {
                var u2 = function(e3) {
              ...
              if (o2) {
                var m4 = void 0 !== w2.config.minTime ? w2.config.minTime : w2.config.minDate;
                (t2 = Math.max(t2, m4.getHours())) === m4.getHours() && a2 < m4.getMinutes() && (a2 = m4.getMinutes()), a2 === m4.getMinutes() && (i2 = Math.max(i2, m4.getSeconds()));
              }
            }
            A(t2, a2, i2);
          }
        ...
        function R(e2, n2, t2, a2) {
          var i2 = ne(n2, true), o2 = d3("span", e2, n2.getDate().toString());
          return o2.dateObj = n2, o2.$i = a2, o2.setAttribute("aria-label", w2.formatDate(n2, w2.config.ariaDateFormat)), -1 === e2.indexOf("hidden") && 0 === M2(n2, w2.now) && (w2.todayDateElem = o2, o2.classList.add("today"), o2.setAttribute("aria-current", "date")), i2 ? (o2.tabIndex = -1, be(n2) && (o2.classList.add("selected"), w2.selectedDateElem = o2, "range" === w2.config.mode && (s(o2, "startRange", w2.selectedDates[0] && 0 === M2(n2, w2.selectedDates[0], true)), s(o2, "endRange", w2.selectedDates[1] && 0 === M2(n2, w2.selectedDates[1], true)), "nextMonthDay" === e2 && o2.classList.add("inRange")))) : o2.classList.add("flatpickr-disabled"), "range" === w2.config.mode && function(e3) {
            return !("range" !== w2.config.mode || w2.selectedDates.length < 2) && (M2(e3, w2.selectedDates[0]) >= 0 && M2(e3, w2.selectedDates[1]) <= 0);
        ...
        function J(e2, n2) {
          ...
          void 0 === i2 ? w2._input.focus() : a2 ? function(e3, n3) {
            for (var t3 = -1 === e3.className.indexOf("Month") ? e3.dateObj.getMonth() : w2.currentMonth, a3 = n3 > 0 ? w2.config.showMonths : -1, i3 = n3 > 0 ? 1 : -1, o2 = t3 - w2.currentMonth; o2 != a3; o2 += i3) for (var r2 = w2.daysContainer.children[o2], l2 = t3 - w2.currentMonth === o2 ? e3.$i + n3 : n3 < 0 ? r2.children.length - 1 : 0, c2 = r2.children.length, s2 = l2; s2 >= 0 && s2 < c2 && s2 != (n3 > 0 ? c2 : -1); s2 += i3) {
              var d4 = r2.children[s2];
              if (-1 === d4.className.indexOf("hidden") && ne(d4.dateObj) && Math.abs(e3.$i - s2) >= Math.abs(n3)) return W(d4);
            }
        ...
        function K(e2, n2) {
          ...
          var m4 = d3("div", "dayContainer");
          return m4.appendChild(o2), m4;
        }
        function U() {
        ...
        function q() {
          if (!(w2.config.showMonths > 1 || "dropdown" !== w2.config.monthSelectorType)) {
            ...
            for (var n2 = 0; n2 < 12; n2++) if (e2(n2)) {
              var t2 = d3("option", "flatpickr-monthDropdown-month");
        ...
        function $() {
          var e2, n2 = d3("div", "flatpickr-month"), t2 = window.document.createDocumentFragment();
          w2.config.showMonths > 1 || "static" === w2.config.monthSelectorType ? e2 = d3("span", "cur-month") : (w2.monthsDropdownContainer = d3("select", "flatpickr-monthDropdown-months"), w2.monthsDropdownContainer.setAttribute("aria-label", w2.l10n.monthAriaLabel), P(w2.monthsDropdownContainer, "change", function(e3) {
            var n3 = g(e3), t3 = parseInt(n3.value, 10);
            w2.changeMonth(t3 - w2.currentMonth), De("onMonthChange");
          }), q(), e2 = w2.monthsDropdownContainer);
          var a2 = m3("cur-year", { tabindex: "-1" }), i2 = a2.getElementsByTagName("input")[0];
          ...
          var o2 = d3("div", "flatpickr-current-month");
        ...
        function z() {
          w2.weekdayContainer ? u(w2.weekdayContainer) : w2.weekdayContainer = d3("div", "flatpickr-weekdays");
          for (var e2 = w2.config.showMonths; e2--; ) {
            var n2 = d3("div", "flatpickr-weekdaycontainer");
        ...
        function ne(e2, n2) {
          ...
          if (w2.config.minDate && a2 && M2(a2, w2.config.minDate, void 0 !== n2 ? n2 : !w2.minDateHasTime) < 0 || w2.config.maxDate && a2 && M2(a2, w2.config.maxDate, void 0 !== n2 ? n2 : !w2.maxDateHasTime) > 0) return false;
        ...
        function ie(e2) {
          ...
          if (13 === e2.keyCode && t2) {
            ...
            switch (e2.keyCode) {
              ...
              case 9:
                if (r2) {
                  var d4 = [w2.hourElement, w2.minuteElement, w2.secondElement, w2.amPM].concat(w2.pluginElements).filter(function(e3) {
                    return e3;
                  }), u2 = d4.indexOf(n2);
                  if (-1 !== u2) {
                    var f2 = d4[u2 + (e2.shiftKey ? -1 : 1)];
        ...
        function oe(e2, n2) {
          if (void 0 === n2 && (n2 = "flatpickr-day"), 1 === w2.selectedDates.length && (!e2 || e2.classList.contains(n2) && !e2.classList.contains("flatpickr-disabled"))) {
            ...
            Array.from(w2.rContainer.querySelectorAll("*:nth-child(-n+" + w2.config.showMonths + ") > ." + n2)).forEach(function(n3) {
              var i3, o3, s3, d4 = n3.dateObj.getTime(), u2 = l2 > 0 && d4 < l2 || c2 > 0 && d4 > c2;
              ...
              r2 && !u2 || (["startRange", "inRange", "endRange", "notAllowed"].forEach(function(e3) {
                n3.classList.remove(e3);
              }), void 0 !== e2 && (e2.classList.add(t2 <= w2.selectedDates[0].getTime() ? "startRange" : "endRange"), a2 < t2 && d4 === a2 ? n3.classList.add("startRange") : a2 > t2 && d4 === a2 && n3.classList.add("endRange"), d4 >= l2 && (0 === c2 || d4 <= c2) && (o3 = a2, s3 = t2, (i3 = d4) > Math.min(o3, s3) && i3 < Math.max(o3, s3)) && n3.classList.add("inRange")));
            });
          }
        }
        function re() {
        ...
        function se() {
          "object" != typeof w2.config.locale && void 0 === I.l10ns[w2.config.locale] && w2.config.errorHandler(new Error("flatpickr: invalid locale " + w2.config.locale)), w2.l10n = e(e({}, I.l10ns.default), "object" == typeof w2.config.locale ? w2.config.locale : "default" !== w2.config.locale ? I.l10ns[w2.config.locale] : void 0), D2.D = "(" + w2.l10n.weekdays.shorthand.join("|") + ")", D2.l = "(" + w2.l10n.weekdays.longhand.join("|") + ")", D2.M = "(" + w2.l10n.months.shorthand.join("|") + ")", D2.F = "(" + w2.l10n.months.longhand.join("|") + ")", D2.K = "(" + w2.l10n.amPM[0] + "|" + w2.l10n.amPM[1] + "|" + w2.l10n.amPM[0].toLowerCase() + "|" + w2.l10n.amPM[1].toLowerCase() + ")", void 0 === e(e({}, v2), JSON.parse(JSON.stringify(p2.dataset || {}))).time_24hr && void 0 === I.defaultConfig.time_24hr && (w2.config.time_24hr = w2.l10n.time_24hr), w2.formatDate = b(w2), w2.parseDate = C({ config: w2.config, l10n: w2.l10n });
        }
        function de(e2) {
          if ("function" != typeof w2.config.position) {
            if (void 0 !== w2.calendarContainer) {
              ...
              }, 0), a2 = w2.calendarContainer.offsetWidth, i2 = w2.config.position.split(" "), o2 = i2[0], r2 = i2.length > 1 ? i2[1] : null, l2 = n2.getBoundingClientRect(), c2 = window.innerHeight - l2.bottom, d4 = "above" === o2 || "below" !== o2 && c2 < t2 && l2.top > t2, u2 = window.pageYOffset + l2.top + (d4 ? -t2 - 2 : n2.offsetHeight + 2);
              if (s(w2.calendarContainer, "arrowTop", !d4), s(w2.calendarContainer, "arrowBottom", d4), !w2.config.inline) {
                var f2 = window.pageXOffset + l2.left, m4 = false, g2 = false;
                "center" === r2 ? (f2 -= (a2 - l2.width) / 2, m4 = true) : "right" === r2 && (f2 -= a2 - l2.width, g2 = true), s(w2.calendarContainer, "arrowLeft", !m4 && !g2), s(w2.calendarContainer, "arrowCenter", m4), s(w2.calendarContainer, "arrowRight", g2);
                ...
                if (s(w2.calendarContainer, "rightMost", h2), !w2.config.static) if (w2.calendarContainer.style.top = u2 + "px", h2) if (v3) {
                  ...
                  if (void 0 === D3) return;
                  var b2 = window.document.body.offsetWidth, C2 = Math.max(0, b2 / 2 - a2 / 2), M3 = D3.cssRules.length, y4 = "{left:" + l2.left + "px;right:auto;}";
                  s(w2.calendarContainer, "rightMost", false), s(w2.calendarContainer, "centerMost", true), D3.insertRule(".flatpickr-calendar.centerMost:before,.flatpickr-calendar.centerMost:after" + y4, M3), w2.calendarContainer.style.left = C2 + "px", w2.calendarContainer.style.right = "auto";
        ...
        function me(e2) {
          ...
          if (void 0 !== n2) {
            ...
            } else "range" === w2.config.mode && (2 === w2.selectedDates.length && w2.clear(false, false), w2.latestSelectedDateObj = a2, w2.selectedDates.push(a2), 0 !== M2(a2, w2.selectedDates[0], true) && w2.selectedDates.sort(function(e3, n3) {
        ...
        w2.parseDate = C({ config: w2.config, l10n: w2.l10n }), w2._handlers = [], w2.pluginElements = [], w2.loadedPlugins = [], w2._bind = P, w2._setHoursFromDate = F, w2._positionCalendar = de, w2.changeMonth = Z, w2.changeYear = ee, w2.clear = function(e2, n2) {
          ...
          De("onClose");
        }, w2.onMouseOver = oe, w2._createElement = d3, w2.createDay = R, w2.destroy = function() {
        ...
        function be(e2) {
          for (var n2 = 0; n2 < w2.selectedDates.length; n2++) {
            ...
            if (t2 instanceof Date && 0 === M2(t2, e2)) return "" + n2;
          }
          return false;
        }
        function Ce() {
        ...
        return function() {
          w2.element = w2.input = p2, w2.isOpen = false, function() {
            ...
            }, set: d4("min") }), Object.defineProperty(w2.config, "maxTime", { get: function() {
              return w2.config._maxTime;
            }, set: d4("max") }), "time" === i2.mode && (w2.config.noCalendar = true, w2.config.enableTime = true);
            ...
            for (u2 = 0; u2 < w2.config.plugins.length; u2++) {
              ...
              for (var m4 in f2) t.indexOf(m4) > -1 ? w2.config[m4] = c(f2[m4]).map(T2).concat(w2.config[m4]) : void 0 === i2[m4] && (w2.config[m4] = f2[m4]);
            }
            ...
            if (w2.calendarContainer = d3("div", "flatpickr-calendar"), w2.calendarContainer.tabIndex = -1, !w2.config.noCalendar) {
              if (e2.appendChild((w2.monthNav = d3("div", "flatpickr-months"), w2.yearElements = [], w2.monthElements = [], w2.prevMonthNav = d3("span", "flatpickr-prev-month"), w2.prevMonthNav.innerHTML = w2.config.prevArrow, w2.nextMonthNav = d3("span", "flatpickr-next-month"), w2.nextMonthNav.innerHTML = w2.config.nextArrow, V(), Object.defineProperty(w2, "_hidePrevMonthArrow", { get: function() {
              ...
              } }), w2.currentYearElement = w2.yearElements[0], Ce(), w2.monthNav)), w2.innerContainer = d3("div", "flatpickr-innerContainer"), w2.config.weekNumbers) {
                var n3 = function() {
                  w2.calendarContainer.classList.add("hasWeeks");
                  var e3 = d3("div", "flatpickr-weekwrapper");
                  e3.appendChild(d3("span", "flatpickr-weekday", w2.l10n.weekAbbreviation));
                  var n4 = d3("div", "flatpickr-weeks");
              ...
              w2.rContainer = d3("div", "flatpickr-rContainer"), w2.rContainer.appendChild(z()), w2.daysContainer || (w2.daysContainer = d3("div", "flatpickr-days"), w2.daysContainer.tabIndex = -1), U(), w2.rContainer.appendChild(w2.daysContainer), w2.innerContainer.appendChild(w2.rContainer), e2.appendChild(w2.innerContainer);
            }
            w2.config.enableTime && e2.appendChild(function() {
              ...
              var e3 = E(w2.config);
              w2.timeContainer = d3("div", "flatpickr-time"), w2.timeContainer.tabIndex = -1;
              var n4 = d3("span", "flatpickr-time-separator", ":"), t3 = m3("flatpickr-hour", { "aria-label": w2.l10n.hourAriaLabel });
              w2.hourElement = t3.getElementsByTagName("input")[0];
              var a3 = m3("flatpickr-minute", { "aria-label": w2.l10n.minuteAriaLabel });
              ...
              if (w2.config.enableSeconds) {
                ...
                var i3 = m3("flatpickr-second");
                w2.secondElement = i3.getElementsByTagName("input")[0], w2.secondElement.value = o(w2.latestSelectedDateObj ? w2.latestSelectedDateObj.getSeconds() : e3.seconds), w2.secondElement.setAttribute("step", w2.minuteElement.getAttribute("step")), w2.secondElement.setAttribute("min", "0"), w2.secondElement.setAttribute("max", "59"), w2.secondElement.setAttribute("maxlength", "2"), w2.timeContainer.appendChild(d3("span", "flatpickr-time-separator", ":")), w2.timeContainer.appendChild(i3);
              }
              w2.config.time_24hr || (w2.amPM = d3("span", "flatpickr-am-pm", w2.l10n.amPM[r((w2.latestSelectedDateObj ? w2.hourElement.value : w2.config.defaultHour) > 11)]), w2.amPM.title = w2.l10n.toggleTitle, w2.amPM.tabIndex = -1, w2.timeContainer.appendChild(w2.amPM));
            ...
            if ((w2.config.inline || w2.config.static) && (w2.calendarContainer.classList.add(w2.config.inline ? "inline" : "static"), w2.config.inline && (!i2 && w2.element.parentNode ? w2.element.parentNode.insertBefore(w2.calendarContainer, w2._input.nextSibling) : void 0 !== w2.config.appendTo && w2.config.appendTo.appendChild(w2.calendarContainer)), w2.config.static)) {
              var l2 = d3("div", "flatpickr-wrapper");
      ...
      }, I.parseDate = C({}), I.formatDate = b({}), I.compareDates = M2, "undefined" != typeof jQuery && void 0 !== jQuery.fn && (jQuery.fn.flatpickr = function(e2) {
        return T(this, e2);
...
var document_upload_controller_default = class extends Controller {
  static targets = ["fileInput", "submitBtn", "uploadedList", "modal", "dropZone", "modalTitle", "modalBody", "form"];
  static values = { editTitle: String, uploadTitle: String, currentPage: Number };
  ...
  handleDrop(e) {
    e.preventDefault();
    this.dropZoneTarget.classList.remove("bg-neutral-100", "text-neutral-900", "dark:bg-neutral-700", "dark:text-neutral-100");
    this.addFiles(Array.from(e.dataTransfer.files));
  }
  handleDragOver(e) {
    e.preventDefault();
    this.dropZoneTarget.classList.add("bg-neutral-100", "text-neutral-900", "dark:bg-neutral-700", "dark:text-neutral-100");
  }
  handleDragLeave(e) {
    e.preventDefault();
    this.dropZoneTarget.classList.remove("bg-neutral-100", "text-neutral-900", "dark:bg-neutral-700", "dark:text-neutral-100");
  ...
  addFiles(newFiles) {
    const validFiles = Array.from(newFiles).filter(
      (f) => this.allowedExtensions.includes(f.name.split(".").pop().toLowerCase())
    );
    if (!validFiles.length) {
      alert(`Only files of type: ${this.allowedExtensions.join(", ")} are allowed.`);
      return;
    }
    this.files = this.isEdit ? validFiles.slice(0, 1) : [...this.files, ...validFiles.filter(
      (f) => !this.files.some((existing) => existing.name === f.name && existing.size === f.size)
    )];
    this.syncFiles();
  }
  removeFile(e) {
  ...
  syncFiles() {
    ...
    this.files.forEach((f) => data.items.add(f));
    this.fileInputTarget.files = data.files;
    if (this.isEdit && this.hasFormTarget) {
      const formData = new FormData(this.formTarget);
      formData.delete("document[file]");
      if (this.files.length) formData.append("document[file]", this.files[0]);
    }
    this.renderFileList();
    this.updateSubmitState();
  }
  renderFileList() {
    if (!this.hasUploadedListTarget) return;
    this.uploadedListTarget.innerHTML = this.files.map((file, i) => `
      <li class="uploaded-image-name-list text-primary-600 font-semibold flex items-center gap-2 justify-between mb-2">
        <div class="flex items-center gap-2 flex-1 min-w-0">
          ...
          <span class="truncate block whitespace-nowrap overflow-hidden text-ellipsis" title="${file.name}">${file.name}</span>
        </div>
        <span class="text-neutral-500 text-sm ml-2">${this.formatSize(file.size)}</span>
        <button type="button" class="text-red-600 hover:text-red-800 font-bold px-2 rounded ml-2 cursor-pointer"
          data-action="click->document-upload#removeFile" data-index="${i}">&times;</button>
      </li>
    `).join("");
  }
  updateSubmitState() {
    if (this.hasSubmitBtnTarget) this.submitBtnTarget.disabled = !this.files.length;
  }
  formatSize(bytes) {
  ...
  openModal() {
    this.isEdit = false;
    this.loadModalContent("new", this.uploadTitleValue || "Documents Upload");
  }
  openEditModal(e) {
    this.isEdit = true;
    this.loadModalContent(`${e.currentTarget.dataset.documentId}/edit`, this.editTitleValue || "Document Edit");
  }
  loadModalContent(path, title) {
    if (this.hasModalTitleTarget) this.modalTitleTarget.textContent = title;
    fetch(`/documents/${path}?page=${this.currentPageValue || 1}`).then((res) => res.ok ? res.text() : Promise.reject("Failed to load form")).then((html) => {
  ...
  openModalUI() {
    this.modalTarget.classList.replace("hidden", "flex");
  ...
  // Form submission
  handleFormSubmit(e) {
    if (!this.isEdit || !this.files.length) return;
    e.preventDefault();
    const formData = new FormData(this.formTarget);
    formData.delete("document[file]");
    formData.append("document[file]", this.files[0]);
    ...
    }).then((res) => res.ok ? res.text() : Promise.reject("Network error")).then(renderStreamMessage).catch(console.error);
  }
  // Loader
  showLoader() {
    this.closeModal();
    setTimeout(() => document.getElementById("loader")?.classList.remove("hidden"), 100);
  }
  hideLoader() {
...
var document_controller_default = class extends Controller {
  ...
  verify(event2) {
    event2.preventDefault();
    const modal = document.getElementById("document-verification-modal");
    this.currentId = event2.currentTarget.dataset.documentId;
    const currentStatus = event2.currentTarget.dataset.documentStatus;
    const currentRejectionReason = event2.currentTarget.dataset.documentRejectionReason;
    const currentQueryDescription = event2.currentTarget.dataset.queryDescription;
    const currentCommentDescription = event2.currentTarget.dataset.commentDescription;
    const commentsJSON = event2.currentTarget.dataset.documentComments;
    const comments = commentsJSON ? JSON.parse(commentsJSON) : [];
    const validStatuses = Array.from(this.statusFieldTarget.options).map((option) => option.value);
    if (currentStatus && validStatuses.includes(currentStatus)) {
      this.statusFieldTarget.value = currentStatus;
    } else {
      this.statusFieldTarget.selectedIndex = 0;
    }
    this.rejectionReasonFieldTarget.value = currentRejectionReason || "";
    if (currentStatus === "query_raised") {
      this.descriptionFieldTarget.value = currentQueryDescription || "";
    } else if (currentStatus === "query_resolved") {
      this.descriptionFieldTarget.value = currentCommentDescription || "";
    } else {
      this.descriptionFieldTarget.value = "";
    }
    this.updatePreviousComments(comments);
    this.toggleConditionalFields();
    modal.classList.remove("hidden");
    this.clearErrors();
  }
  updatePreviousComments(comments) {
    if (comments.length === 0) {
      this.previousCommentsSectionTarget.classList.add("hidden");
      this.previousCommentsSectionTarget.innerHTML = "";
      return;
    }
    this.previousCommentsSectionTarget.innerHTML = `
      <p class="text-lg font-semibold mb-4 text-neutral-900 dark:text-white">Previous Comments</p>
      <ul class="max-h-48 overflow-y-auto space-y-2 pr-2 scrollbar-thin scrollbar-thumb-rounded scrollbar-thumb-gray-400 dark:scrollbar-thumb-gray-700">
        ${comments.map((comment) => `
          <li class="p-2 border border-neutral-300 dark:border-neutral-700 rounded-md bg-gray-50 dark:bg-gray-800 text-xs shadow-sm">
            <div class="flex items-center justify-between mb-1">
              <span class="px-1.5 py-0.25 font-semibold rounded ${comment.type === "query" ? "bg-yellow-200 text-yellow-800 dark:bg-yellow-600 dark:text-yellow-100" : "bg-green-200 text-green-800 dark:bg-green-600 dark:text-green-100"}">
                ${comment.type === "query" ? "Query" : "Comment"}
              </span>
              <time class="text-gray-500 dark:text-gray-400">${comment.created_at}</time>
            </div>
            <p class="pl-4 text-neutral-700 dark:text-gray-300 truncate" title="${comment.description}">
              ${comment.description.length > 60 ? comment.description.substring(0, 60) + "..." : comment.description}
            </p>
          </li>
        `).join("")}
      </ul>
    `;
    this.previousCommentsSectionTarget.classList.remove("hidden");
  }
  cancelVerification() {
  ...
  setupStatusChangeListener() {
    this.statusFieldTarget.addEventListener("change", () => {
      this.toggleConditionalFields();
      this.clearErrors();
    });
  }
  toggleConditionalFields() {
    ...
    if (status === "rejected") {
      this.rejectionReasonContainerTarget.classList.remove("hidden");
      this.descriptionContainerTarget.classList.add("hidden");
      this.commentTypeFieldTarget.value = "";
    } else {
      this.rejectionReasonContainerTarget.classList.add("hidden");
      this.rejectionReasonFieldTarget.value = "";
    }
    if (status === "query_raised") {
      this.descriptionContainerTarget.classList.remove("hidden");
      this.commentTypeFieldTarget.value = "query";
    } else if (status === "query_resolved") {
      this.descriptionContainerTarget.classList.remove("hidden");
      this.commentTypeFieldTarget.value = "comment";
    } else {
      this.descriptionContainerTarget.classList.add("hidden");
      this.commentTypeFieldTarget.value = "";
    }
    if (this.hasPreviousCommentsSectionTarget) {
      const showStatuses = ["query_raised", "query_resolved"];
      if (showStatuses.includes(status)) {
        this.previousCommentsSectionTarget.classList.remove("hidden");
      } else {
        this.previousCommentsSectionTarget.classList.add("hidden");
      }
  ...
  clearErrors() {
    ...
    this.rejectionReasonErrorTarget.classList.add("hidden");
  ...
  async submitVerification(event2) {
    event2.preventDefault();
    this.clearErrors();
    if (!this.currentId) {
      this.showError(this.formErrorTarget, "No document selected");
      return;
    }
    const status = this.statusFieldTarget.value;
    const rejectionReason = this.rejectionReasonFieldTarget.value.trim();
    const description = this.descriptionFieldTarget.value.trim();
    if (status === "rejected" && !rejectionReason) {
      this.showError(this.rejectionReasonErrorTarget, "Reason is required when rejecting a document");
      return;
    }
    if ((status === "query_raised" || status === "query_resolved") && !description) {
    ...
    const urlWithPage = `${this.urlValue}/${this.currentId}/verify?page=${this.currentPageValue}`;
    try {
      const response = await fetch(urlWithPage, {
        ...
        body: JSON.stringify({
          ...
          document_comment_description: description,
          comment_type: this.commentTypeFieldTarget.value
        })
      });
      ...
      if (response.ok) {
        if (contentType && contentType.includes("text/vnd.turbo-stream.html")) {
          ...
          renderStreamMessage(turboStream);
          ...
          if (data.status === "success") {
            ...
            this.showError(this.formErrorTarget, data.error || "Failed to verify document");
          }
        }
      } else {
        const data = await response.json();
        if (data.errors) {
          if (data.errors.status) {
            this.showError(this.statusErrorTarget, data.errors.status.join(", "));
          }
          if (data.errors.rejection_reason) {
            this.showError(this.rejectionReasonErrorTarget, data.errors.rejection_reason.join(", "));
          }
          if (data.errors.document_comment_description) {
            this.showError(this.descriptionErrorTarget, data.errors.document_comment_description.join(", "));
          }
          if (data.errors.base) {
            this.showError(this.formErrorTarget, data.errors.base.join(", "));
          }
        } else {
          this.showError(this.formErrorTarget, data.error || "Failed to verify document");
        }
      ...
      this.showError(this.formErrorTarget, "Network error - please try again");
    } finally {
...
var confirm_delete_controller_default = class extends Controller {
  ...
  confirm(event2) {
    event2.preventDefault();
    this.formElement = event2.target.closest("form");
...
// app/javascript/controllers/client_modal_controller.js
var client_modal_controller_default = class extends Controller {
  static targets = [
    "modal",
    "createModal",
    "nameField",
  ...
  closeBackground(event2) {
    if (event2.target === this.createModalTarget) {
      this.close();
    }
  }
  ...
  async submit(event2) {
    ...
    const body = {
      client: {
        ...
        profile_attributes: {
          mobile_no: this.mobileFieldTarget?.value || "",
          pan_no: this.panFieldTarget?.value || "",
          gst_no: this.gstFieldTarget?.value || "",
          business_type: this.businessTypeFieldTarget?.value || "",
          address: this.addressFieldTarget?.value || "",
          whatsapp_no: this.whatsappFieldTarget?.value || ""
        }
      }
    };
  ...
  handleErrors(errors) {
    ...
    if (errors.client) {
      Object.entries(errors.client).forEach(([field, messages]) => {
        this.showError(field, uniqueMessages(messages).join(", "));
      });
    }
  }
  clearErrors() {
  ...
  showError(field, message) {
    console.log("showError", field, "message:", message);
    const errorTarget = `${field}ErrorTarget`;
    if (this[errorTarget]) {
      this[errorTarget].textContent = this.capitalizeFirstLetter(field) + " " + message;
...
var group_controller_default = class extends Controller {
  static targets = ["modal", "editModal"];
  connect() {
  }
  openModal() {
    this.modalTarget.classList.remove("hidden");
  ...
  openEditModal() {
    ...
    const editpath = parsedData.path;
    fetch(editpath, {
      method: "GET",
      headers: {
        Accept: "application/json"
      ...
      this.editModalTarget.innerHTML = html;
...
// app/javascript/controllers/users_edit_controller.js
var users_edit_controller_default = class extends Controller {
  static targets = ["modal", "nameField", "emailField", "form", "nameError"];
  ...
  edit(event2) {
    ...
    this.currentId = row.dataset.userId;
    this.nameFieldTarget.value = row.querySelector("td:nth-child(1)").textContent.trim();
    this.emailFieldTarget.value = row.querySelector("td:nth-child(2)").textContent.trim();
    this.clearErrors();
    this.modalTarget.classList.remove("hidden");
  }
  cancel() {
  ...
  clearErrors() {
    if (this.hasNameErrorTarget) this.nameErrorTarget.classList.add("hidden");
  }
  showError(field, message) {
    const errorTarget = `${field}ErrorTarget`;
    if (this[errorTarget]) {
  ...
  async submit(event2) {
    event2.preventDefault();
    if (!this.currentId) {
      this.showError("name", "No user selected");
      return;
    }
    this.clearErrors();
    const urlParams = new URLSearchParams(window.location.search);
    const currentPage = urlParams.get("page") || 1;
    fetch(`${this.urlValue}/${this.currentId}?page=${currentPage}`, {
      method: "PATCH",
      headers: {
        "X-CSRF-Token": document.querySelector("[name='csrf-token']").content,
        "Content-Type": "application/json",
      ...
      if (response.ok && contentType.includes("text/vnd.turbo-stream.html")) {
        return response.text().then((html) => ({ type: "turbo", html }));
      }
      ...
      if (result.type === "turbo") {
        renderStreamMessage(result.html);
        this.cancel();
      } else if (result.type === "json") {
        if (result.data.errors) {
          if (result.data.errors.name) {
            this.showError("name", result.data.errors.name.join(", "));
          } else {
            this.showError("name", "Failed to update");
          }
        }
      ...
      this.clearErrors();
      this.showError("name", "Network error - please try again");
    });
  }
};

// app/javascript/controllers/client_edit_controller.js
var client_edit_controller_default = class extends Controller {
  static targets = [
    "modal",
    "form",
    "nameField",
  ...
  edit(event2) {
    event2.preventDefault();
    const row = event2.target.closest("tr");
    this.currentId = row.dataset.clientId;
    if (!this.currentId) {
      console.error("No ID found for resource");
      return;
    }
    fetch(`${this.editUrlValue}/${this.currentId}/edit`, {
      headers: { "Accept": "application/json" }
    }).then((response) => response.json()).then((data) => {
      if (this.hasNameFieldTarget) this.nameFieldTarget.value = data.name || "";
      if (this.hasEmailFieldTarget) this.emailFieldTarget.value = data.email || "";
      if (data.profile) {
        if (this.hasMobileFieldTarget) this.mobileFieldTarget.value = data.profile.mobile_no || "";
        if (this.hasWhatsappFieldTarget) this.whatsappFieldTarget.value = data.profile.whatsapp_no || "";
        if (this.hasPanFieldTarget) this.panFieldTarget.value = data.profile.pan_no || "";
        if (this.hasGstFieldTarget) this.gstFieldTarget.value = data.profile.gst_no || "";
        if (this.hasBusinessTypeFieldTarget) {
          this.businessTypeFieldTarget.value = data.profile.business_type || "";
        }
        if (this.hasAddressFieldTarget) this.addressFieldTarget.value = data.profile.address || "";
      }
      this.clearErrors();
      this.modalTarget.classList.remove("hidden");
    }).catch((error2) => {
      console.error("Error:", error2);
      this.showError("name", "Failed to load details");
    });
  }
  async submit(event2) {
    event2.preventDefault();
    if (!this.currentId) {
      this.showError("name", "No client selected");
      return;
    }
    const urlParams = new URLSearchParams(window.location.search);
    const currentPage = urlParams.get("page") || 1;
    ...
    Object.keys(body.client.profile_attributes).forEach((key) => {
      if (body.client.profile_attributes[key] === "") {
        delete body.client.profile_attributes[key];
      }
    });
    this.clearErrors();
    fetch(`${this.editUrlValue}/${this.currentId}?page=${currentPage}`, {
      method: "PATCH",
      headers: {
        "X-CSRF-Token": document.querySelector("[name='csrf-token']").content,
        "Content-Type": "application/json",
      ...
      if (result.type === "turbo") {
        renderStreamMessage(result.html);
        setTimeout(() => document.querySelector(".flash, .alert, .notice")?.remove(), 3e3);
        this.cancel();
      } else if (result.type === "json") {
        this.handleErrors(result.data.errors);
      }
    }).catch((error2) => {
      console.error("Error:", error2);
      this.clearErrors();
      this.showError("name", "Something went wrong. Please try again.");
    });
  }
  handleErrors(errors) {
    if (!errors) return;
    ...
    if (errors.profile) {
      Object.entries(errors.profile).forEach(([field, messages]) => {
        const targetField = field.replace("_no", "");
        this.showError(targetField, uniqueMessages(messages).join(", "));
      });
    }
    if (errors.client) {
      Object.entries(errors.client).forEach(([field, messages]) => {
    ...
    if (errors.base) {
      this.showError("name", uniqueMessages(errors.base).join(", "));
    }
  }
  cancel() {
    this.modalTarget.classList.add("hidden");
...
// app/javascript/controllers/admin/supervisor/allocate_manager_controller.js
var allocate_manager_controller_default = class extends Controller {
  static targets = ["assignManagerModal", "assignManagerModalChosenManager", "assignButton"];
  setSupervisor(event2) {
    event2.preventDefault();
    const supervisorId = event2.currentTarget.dataset.supervisorId;
    const managerId = event2.currentTarget.dataset.managerId;
    this.assignManagerModalTarget.dataset.supervisorId = supervisorId;
    this.showModal();
    if (managerId) {
      this.assignManagerModalChosenManagerTarget.value = managerId;
    }
    this.updateAssignButtonState();
  }
  allocate(event2) {
    if (this.assignButtonTarget.disabled) return;
    event2.preventDefault();
    const supervisorId = this.assignManagerModalTarget.dataset.supervisorId;
    const managerIds = [this.assignManagerModalChosenManagerTarget.value];
    const apiUrl = `/admin/supervisors/${supervisorId}/assign_managers`;
    const urlParams = new URLSearchParams(window.location.search);
    const currentPage = urlParams.get("page") || 1;
    fetch(apiUrl, {
      method: "POST",
      ...
      body: JSON.stringify({ manager_ids: managerIds, page: currentPage })
    }).then(async (response) => {
      if (response.ok) {
        const turboStream = await response.text();
        renderStreamMessage(turboStream);
        ...
        console.error("Turbo Stream request failed:", response.statusText);
      }
    }).catch((error2) => {
      console.error("Error:", error2);
    });
  ...
  connect() {
    this.assignManagerModalChosenManagerTarget.addEventListener("change", this.updateAssignButtonState.bind(this));
  }
  updateAssignButtonState() {
    const managerSelected = this.assignManagerModalChosenManagerTarget.value !== "";
    this.assignButtonTarget.disabled = !managerSelected;
    if (managerSelected) {
      this.assignButtonTarget.classList.remove("bg-blue-500", "dark:bg-blue-900", "cursor-not-allowed");
      this.assignButtonTarget.classList.add("bg-blue-600", "hover:bg-blue-700", "cursor-pointer");
    } else {
      this.assignButtonTarget.classList.remove("bg-blue-600", "hover:bg-blue-700", "cursor-pointer");
      this.assignButtonTarget.classList.add("bg-blue-500", "dark:bg-blue-900", "cursor-not-allowed");
    }
  }
  showModal() {
    this.assignManagerModalTarget.classList.remove("hidden");
  }
  hideModal() {
    this.assignManagerModalTarget.classList.add("hidden");
    this.assignManagerModalChosenManagerTarget.value = "";
    this.updateAssignButtonState();
  }
};

// app/javascript/controllers/admin/data_entry_operator/allocate_users_controller.js
var allocate_users_controller_default = class extends Controller {
  static targets = [
    "assignUsersModal",
    "assignUsersModalChosenManager",
    "assignUsersModalChosenSupervisor",
    "assignButton"
  ];
  setDataEntryOperator(event2) {
    event2.preventDefault();
    const dataEntryOperatorId = event2.currentTarget.dataset.dataEntryOperatorId;
    this.currentDataEntryOperatorId = dataEntryOperatorId;
    const managerId = event2.currentTarget.dataset.managerId;
    const supervisorId = event2.currentTarget.dataset.supervisorId;
    this.showModal();
    if (managerId) {
      this.assignUsersModalChosenManagerTarget.value = managerId;
      this.managerChanged();
      if (supervisorId) {
        setTimeout(() => {
          this.assignUsersModalChosenSupervisorTarget.value = supervisorId;
          this.updateAssignButtonState();
        }, 300);
      }
    }
  ...
  allocate(event2) {
    if (this.assignButtonTarget.disabled) return;
    event2.preventDefault();
    const dataEntryOperatorId = this.currentDataEntryOperatorId;
    const managerIds = this.assignUsersModalChosenManagerTarget.value ? [this.assignUsersModalChosenManagerTarget.value] : [];
    const supervisorIds = this.assignUsersModalChosenSupervisorTarget.value ? [this.assignUsersModalChosenSupervisorTarget.value] : [];
    const apiUrl = `/admin/data_entry_operators/${dataEntryOperatorId}/assign_users`;
    const urlParams = new URLSearchParams(window.location.search);
    const currentPage = urlParams.get("page") || 1;
    fetch(apiUrl, {
      method: "POST",
  ...
  connect() {
    this.assignUsersModalChosenManagerTarget.addEventListener("change", this.managerChanged.bind(this));
    this.assignUsersModalChosenSupervisorTarget.addEventListener("change", this.updateAssignButtonState.bind(this));
  }
  managerChanged(event2) {
    if (event2 && typeof event2.preventDefault === "function") {
      event2.preventDefault();
    }
    const dataEntryOperatorId = this.currentDataEntryOperatorId;
    const managerId = event2 ? event2.target.value : this.assignUsersModalChosenManagerTarget.value;
    const supervisorSelect = this.assignUsersModalChosenSupervisorTarget;
    supervisorSelect.innerHTML = "";
    supervisorSelect.disabled = true;
    supervisorSelect.classList.add("cursor-not-allowed", "bg-gray-100", "dark:bg-neutral-700", "text-gray-500", "dark:text-gray-400");
    supervisorSelect.classList.remove("cursor-pointer", "bg-white", "dark:bg-neutral-800", "text-gray-900", "dark:text-white");
    if (!managerId) {
      const defaultOption = document.createElement("option");
      defaultOption.value = "";
      defaultOption.text = "Select Supervisor (choose manager first)";
      supervisorSelect.appendChild(defaultOption);
      this.updateAssignButtonState();
      return;
    }
    fetch(`/admin/data_entry_operators/${dataEntryOperatorId}/manager_supervisors?manager_id=${managerId}`, {
      headers: {
        "Accept": "application/json"
      }
    }).then((response) => response.json()).then((data) => {
      ...
      const defaultOption = document.createElement("option");
      defaultOption.value = "";
      defaultOption.text = data.length > 0 ? "Select Supervisor" : "No supervisors available";
      supervisorSelect.appendChild(defaultOption);
      ...
      if (data.length > 0) {
        ...
        supervisorSelect.classList.remove("cursor-not-allowed", "bg-gray-100", "dark:bg-neutral-700", "text-gray-500", "dark:text-gray-400");
        supervisorSelect.classList.add("cursor-pointer", "bg-white", "dark:bg-neutral-800", "text-gray-900", "dark:text-white");
      }
      this.updateAssignButtonState();
    }).catch((error2) => {
      console.error("Error fetching supervisors:", error2);
      const errorOption = document.createElement("option");
      errorOption.value = "";
      errorOption.text = "Error loading supervisors";
      supervisorSelect.appendChild(errorOption);
      this.updateAssignButtonState();
    });
  }
  updateAssignButtonState() {
    const managerSelected = this.assignUsersModalChosenManagerTarget.value !== "";
    const supervisorSelected = this.assignUsersModalChosenSupervisorTarget.value !== "";
    const hasSupervisors = this.assignUsersModalChosenSupervisorTarget.querySelectorAll("option").length > 1;
    const shouldEnable = managerSelected && !hasSupervisors || managerSelected && supervisorSelected;
    this.assignButtonTarget.disabled = !shouldEnable;
    if (shouldEnable) {
      this.assignButtonTarget.classList.remove("bg-blue-500", "dark:bg-blue-900", "cursor-not-allowed");
      this.assignButtonTarget.classList.add("bg-blue-600", "hover:bg-blue-700", "cursor-pointer");
    } else {
  ...
  showModal() {
    this.assignUsersModalTarget.classList.remove("hidden");
    document.body.classList.add("overflow-hidden");
    this.updateAssignButtonState();
  }
  hideModal() {
    this.assignUsersModalTarget.classList.add("hidden");
    document.body.classList.remove("overflow-hidden");
    this.assignUsersModalChosenManagerTarget.value = "";
    const supervisorSelect = this.assignUsersModalChosenSupervisorTarget;
    supervisorSelect.innerHTML = "";
    const defaultOption = document.createElement("option");
    defaultOption.value = "";
...
// app/javascript/controllers/admin/client/allocate_users_controller.js
var allocate_users_controller_default2 = class extends Controller {
  static targets = [
    "assignUsersModal",
    "assignUsersModalChosenManager",
    "assignUsersModalChosenSupervisor",
    "assignUsersModalChosenDataEntryOperator",
    "assignButton"
  ];
  setClient(event2) {
    event2.preventDefault();
    const clientId = event2.currentTarget.dataset.clientId;
    ...
    if (managerId) {
      ...
      if (supervisorId) {
        setTimeout(() => {
          this.assignUsersModalChosenSupervisorTarget.value = supervisorId;
          this.supervisorChanged();
          if (dataEntryOperatorId) {
            setTimeout(() => {
              this.assignUsersModalChosenDataEntryOperatorTarget.value = dataEntryOperatorId;
              this.updateAssignButtonState();
            }, 300);
          }
        }, 300);
  ...
  allocate(event2) {
    ...
    const managerIds = this.assignUsersModalChosenManagerTarget.value ? [this.assignUsersModalChosenManagerTarget.value] : [];
    const supervisorIds = this.assignUsersModalChosenSupervisorTarget.value ? [this.assignUsersModalChosenSupervisorTarget.value] : [];
    const dataEntryOperatorIds = this.assignUsersModalChosenDataEntryOperatorTarget.value ? [this.assignUsersModalChosenDataEntryOperatorTarget.value] : [];
    const apiUrl = `/admin/clients/${clientId}/assign_users`;
    const urlParams = new URLSearchParams(window.location.search);
    const currentPage = urlParams.get("page") || 1;
    fetch(apiUrl, {
      method: "POST",
      ...
      body: JSON.stringify({
        manager_ids: managerIds,
        supervisor_ids: supervisorIds,
        data_entry_operator_ids: dataEntryOperatorIds,
        page: currentPage
      })
    }).then(async (response) => {
      if (response.ok) {
  ...
  connect() {
    this.assignUsersModalChosenManagerTarget.addEventListener("change", this.managerChanged.bind(this));
    this.assignUsersModalChosenSupervisorTarget.addEventListener("change", this.supervisorChanged.bind(this));
    this.assignUsersModalChosenDataEntryOperatorTarget.addEventListener("change", this.updateAssignButtonState.bind(this));
  }
  managerChanged(event2) {
    if (event2 && typeof event2.preventDefault === "function") {
      event2.preventDefault();
    ...
    const managerId = event2 ? event2.target.value : this.assignUsersModalChosenManagerTarget.value;
    const supervisorSelect = this.assignUsersModalChosenSupervisorTarget;
    const dataEntryOperatorSelect = this.assignUsersModalChosenDataEntryOperatorTarget;
    supervisorSelect.innerHTML = "";
    supervisorSelect.disabled = true;
    supervisorSelect.classList.add("cursor-not-allowed", "bg-gray-100", "dark:bg-neutral-700", "text-gray-500", "dark:text-gray-400");
    supervisorSelect.classList.remove("cursor-pointer", "bg-white", "dark:bg-neutral-800", "text-gray-900", "dark:text-white");
    dataEntryOperatorSelect.innerHTML = "";
    const defaultOperatorOption = document.createElement("option");
    defaultOperatorOption.value = "";
    defaultOperatorOption.text = "Select Data Entry Operator (choose supervisor first)";
    dataEntryOperatorSelect.appendChild(defaultOperatorOption);
    dataEntryOperatorSelect.disabled = true;
    dataEntryOperatorSelect.classList.add("cursor-not-allowed", "bg-gray-100", "dark:bg-neutral-700", "text-gray-500", "dark:text-gray-400");
    dataEntryOperatorSelect.classList.remove("cursor-pointer", "bg-white", "dark:bg-neutral-800", "text-gray-900", "dark:text-white");
    if (!managerId) {
      const defaultOption = document.createElement("option");
      defaultOption.value = "";
      defaultOption.text = "Select Supervisor (choose manager first)";
    ...
    fetch(`/admin/clients/${clientId}/manager_supervisors?manager_id=${managerId}`, {
      headers: {
        "Accept": "application/json"
      }
    }).then((response) => response.json()).then((data) => {
      ...
      if (data.length > 0) {
        const defaultOption = document.createElement("option");
        defaultOption.value = "";
        defaultOption.text = "Select Supervisor";
        supervisorSelect.appendChild(defaultOption);
      }
      data.forEach((supervisor) => {
        const option = document.createElement("option");
      ...
      if (data.length > 0) {
        ...
        const noSupervisorsOption = document.createElement("option");
        noSupervisorsOption.value = "";
        noSupervisorsOption.text = "No supervisors available";
        supervisorSelect.appendChild(noSupervisorsOption);
      }
      this.updateAssignButtonState();
    }).catch((error2) => {
      console.error("Error fetching supervisors:", error2);
  ...
  supervisorChanged(event2) {
    if (event2 && typeof event2.preventDefault === "function") {
      event2.preventDefault();
    }
    const clientId = this.currentclientId;
    const supervisorId = event2 ? event2.target.value : this.assignUsersModalChosenSupervisorTarget.value;
    const dataEntryOperatorSelect = this.assignUsersModalChosenDataEntryOperatorTarget;
    dataEntryOperatorSelect.innerHTML = "";
    dataEntryOperatorSelect.disabled = true;
    dataEntryOperatorSelect.classList.add("cursor-not-allowed", "bg-gray-100", "dark:bg-neutral-700", "text-gray-500", "dark:text-gray-400");
    ...
    if (!supervisorId) {
      const defaultOption = document.createElement("option");
      defaultOption.value = "";
      defaultOption.text = "Select Data Entry Operator (choose supervisor first)";
      dataEntryOperatorSelect.appendChild(defaultOption);
      this.updateAssignButtonState();
      return;
    }
    fetch(`/admin/clients/${clientId}/supervisor_data_entry_operators?supervisor_id=${supervisorId}`, {
      headers: {
        "Accept": "application/json"
      }
    }).then((response) => response.json()).then((data) => {
      ...
      if (data.length > 0) {
        const defaultOption = document.createElement("option");
        defaultOption.value = "";
        defaultOption.text = "Select Data Entry Operator";
        dataEntryOperatorSelect.appendChild(defaultOption);
      }
      data.forEach((operator) => {
        ...
        dataEntryOperatorSelect.appendChild(option);
      });
      if (data.length > 0) {
        dataEntryOperatorSelect.disabled = false;
        dataEntryOperatorSelect.classList.remove("cursor-not-allowed", "bg-gray-100", "dark:bg-neutral-700", "text-gray-500", "dark:text-gray-400");
        dataEntryOperatorSelect.classList.add("cursor-pointer", "bg-white", "dark:bg-neutral-800", "text-gray-900", "dark:text-white");
      } else {
        const noOperatorsOption = document.createElement("option");
        noOperatorsOption.value = "";
        noOperatorsOption.text = "No data entry operators available";
        dataEntryOperatorSelect.appendChild(noOperatorsOption);
      }
      this.updateAssignButtonState();
    }).catch((error2) => {
      console.error("Error fetching data entry operators:", error2);
    });
  }
  updateAssignButtonState() {
    const managerSelected = this.assignUsersModalChosenManagerTarget.value !== "";
    const supervisorSelected = this.assignUsersModalChosenSupervisorTarget.value !== "";
    const dataEntryOperatorSelected = this.assignUsersModalChosenDataEntryOperatorTarget.value !== "";
    const hasSupervisors = this.assignUsersModalChosenSupervisorTarget.querySelectorAll("option").length > 1;
    const hasDataEntryOperators = this.assignUsersModalChosenDataEntryOperatorTarget.querySelectorAll("option").length > 1;
    const shouldEnable = managerSelected && !hasSupervisors || managerSelected && supervisorSelected && !hasDataEntryOperators || managerSelected && supervisorSelected && dataEntryOperatorSelected;
    this.assignButtonTarget.disabled = !shouldEnable;
    if (shouldEnable) {
      this.assignButtonTarget.classList.remove("bg-blue-500", "dark:bg-blue-900", "cursor-not-allowed");
      this.assignButtonTarget.classList.add("bg-blue-600", "hover:bg-blue-700", "cursor-pointer");
  ...
  hideModal() {
    ...
    const supervisorSelect = this.assignUsersModalChosenSupervisorTarget;
    supervisorSelect.innerHTML = "";
    const defaultSupervisorOption = document.createElement("option");
    defaultSupervisorOption.value = "";
    defaultSupervisorOption.text = "Select Supervisor (choose manager first)";
    supervisorSelect.appendChild(defaultSupervisorOption);
    supervisorSelect.disabled = true;
    supervisorSelect.classList.add("cursor-not-allowed", "bg-gray-100", "dark:bg-neutral-700", "text-gray-500", "dark:text-gray-400");
    supervisorSelect.classList.remove("cursor-pointer", "bg-white", "dark:bg-neutral-800", "text-gray-900", "dark:text-white");
    const dataEntryOperatorSelect = this.assignUsersModalChosenDataEntryOperatorTarget;
...
// app/javascript/controllers/add_user_controller.js
var add_user_controller_default = class extends Controller {
  static targets = ["modal", "form", "nameField", "emailField", "nameError", "emailError", "submitButton", "modalHeader"];
  static values = {
    url: String
  };
  show() {
  ...
  submit(e) {
    ...
    fetch(this.urlValue, {
      ...
      const contentType = response.headers.get("Content-Type");
      if (contentType && contentType.includes("text/vnd.turbo-stream.html")) {
        return response.text().then((html) => renderStreamMessage(html));
      }
      return response.json();
    }).then(() => {
      this.hide();
    }).catch((error2) => {
      this.handleErrors(error2.errors);
    }).finally(() => {
...
// app/javascript/controllers/supervisors/assign_deo_controller.js
var assign_deo_controller_default = class extends Controller {
  static targets = ["assignDeoModal", "assignDeoModalChosenDeo"];
  connect() {
    console.log("Assign Deo Controller connected");
  }
  setClient(event2) {
    console.log("Set client triggered");
    event2.preventDefault();
    const clientId = event2.currentTarget.dataset.clientId;
    const currentDeoId = event2.currentTarget.dataset.currentDeoId;
    this.assignDeoModalTarget.dataset.clientId = clientId;
    event2.currentTarget.dataset.currentDeoId = currentDeoId;
    if (currentDeoId) {
      this.assignDeoModalChosenDeoTarget.value = currentDeoId;
    } else {
      this.assignDeoModalChosenDeoTarget.value = "";
    }
    this.showModal();
  }
  async allocate(event2) {
    event2.preventDefault();
    const clientId = this.assignDeoModalTarget.dataset.clientId;
    const deoIds = [this.assignDeoModalChosenDeoTarget.value];
    const clientRow = document.querySelector(`tr[data-entry-operator-id="${clientId}"]`);
    const deoCell = clientRow.querySelector("td:nth-child(3)");
    const assignButton = clientRow.querySelector('[data-action="click->supervisors--assign-deo#setClient"]');
    try {
      const response = await fetch(`/supervisors/clients/${clientId}/assign_deos`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "X-CSRF-Token": document.querySelector("meta[name='csrf-token']").content,
        ...
        body: JSON.stringify({ deo_ids: deoIds })
      });
      if (response.ok) {
        const data = await response.json();
        if (data.success) {
          if (data.deo_names && data.deo_names.length > 0) {
            deoCell.innerHTML = data.deo_names.join(", ");
          } else {
            deoCell.innerHTML = '<span class="text-gray-400">-</span>';
          }
          if (assignButton) {
            assignButton.dataset.currentDeoId = deoIds[0] || "";
          }
          this.showFlashMessage("success", "Data Entry Operator assigned successfully!");
        }
      } else {
      ...
      console.error("Error:", error2);
      this.showFlashMessage("error", "Failed to assign Data Entry Operator");
    } finally {
      this.hideModal();
    }
  }
  showModal() {
    this.assignDeoModalTarget.classList.remove("hidden");
    document.body.classList.add("overflow-hidden");
  }
  hideModal() {
    this.assignDeoModalTarget.classList.add("hidden");
    document.body.classList.remove("overflow-hidden");
  }
};

// app/javascript/controllers/manager/data_entry_operator/allocate_supervisor_controller.js
var allocate_supervisor_controller_default = class extends Controller {
  static targets = ["assignSupervisorModal", "chosenSupervisor"];
  setSupervisor(event2) {
    event2.preventDefault();
    const deoId = event2.currentTarget.dataset.deoId;
    this.assignSupervisorModalTarget.dataset.deoId = deoId;
    fetch("/managers/fetch_supervisors", {
      method: "GET",
      headers: {
        Accept: "application/json"
      }
      ...
      const html = data.html;
      this.assignSupervisorModalTarget.innerHTML = html;
      this.assignSupervisorModalTarget.classList.remove("hidden");
    }).catch((error2) => {
      console.error("error", error2);
    });
  }
  allocate(event2) {
    event2.preventDefault();
    const deoId = this.assignSupervisorModalTarget.dataset.deoId;
    const supervisorIds = this.chosenSupervisorTarget.value;
    const apiUrl = `/managers/data_entry_operators/${deoId}/assign_supervisor`;
    const urlParams = new URLSearchParams(window.location.search);
    const currentPage = urlParams.get("page") || 1;
    console.log("urlParams", urlParams, "-- currentPage--- ", currentPage);
    fetch(apiUrl, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      ...
      body: JSON.stringify({ supervisorIds: [supervisorIds], page: currentPage })
    }).then((response) => {
  ...
  hideModal() {
    this.assignSupervisorModalTarget.classList.add("hidden");
  }
};

// app/javascript/controllers/manager/client/allocate_supervisor_deo_controller.js
var allocate_supervisor_deo_controller_default = class extends Controller {
  static targets = ["assignSupervisorDeoModal", "chosenSupervisor", "chosenDeo", "assignButton"];
  setSupervisor(event2) {
    event2.preventDefault();
    const clientId = event2.currentTarget.dataset.clientId;
    this.currentclientId = clientId;
    const supervisorId = event2.currentTarget.dataset.supervisorId;
    const dataEntryOperatorId = event2.currentTarget.dataset.dataEntryOperatorId;
    fetch("/managers/fetch_client_supervisors", {
      method: "GET",
      headers: {
        Accept: "application/json"
      }
      ...
      const html = data.html;
      this.assignSupervisorDeoModalTarget.innerHTML = html;
      this.assignSupervisorDeoModalTarget.classList.remove("hidden");
      if (supervisorId) {
        setTimeout(() => {
          this.chosenSupervisorTarget.value = supervisorId;
          this.changeSupervisor();
          if (dataEntryOperatorId) {
            setTimeout(() => {
              this.chosenDeoTarget.value = dataEntryOperatorId;
            }, 300);
          }
        }, 300);
      }
  ...
  changeSupervisor(event2) {
    const clientId = this.currentclientId;
    const supervisorId = event2 ? event2.target.value : this.chosenSupervisorTarget.value;
    const dataEntryOperatorSelect = this.chosenDeoTarget;
    dataEntryOperatorSelect.disabled = false;
    dataEntryOperatorSelect.innerHTML = "";
    dataEntryOperatorSelect.disabled = true;
    dataEntryOperatorSelect.classList.add("cursor-not-allowed", "bg-gray-100", "dark:bg-neutral-700", "text-gray-500", "dark:text-gray-400");
    ...
    fetch(`/managers/clients/${clientId}/supervisor_data_entry_operators?supervisor_id=${supervisorId}`, {
      headers: {
        "Accept": "application/json"
      }
    }).then((response) => response.json()).then((data) => {
  ...
  changeDataEntryOperator() {
    this.updateAssignButtonState();
  }
  allocate(event2) {
    event2.preventDefault();
    const deoIds = this.chosenDeoTarget.value;
    const supervisorIds = this.chosenSupervisorTarget.value;
    const apiUrl = `/managers/clients/${this.currentclientId}/assign_users`;
    const urlParams = new URLSearchParams(window.location.search);
    const currentPage = urlParams.get("page") || 1;
    fetch(apiUrl, {
      method: "POST",
      ...
      body: JSON.stringify({ supervisorIds: [supervisorIds], deoIds: [deoIds], page: currentPage })
    }).then((response) => {
      if (response.redirected) {
        this.hideModal();
        window.location.href = response.url;
  ...
  hideModal() {
    this.assignSupervisorDeoModalTarget.classList.add("hidden");
    this.updateAssignButtonState();
  }
  updateAssignButtonState() {
    const supervisorSelected = this.chosenSupervisorTarget.value !== "";
    const dataEntryOperatorSelected = this.chosenDeoTarget.value !== "";
    const hasSupervisors = this.chosenSupervisorTarget.querySelectorAll("option").length > 1;
    const hasDataEntryOperators = this.chosenDeoTarget.querySelectorAll("option").length > 1;
    const shouldEnable = !hasSupervisors || supervisorSelected && !hasDataEntryOperators || supervisorSelected && dataEntryOperatorSelected;
    this.assignButtonTarget.disabled = !shouldEnable;
    if (shouldEnable) {
      this.assignButtonTarget.classList.remove("bg-blue-500", "dark:bg-blue-900", "cursor-not-allowed");
      this.assignButtonTarget.classList.add("bg-blue-600", "hover:bg-blue-700", "cursor-pointer");
...
// app/javascript/controllers/permissions_modal_controller.js
var permissions_modal_controller_default = class extends Controller {
  ...
  open(event2) {
    ...
    this.userType = button.dataset.userType;
    this.fetchPermissions();
  }
  fetchPermissions() {
    const path = `/admin/${this.userType}/${this.userId}/get_permissions`;
    fetch(path, {
      headers: { "Accept": "application/json" }
    }).then((response) => {
      if (!response.ok) throw new Error("Network response was not ok");
      return response.json();
    }).then((data) => this.renderPermissions(data)).catch((error2) => {
  ...
  renderPermissions(data) {
    ...
    const permissionsHtml = Object.entries(groupedPermissions).map(([subject, permissions]) => {
      const groupId = subject.toLowerCase().replace(/\s+/g, "_");
      const groupItems = permissions.map((permission) => {
        const isGroupPermission = data.group_permission_ids.includes(permission.id);
        const isChecked = isGroupPermission ? data.denied_permissions.includes(permission.id) : data.assigned_permissions.includes(permission.id);
        const labelTextColorClass = isGroupPermission ? "text-red-600 dark:!text-red-400" : "text-indigo-600 dark:!text-indigo-400";
        return `
          <div class="flex items-center py-2 px-3 border-b border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 rounded transition-colors permission-item pl-10" data-subject="${groupId}">
            <input type="checkbox"
              name="${isGroupPermission ? "denied_permission_ids[]" : "permission_ids[]"}"
              value="${permission.id}"
              ${isChecked ? "checked" : ""}
              class="h-5 w-5 border-gray-300 dark:border-gray-600 rounded mr-4 group-checkbox"
              data-group-id="${groupId}">
            <div class="flex-1">
              <div class="flex items-baseline">
                <span class="mr-2">${permission.name}</span>
                <small class="text-gray-600 dark:text-gray-400">(${permission.action} \u2022 ${permission.subject})</small>
              </div>
            </div>
            <span class="text-sm ${labelTextColorClass} font-medium">
              ${isGroupPermission ? "Deny" : "Allow"}
            </span>
          </div>
        `;
      }).join("");
      return `
        <details class="mb-4 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded">
          <summary class="cursor-pointer px-4 py-3 font-semibold text-lg text-gray-800 dark:text-gray-200">
            ${subject} Permissions
          </summary>
          <div class="px-4 py-2 flex items-center space-x-2 pl-6">
            <input
              type="checkbox"
              name="select_all_${groupId}"
              data-action="change->permissions-modal#toggleGroup"
              data-group-id="${groupId}"
              class="h-5 w-5 border-gray-300 dark:border-gray-600 rounded"
            />
            <label class="text-base text-gray-700 dark:text-gray-300 font-medium">Full access to ${subject} management</label>
          </div>
    ...
    `;
    Object.keys(groupedPermissions).forEach((subject) => {
      const groupId = subject.toLowerCase().replace(/\s+/g, "_");
      const groupCheckbox = this.contentTarget.querySelector(`input[name="select_all_${groupId}"]`);
      if (!groupCheckbox) return;
      const permissionCheckboxes = this.contentTarget.querySelectorAll(`.group-checkbox[data-group-id="${groupId}"]`);
  ...
  toggleGroup(event2) {
    const groupId = event2.currentTarget.dataset.groupId;
    const isChecked = event2.currentTarget.checked;
    const checkboxes = this.contentTarget.querySelectorAll(`.group-checkbox[data-group-id="${groupId}"]`);
  ...
  save(event2) {
    ...
    fetch(`/admin/${this.userType}/${this.userId}/assign_permissions`, {
      method: "POST",
      body: formData,
      headers: {
...
// app/javascript/controllers/groups_modal_controller.js
var groups_modal_controller_default = class extends Controller {
  static targets = ["modal", "content", "form"];
  connect() {
    this.userId = null;
    this.userType = null;
  ...
  fetchGroups() {
    const path = `/admin/${this.userType}/${this.userId}/get_groups`;
    fetch(path, {
      headers: { "Accept": "application/json" }
    }).then((res) => res.json()).then((data) => this.renderGroups(data)).catch((err) => console.error("Error fetching groups:", err));
  }
  renderGroups(data) {
    const groupsHtml = data.groups.map((group) => {
      const isChecked = data.assigned_group_ids.includes(group.id);
      return `
        <div class="flex items-center justify-between py-2 border-b border-gray-300 dark:border-gray-600">
          <!-- Checkbox -->
          <input type="checkbox"
                name="group_ids[]"
                value="${group.id}"
                ${isChecked ? "checked" : ""}
                class="h-5 w-5 border-gray-300 dark:border-gray-600 rounded mr-4">

          <!-- Group name and permissions count in one line -->
          <div class="flex items-center flex-grow space-x-2 text-lg text-gray-900 dark:text-gray-100">
  ...
  save(event2) {
    ...
    const urlParams = new URLSearchParams(window.location.search);
    const currentPage = urlParams.get("page") || 1;
    const path = `/admin/${this.userType}/${this.userId}/assign_groups?page=${currentPage}`;
    fetch(path, {
      method: "POST",
      body: formData,
      headers: {
...
var flatpickr_controller_default = class extends Controller {
  ...
  connect() {
    this.startPicker = window.flatpickr(this.startTarget, {
      dateFormat: "Y-m-d",
      clickOpens: false,
      // We'll handle opening manually
      disableMobile: true,
      // <--- Add this line
      onChange: (selectedDates) => {
        if (selectedDates.length && this.hasEndTarget) {
    ...
    this.startTarget.addEventListener("click", () => this.toggleCalendar(this.startPicker));
    this.endTarget.addEventListener("click", () => this.toggleCalendar(this.endPicker));
  }
  toggleCalendar(pickerInstance) {
...
// app/javascript/controllers/document_bulk_update_controller.js
var document_bulk_update_controller_default = class extends Controller {
  static targets = ["selectAll", "checkbox", "bulkDropdownToggle", "bulkDropdownMenu", "dropdownArrow"];
  static values = {
    url: String,
    currentPage: Number
  };
  connect() {
    if (!this.hasSelectAllTarget || !this.hasBulkDropdownToggleTarget || !this.hasBulkDropdownMenuTarget || !this.urlValue) {
      console.warn("document_bulk_update_controller: missing required targets or URL");
      return;
    }
    this.boundToggleAllCheckboxes = this.toggleAllCheckboxes.bind(this);
    this.boundUpdateDropdownState = this.updateDropdownState.bind(this);
    ...
    this.selectAllTarget.addEventListener("change", this.boundToggleAllCheckboxes);
    this.element.addEventListener("change", (e) => {
      if (e.target.matches("input.document-checkbox")) {
        this.updateDropdownState();
      }
    });
    this.bulkDropdownToggleTarget.addEventListener("click", this.boundToggleDropdownMenu);
    this.updateDropdownState();
  }
  disconnect() {
    this.selectAllTarget?.removeEventListener("change", this.boundToggleAllCheckboxes);
    this.checkboxTargets?.forEach((cb) => cb.removeEventListener("change", this.boundUpdateDropdownState));
    this.bulkDropdownToggleTarget?.removeEventListener("click", this.boundToggleDropdownMenu);
    document.removeEventListener("click", this.boundCloseDropdownMenu);
  }
  toggleAllCheckboxes() {
    ...
    if (someChecked) {
      ...
      this.selectAllTarget.checked = newState;
      this.selectAllTarget.indeterminate = false;
    }
    this.updateDropdownState();
  }
  updateDropdownState() {
    ...
    this.bulkDropdownToggleTarget.disabled = selectedCount === 0;
    ...
    if (selectedCount === 0) {
      this.bulkDropdownMenuTarget.classList.add("hidden");
      this.dropdownArrowTarget.classList.remove("rotate-180");
    }
  }
  toggleDropdownMenu(event2) {
    event2.stopPropagation();
    event2.preventDefault();
    if (this.bulkDropdownToggleTarget.disabled) return;
    if (this.bulkDropdownMenuTarget.classList.contains("hidden")) {
      this.bulkDropdownMenuTarget.classList.remove("hidden");
      this.dropdownArrowTarget.classList.add("rotate-180");
      document.addEventListener("click", this.boundCloseDropdownMenu, { once: true });
    } else {
      this.bulkDropdownMenuTarget.classList.add("hidden");
      this.dropdownArrowTarget.classList.remove("rotate-180");
    }
  }
  closeDropdownMenu(event2) {
    if (!this.element.contains(event2.target)) {
      this.bulkDropdownMenuTarget.classList.add("hidden");
      this.dropdownArrowTarget.classList.remove("rotate-180");
    }
  }
  async selectStatus(event2) {
    const status = event2.currentTarget.dataset.status;
    event2.preventDefault();
    const selectedDocumentIds = this.checkboxTargets.filter((cb) => cb.checked).map((cb) => cb.value);
    if (selectedDocumentIds.length === 0 || !status) {
      return;
    }
    const urlWithPage = `${this.urlValue}?page=${this.currentPageValue}`;
    try {
      const response = await fetch(urlWithPage, {
        method: "PATCH",
        headers: {
...
var message_controller_default = class extends Controller {
  static targets = ["input", "submitButton", "fileInput", "filePreviewContainer", "filePreviews", "messagesContainer"];
  connect() {
  ...
  initializeScrollTracking() {
    if (this.hasMessagesContainerTarget) {
      ...
      observer.observe(this.messagesContainerTarget, { childList: true, subtree: true });
      this.mutationObserver = observer;
      if (this.isElementVisible(this.messagesContainerTarget)) {
  ...
  checkEmptyState() {
    const messages = this.messagesContainerTarget.querySelectorAll('[id^="message_"]');
    const noMessagesElement = this.messagesContainerTarget.querySelector("#no-messages");
    ...
    this.observer = new IntersectionObserver(
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting && !this.userScrolledUp) {
            this.scrollToBottom({ behavior: "auto" });
          }
        });
      },
  ...
  handleScroll(event2) {
    const container = event2.target;
    const scrollTop = container.scrollTop;
    const scrollHeight = container.scrollHeight;
    const clientHeight = container.clientHeight;
    this.userScrolledUp = scrollTop + clientHeight < scrollHeight - 100;
    this.lastScrollPosition = scrollTop;
  }
  initialize() {
    document.addEventListener("turbo:frame-load", (event2) => {
      if (event2.target.id === "supervisor_message_blocks") {
        this.checkEmptyState();
        this.scrollToBottomIfNotScrolledUp();
      }
    });
    const originalRenderStreamMessage = turbo_es2017_esm_exports.renderStreamMessage;
    turbo_es2017_esm_exports.renderStreamMessage = async function(streamMessage) {
      await originalRenderStreamMessage.call(this, streamMessage);
      requestAnimationFrame(() => {
        const controllerElement = document.querySelector('[data-controller="message"]');
        if (controllerElement) {
          const controller = controllerElement[this.identifier] || controllerElement.controller;
          if (controller) {
            controller.checkEmptyState();
            controller.scrollToBottomIfNotScrolledUp();
          }
        }
      });
    }.bind(this);
  ...
  scrollToBottomIfNotScrolledUp() {
    if (!this.userScrolledUp && this.hasMessagesContainerTarget) {
      requestAnimationFrame(() => {
        setTimeout(() => this.scrollToBottom({ behavior: "auto" }), 50);
      });
    }
  }
  submitForm(event2) {
  ...
  toggleSubmitButton() {
    this.submitButtonTarget.style.display = this.hasContent() ? "flex" : "none";
  }
  triggerFileInput() {
    this.fileInputTarget.click();
  }
  displayFilePreview() {
    ...
    this.filePreviewsTarget.innerHTML = Array.from(this.fileInputTarget.files).map((file) => this.createFilePreview(file)).join("");
    this.filePreviewContainerTarget.classList.remove("hidden");
    this.toggleSubmitButton();
  }
  hasContent() {
    return this.inputTarget.value.trim() || this.fileInputTarget.files.length > 0;
  }
  clearForm() {
  ...
  createFilePreview(file) {
    return `
      <div class="flex items-center gap-2 bg-white dark:bg-neutral-600 rounded-lg p-2 flex-shrink-0">
        ${file.type.startsWith("image/") ? `<iconify-icon icon="heroicons:photo" class="text-4xl text-primary-600 dark:text-primary-400"></iconify-icon>` : `<iconify-icon icon="heroicons:document" class="text-lg"></iconify-icon>`}
        <span class="text-sm truncate max-w-[100px]">${file.name}</span>
        <button type="button" class="text-neutral-500 dark:text-neutral-300 hover:text-red-500"
                data-action="click->message#removeFile" data-filename="${file.name}">
          <iconify-icon icon="heroicons:x-mark" class="text-sm"></iconify-icon>
        </button>
      </div>`;
  }
  removeFile(event2) {
    const fileName = event2.target.closest("button").dataset.filename;
    const dataTransfer = new DataTransfer();
    Array.from(this.fileInputTarget.files).filter((file) => file.name !== fileName).forEach((file) => dataTransfer.items.add(file));
    this.fileInputTarget.files = dataTransfer.files;
    event2.target.closest("div").remove();
    this.toggleSubmitButton();
    if (this.filePreviewsTarget.children.length === 0) {
      this.filePreviewContainerTarget.classList.add("hidden");
    }
  }
  clearAllFiles() {
  ...
  scrollToBottom(options = { behavior: "smooth" }) {
    ...
    requestAnimationFrame(() => {
      const bottomOffset = container.offsetHeight * 0.1;
      container.scrollTo({
        top: container.scrollHeight + bottomOffset,
        ...options
      });
    });
  }
  showError() {
    ...
    alert2.className = "fixed top-4 right-4 bg-red-500 text-white px-4 py-2 rounded";
    alert2.textContent = "Failed to send message";
    document.body.appendChild(alert2);
    setTimeout(() => alert2.remove(), 3e3);
  }
};
...
var consumer_default = createConsumer3(document.getElementById("action_cable_js_config").dataset.actionCableHost);

// app/javascript/channels/chat_channel.js
var chatChannel = (recipientId) => {
  return consumer_default.subscriptions.create(
    { channel: "ChatChannel", recipient_id: recipientId },
    {
      connected() {
        console.log("Connected to private chat with user", recipientId);
      },
      received(data) {
        renderStreamMessage(data.turbo_stream);
      },
      speak(message) {
...
var chat_channel_default = chatChannel;

// app/javascript/controllers/client/message_controller.js
var message_controller_default2 = class extends Controller {
  static targets = ["input", "submitButton", "fileInput", "filePreviewContainer", "filePreviews"];
  connect() {
    this.scrollToBottom();
    this.userScrolledUp = false;
    ...
    if (recipientId) {
      chat_channel_default(recipientId);
    }
  ...
  handleTurboFrameLoad(event2) {
    if (event2.target.id === "client_message_blocks") {
      this.scrollToBottomIfNotScrolledUp();
    }
  }
  handleTurboStreamRender(event2) {
    event2.detail.render(event2);
    this.scrollToBottomIfNotScrolledUp();
  }
  scrollToBottomIfNotScrolledUp() {
  ...
  submitForm(event2) {
    ...
    }).then((response) => response.ok ? this.scrollToBottom() : this.showError()).catch(() => this.showError());
  }
  toggleSubmitButton() {
    this.submitButtonTarget.style.display = this.hasContent() ? "flex" : "none";
  }
  ...
  createFilePreview(file) {
    return `
      <div class="flex items-center gap-2 bg-white dark:bg-neutral-600 rounded-lg p-2 flex-shrink-0">
        ...
        <span class="text-sm truncate max-w-[100px]">${file.name}</span>
        <button type="button" class="text-neutral-500 dark:text-neutral-300 hover:text-red-500"
                data-action="click->client--message#removeFile" data-filename="${file.name}">
          <iconify-icon icon="heroicons:x-mark" class="text-sm"></iconify-icon>
        </button>
      </div>`;
  }
...
// app/javascript/controllers/update_recepient_controller.js
var update_recepient_controller_default = class extends Controller {
  static values = {
    recipientId: String
  };
  connect() {
    console.log("Update recepient controller....", this.recipientIdValue);
    if (this.recipientIdValue) {
      chat_channel_default(this.recipientIdValue);
    }
  }
};

// app/javascript/controllers/manager/client/set_company_id_controller.js
var set_company_id_controller_default = class extends Controller {
  static targets = ["modal", "companyIdInput", "companyIdError"];
  connect() {
  }
  showModal(event2) {
    this.currentClientId = event2.currentTarget.dataset.clientId;
    const currentCompanyId = event2.currentTarget.dataset.companyId || "";
    this.companyIdInputTarget.value = currentCompanyId;
    this.clearError();
    this.modalTarget.classList.remove("hidden");
  }
  saveCompanyId(event2) {
    event2.preventDefault();
    const companyId = this.companyIdInputTarget.value.trim();
    if (!companyId) {
      this.showError("Company ID can\u2019t be blank");
      return;
    }
    fetch(`/managers/clients/${this.currentClientId}/set_company_id`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "Accept": "text/vnd.turbo-stream.html",
  ...
  showError(message) {
    this.companyIdErrorTarget.textContent = message;
    this.companyIdErrorTarget.classList.remove("hidden");
  }
  clearError() {
    this.companyIdErrorTarget.textContent = "";
    this.companyIdErrorTarget.classList.add("hidden");
  }
  hideModal() {
    this.modalTarget.classList.add("hidden");
  }
...
application.register("document-upload", document_upload_controller_default);
application.register("document", document_controller_default);
application.register("confirm-delete", confirm_delete_controller_default);
application.register("client-modal", client_modal_controller_default);
application.register("group", group_controller_default);
application.register("users-edit", users_edit_controller_default);
application.register("client-edit", client_edit_controller_default);
application.register("admin--supervisor--allocate-manager", allocate_manager_controller_default);
application.register("admin--data-entry-operator--allocate-users", allocate_users_controller_default);
application.register("admin--client--allocate-users", allocate_users_controller_default2);
application.register("add-user", add_user_controller_default);
application.register("supervisors--assign-deo", assign_deo_controller_default);
application.register("manager--data-entry-operator--allocate-supervisor", allocate_supervisor_controller_default);
application.register("manager--client--allocate-supervisor-deo", allocate_supervisor_deo_controller_default);
application.register("permissions-modal", permissions_modal_controller_default);
application.register("groups-modal", groups_modal_controller_default);
application.register("flatpickr", flatpickr_controller_default);
application.register("document-bulk-update", document_bulk_update_controller_default);
application.register("message", message_controller_default);
application.register("client--message", message_controller_default2);
application.register("update-recepient", update_recepient_controller_default);
application.register("manager--client--set-company-id", set_company_id_controller_default);
...
// app/javascript/controllers/flash_dismiss.js
document.addEventListener("DOMContentLoaded", () => {
  const flashNotice = document.querySelector(".bg-green-100.border-green-400.text-green-700");
  const flashAlert = document.querySelector(".bg-red-100.border-red-400.text-red-700");
