...
<section class="bg-white dark:bg-black flex flex-wrap min-h-[calc(100vh-64px)]">
    ...
    <div class="lg:w-3/5 lg:block hidden">
        <div class="flex items-center justify-center h-full bg-white dark:bg-black">
            <img src="<?php echo e(asset('assets/images/light-logo_login.svg')); ?>" alt="Balantro"
                class="w-96 h-auto block dark:hidden">
            <img src="<?php echo e(asset('assets/images/dark-logo_login.svg')); ?>" alt="Balantro"
        ...
        <div class="w-full max-w-md mx-auto px-4 sm:px-6 flex flex-col items-center">
            <div class="w-[350px] max-w-full text-center">
                ...
                <p class="mb-6 text-sm text-gray-600 dark:text-gray-300">
                    ...
                    <strong class="font-medium text-gray-900 dark:text-white"><?php echo e($email); ?></strong>
                </p>
                ...
                <div class="mb-4 flex items-start gap-3 rounded-lg px-4 py-3 text-left text-sm text-green-600 dark:text-green-400 bg-green-50 dark:bg-gray-900">
                    ...
                    <div class="flex-1 leading-relaxed"><?php echo e(session('status')); ?></div>
                </div>
                <?php endif; ?>
            ...
            <form method="POST" action="<?php echo e(route('registration.otp.verify')); ?>">
                <?php echo csrf_field(); ?>
            ...
            <form method="POST" action="<?php echo e(route('registration.otp.resend')); ?>" class="mt-6 sm:mt-3 text-center text-sm">
                <?php echo csrf_field(); ?>
            ...
            <a href="<?php echo e(route('register')); ?>" class="mt-4 inline-flex items-center gap-1 text-sm text-gray-500 hover:text-[#22d3ee] dark:text-gray-400">
