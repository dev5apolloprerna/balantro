<div class="flex flex-col h-full bg-white dark:bg-neutral-800" data-controller="message">
    <div
        ...
        <a href="<?php echo e(route('manager.messages.index')); ?>"
        ...
        <div class="flex items-center gap-3 flex-1 min-w-0">
            <div class="avatar-lg object-fit-cover rounded-full bg-primary-500 text-white flex items-center justify-center flex-shrink-0"
                ...
                <?php echo e(strtoupper(substr($selectedClient->name, 0, 1))); ?>

            </div>
            <div class="flex-1 min-w-0">
                <h5 class="text-lg font-semibold mb-0 text-neutral-800 dark:text-white truncate">
                    <?php echo e($selectedClient->name); ?></h5>
            </div>
        </div>
    </div>

    <!-- Messages -->
    <div class="flex-1 overflow-y-auto p-4 bg-white dark:bg-neutral-800 messageBox-<?php echo e(request('client_id')); ?>"
            ...
            <?php if($messages && $messages->count() > 0): ?>
                ...
                <div class="space-y-3">
                    <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php $currentMessageDate = $message->created_at->toDateString(); ?>
                        <?php if($lastMessageDate != $currentMessageDate): ?>
                            <div class="flex justify-center my-4">
                                <span
                                    class="px-3 py-1 text-xs bg-neutral-200 dark:bg-neutral-700 text-neutral-700 dark:text-neutral-300 rounded-full">
                                    <?php if($currentMessageDate == now()->toDateString()): ?>
                                        <?php echo e(__('chat.messages.today')); ?>

                                    <?php elseif($currentMessageDate == now()->subDay()->toDateString()): ?>
                                        <?php echo e(__('chat.messages.yesterday')); ?>

                                    <?php else: ?>
                                        <?php echo e($message->created_at->format('F j, Y')); ?>
                        ...
                        <?php echo $__env->make('manager.messages.mobile_message', [
                            'message' => $message,
            ...
            <?php else: ?>
                <div class="flex flex-col items-center justify-center h-full text-center py-10 px-6">
                    ...
                    <h3 class="text-xl font-medium text-neutral-800 dark:text-white mb-2">
                        <?php echo e(__('chat.messages.no_messages.title')); ?>

                    </h3>
                    <p class="text-neutral-600 dark:text-neutral-300 text-sm">
                        <?php echo e(__('chat.messages.no_messages.description', ['name' => $selectedClient->name])); ?>
    ...
    <div class="border-t border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 p-3" id="message_form">
        <form action="<?php echo e(route('manager.messages.store')); ?>" method="POST" class="flex flex-col gap-2"
            ...
            <input type="hidden" name="is_first_message" value="<?php echo e(!$messages->count()); ?>">
            ...
            <div class="flex items-center gap-2">
                ...
                <button type="button"
                    ...
                    data-action="click->message#triggerFileInput" title="<?php echo e(__('chat.messages.file_input.attach')); ?>">
                ...
                <div class="flex-1 relative">
                    <input type="text" name="description"
                        ...
                        autocomplete="off" placeholder="<?php echo e(__('chat.messages.input.placeholder')); ?>"
...
<?php /**PATH D:\xampp\htdocs\balantro\resources\views\managers\messages\_mobile_chat_content.blade.php ENDPATH**/ ?>