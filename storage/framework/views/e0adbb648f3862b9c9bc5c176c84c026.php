                        ...
                        <table class="min-w-full text-sm text-left text-gray-600 dark:text-gray-200">
                            ...
                            <tbody class="divide-y">
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-neutral-700">
                                    ...
                                    <td class="px-4 py-3">
                                        <a href="<?php echo e(route('data_entry_operators.bulkuploadcompletelist')); ?>" class="text-green-600 font-semibold">
                                            Complete
                                        </a>
                                    </td>
...
<?php echo $__env->make('layouts.super_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\balantro\resources\views\admin\data_entry_operators\bulkuploadpurchase.blade.php ENDPATH**/ ?>