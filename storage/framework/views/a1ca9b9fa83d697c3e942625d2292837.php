                        ...
                        <table class="min-w-full text-sm text-left text-gray-600 dark:text-gray-200">
                            ...
                            <thead class="bg-gray-200 dark:bg-neutral-700 text-gray-600 dark:text-gray-200 text-xs uppercase">
                                <tr>
                                    ...
                                    <th class="px-2 py-1 ">Sr.No.</th>
                                    <th class="px-2 py-1">File Name</th>
                                    <th class="px-2 py-1">Type</th>
                                    <th class="px-2 py-1">Statement Date</th>
                                    <th class="px-2 py-1">Synced Date</th>
                                    <th class="px-2 py-1">Total</th>
                                    <th class="px-2 py-1">Pending</th>
                                    <th class="px-2 py-1">Saved</th>
                                    <th class="px-2 py-1">Synced</th>
                            ...
                            <tbody class="divide-y">
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-neutral-700">
                                    ...
                                    <td class="px-2 py-1"><?php echo e($loop->iteration); ?></td>

                                    <td class="px-2 py-1 font-medium text-gray-700 dark:text-gray-200">
                                    ...
                                    <td class="px-2 py-1 text-right flex justify-end gap-4">
...
<?php echo $__env->make('layouts.super_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\balantro\resources\views\admin\data_entry_operators\bulkuploadsales.blade.php ENDPATH**/ ?>