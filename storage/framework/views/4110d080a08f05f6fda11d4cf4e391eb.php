<div class="flex flex-col h-full bg-white dark:bg-neutral-800" data-controller="client-selection">
    <input type="hidden" name="selection_mode" value="<?php echo e($selection_mode ?? false); ?>"
    ...
    <div class="chat-search w-full relative px-4 py-3 border-b border-neutral-200 dark:border-neutral-700">
        ...
        <form action="<?php echo e(route('supervisor.messages.index')); ?>" method="GET" data-turbo-frame="mobile_chat"
            ...
            <input type="text" name="search" value="<?php echo e(request('search')); ?>"
                ...
                autocomplete="off" placeholder="Search clients...">
        </form>
    </div>
        ...
        <?php if($clients->count() > 0): ?>
            <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex items-center gap-3 px-4 py-3 hover:bg-neutral-100 dark:hover:bg-neutral-700 cursor-pointer"
                    ...
                    data-client-selection-client-id-value="<?php echo e($client->client_user_id); ?>">
                    <div class="flex items-center gap-2 w-full" data-controller="update-recepient"
                        data-update-recepient-recipient-id-value="<?php echo e($client->client_user_id); ?>">
                        <div class="flex items-center justify-center w-5 h-5 rounded border border-neutral-300 dark:border-neutral-500 bg-white dark:bg-neutral-700 mr-2 shrink-0 transition-all duration-200 relative <?php echo e($selection_mode ? '' : 'hidden'); ?>"
                            data-client-selection-target="checkbox">
                            <input type="checkbox" name="selected_clients[]" value="<?php echo e($client->client_user_id); ?>"
                        ...
                        <div class="avatar-lg object-fit-cover rounded-full bg-primary-500 text-white flex items-center justify-center"
                            ...
                            <?php echo e(strtoupper(substr($client->client_name, 0, 1))); ?>

                        </div>
                        <div class="flex-1 min-w-0">
                            <div class="text-sm font-medium line-clamp-1"><?php echo e($client->client_name); ?></div>
    ...
    <div class="sticky bottom-0 z-10 p-4 bg-white dark:bg-neutral-800 border-t border-neutral-200 dark:border-neutral-700 <?php echo e($selection_mode ? '' : 'hidden'); ?>"
        data-client-selection-target="footer">
        <form action="<?php echo e(route('supervisor.messages.store')); ?>" method="POST" class="flex flex-col gap-2"
            ...
            <div id="selected-clients-fields" data-client-selection-target="selectedClientsFields">
                <?php if($selection_mode): ?>
                    <?php $__currentLoopData = $selectedClients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $clientId): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <input type="hidden" name="selected_clients[]" value="<?php echo e($clientId); ?>">
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php else: ?>
                    <input type="hidden" name="receiver_id" value="<?php echo e($selectedclient->client_user_id ?? ''); ?>">
                <?php endif; ?>
            </div>
            ...
            <div class="flex items-center gap-2">
                <input type="file" name="attachments[]" multiple class="hidden"
                    id="bulk-file-upload-input-mobile" data-message-target="fileInput"
                ...
                <button type="button"
                    ...
                    style="margin-top: -4px;" data-action="click->message#triggerFileInput" title="Attach files">
                ...
                <div class="flex-1 relative">
                    <textarea name="description" rows="1"
                        ...
                        placeholder="Type a message..." autocomplete="off" data-action="input->client-selection#autoResize"
                        data-message-target="input"></textarea>
...
<?php /**PATH D:\xampp\htdocs\balantro\resources\views\supervisors\messages\mobile_client_list.blade.php ENDPATH**/ ?>