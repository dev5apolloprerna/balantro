  ...
  <div class="relative p-4 w-full max-w-4xl max-h-full">
    <div class="relative bg-white dark:bg-dark-2 rounded-2xl shadow-lg">
      ...
      <div class="flex items-center justify-between p-4 md:p-5 border-b border-gray-200 dark:border-gray-600 rounded-t">
        <h6 class="font-semibold text-gray-900 dark:text-white"><?php echo e(__('admin.assign_permissions.modal.title')); ?></h6>
        <button type="button"
          ...
          <span class="sr-only"><?php echo e(__('admin.assign_permissions.modal.close_icon')); ?></span>
        </button>
      </div>
      <!-- Modal Body -->
      <form method="POST" action="#" class="p-4 md:p-5 space-y-4"
            data-action="submit->permissions-modal#save"
            data-permissions-modal-target="form">
        <?php echo csrf_field(); ?>
        <div data-permissions-modal-target="content">
        ...
        <div class="flex items-center justify-end gap-4 pt-4 mt-4 border-t border-gray-200 dark:border-gray-600 rounded-b">
          <button type="button"
            ...
            <?php echo e(__('admin.assign_permissions.modal.close_btn')); ?>
          ...
          <button type="submit"
            ...
            <?php echo e(__('admin.assign_permissions.modal.save_btn')); ?>
...
</div><?php /**PATH D:\xampp\htdocs\balantro\resources\views\admin\shared\permissions_modal.blade.php ENDPATH**/ ?>