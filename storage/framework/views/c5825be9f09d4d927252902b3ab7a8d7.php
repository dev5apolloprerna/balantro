...
<button type="button"
    ...
    class="block w-full cursor-pointer text-left focus-visible:rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 <?php echo e($class ?? ''); ?>">
    <span class="block truncate">
        <?php echo e($displayText); ?>

    </span>
</button><?php /**PATH D:\xampp\htdocs\balantro\resources\views/shared/_expandable_table_text.blade.php ENDPATH**/ ?>