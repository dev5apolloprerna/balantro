    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-24">
            <div class="flex items-center gap-3 cursor-pointer">
                <img src="<?php echo e(asset('images/logo-white.png')); ?>" alt="Balantro" class="h-8 w-auto hidden dark:block"
                    onerror="
      this.style.display = 'none';
      this.nextElementSibling.style.display = 'flex';
    " />
                <img src="<?php echo e(asset('images/logo-white.png')); ?>" alt="Balantro" class="h-8 w-auto block dark:hidden"
    ...
    <div id="mobile-menu"
        ...
        <div class="px-4 pt-6 pb-10 space-y-4">
            ...
            <div class="mt-8 pt-8 border-t border-white/10 flex flex-col gap-4">
                <a href="<?php echo e(route('login')); ?>" class="block text-center text-base font-medium text-slate-300">Log
                    in</a>
                <a href="#"
...
<?php /**PATH D:\xampp\htdocs\balantro\resources\views/includes/header.blade.php ENDPATH**/ ?>