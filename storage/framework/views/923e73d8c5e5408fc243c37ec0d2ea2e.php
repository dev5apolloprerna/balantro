<tr class="hover:bg-gray-50 dark:hover:bg-gray-700" data-entry-operator-id="<?php echo e($deo->id); ?>">
  <td class="px-4 py-3"><?php echo e($deo->name); ?></td>
  <td class="px-4 py-3"><?php echo e($deo->email); ?></td>
  <td class="px-4 py-3"><?php echo e($deo->managers->first()->name ?? '-'); ?></td>
  <?php if(false): ?>
    <td class="text-center flex space-x-2">
      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', App\Http\Controllers\Supervisors\DataEntryOperatorsController::class)): ?>
        <button type="button"
      ...
      <?php endif; ?>
      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('destroy', App\Http\Controllers\Supervisors\DataEntryOperatorsController::class)): ?>
        <form action="<?php echo e(route('supervisors.data_entry_operators.destroy', $deo)); ?>" method="POST">
          <?php echo csrf_field(); ?>
  ...
  <?php endif; ?>
</tr><?php /**PATH D:\xampp\htdocs\balantro\resources\views\supervisors\data_entry_operators\data_entry_operator.blade.php ENDPATH**/ ?>