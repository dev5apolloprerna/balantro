<a href="<?php echo e(route('managers.messages.index', ['client_id' => $client->id, 'search' => request('search')])); ?>" 
  ...
  <div class="flex items-center gap-3">
    ...
    <div class="flex-1 min-w-0">
      <div class="flex items-center justify-between">
        <div class="text-sm font-medium text-neutral-800 dark:text-neutral-200 truncate"><?php echo e($client->name); ?></div>
...
</a><?php /**PATH D:\xampp\htdocs\balantro\resources\views\managers\messages\_client.blade.php ENDPATH**/ ?>