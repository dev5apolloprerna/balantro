...
<div class="h-full bg-white border border-gray-200 rounded-2xl overflow-hidden flex flex-col chat-container dark:bg-gray-900 dark:border-gray-700">
    ...
    <div class="flex items-center justify-between px-4 py-3 border-b border-gray-200 bg-gray-50 dark:bg-gray-800 dark:border-gray-600">
        ...
        <!-- <div class="flex items-center gap-2">
            ...
            <?php if(isset($supportStaffUsers) && $supportStaffUsers->count() > 1): ?>
            <div class="relative">
                <button type="button" id="staffDropdownButton" 
                    ...
                    <span>To: <?php echo e($selected_user->name ?? 'Select'); ?></span>
                ...
                <div id="staffDropdown" 
                    ...
                    <?php $__currentLoopData = $supportStaffUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $staff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button type="button" class="staff-option w-full text-left px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-300"
                            ...
                            data-staff-name="<?php echo e($staff->name); ?>">
                        <div class="flex items-center gap-2">
                            <div class="w-2 h-2 rounded-full bg-blue-500"></div>
                            <?php echo e($staff->name); ?> (<?php echo e(ucfirst(str_replace('_', ' ', $staff->type))); ?>)
                        </div>
                    </button>
    ...
    <div id="chatScroll" class="flex flex-col p-4 overflow-y-auto flex-1 min-h-0 bg-white dark:bg-gray-900">
        ...
        <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php if($dayKey !== $prevDay): ?>
                <div class="my-4 flex justify-center">
                    <span
                        ...
                        <?php echo e(\Carbon\Carbon::parse($msg->created_at)->format('D, d M Y')); ?>
            ...
            <div class="mt-2 flex <?php echo e($isMe ? 'justify-end' : 'justify-start'); ?>">
                
                <?php if(!$isMe): ?>
                <div class="mr-2 mt-0.5 shrink-0">
                    <div class="w-7 h-7 rounded-full grid place-items-center text-[11px] font-semibold <?php echo e($badgeColor($msg, $isMe)); ?>">
                ...
                <div class="max-w-[78%] md:max-w-[66%] px-4 py-3 rounded-2xl leading-snug <?php echo e($bubbleColor($msg, $isMe)); ?>">
                    ...
                    <?php if($attCount): ?>
                        ...
                        <div class="<?php echo e($singleBigImage ? 'mt-2' : 'mt-3 grid grid-cols-2 gap-2'); ?>">
                            <?php $__currentLoopData = $attData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($a['isImg']): ?>
                                    <a href="<?php echo e($a['url']); ?>" target="_blank"
                                        ...
                                        <img src="<?php echo e($a['url']); ?>" alt="<?php echo e($a['name']); ?>" loading="lazy"
                                            class="w-full <?php echo e($singleBigImage ? 'max-h-[300px]' : 'h-28'); ?> object-cover">
                                    </a>
                                <?php elseif($a['isVid']): ?>
                                    <div class="overflow-hidden rounded-lg border border-gray-300 bg-gray-50 dark:border-gray-600 dark:bg-gray-800">
                                        <video src="<?php echo e($a['url']); ?>" preload="metadata"
                                            class="w-full <?php echo e($singleBigImage ? 'max-h-[300px]' : 'h-28'); ?> object-cover"
                                            controls></video>
                                    </div>
                                <?php else: ?>
                                    <a href="<?php echo e($a['url']); ?>" target="_blank"
                                        ...
                                        <span class="text-sm truncate max-w-[140px] text-gray-700 dark:text-gray-300"><?php echo e($a['name']); ?></span>
                                        <?php if($a['size']): ?>
                                            <span class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($fmtSize($a['size'])); ?></span>
                                        <?php endif; ?>
    ...
    <form id="clientChatForm" action="<?php echo e(route('client.messages.store')); ?>" method="POST"
        enctype="multipart/form-data" class="border-t border-gray-200 bg-gray-50 dark:bg-gray-800 dark:border-gray-600">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="to_user_id" id="to_user_id" value="<?php echo e($selected_user->id ?? ''); ?>">
        ...
        <div class="px-4 pb-4 pt-1 flex items-end gap-3">
            ...
            <div class="text-xs text-gray-500 dark:text-gray-400 mr-2 hidden" id="selectedStaffIndicator">
                To: <span id="selectedStaffName"><?php echo e($selected_user->name ?? ''); ?></span>
            </div>
...
<script>
    (function() {
        ...
        function initializeFileAttachments() {
            ...
            const attachId = 'client-attach-' + ('<?php echo e($selected_user->id ?? 'x'); ?>');
...
</script><?php /**PATH D:\xampp\htdocs\balantro\resources\views\__clients\messages\chat_content.blade.php ENDPATH**/ ?>