            ...
            <div class="shadow rounded-2xl overflow-hidden">
                <div class="">
                    <div id="manager-table" class="overflow-x-auto">
                        <?php echo $__env->make('admin.groups.group_table', [
                            'groups' => $groups,
                    ...
                    <?php echo $__env->make('admin.groups.edit_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php echo $__env->make('admin.managers.permissions_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    
                    <?php echo $__env->make('admin.groups.create_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

                    <?php if($groups->count()): ?>
                        <div class="mt-4">
                            <?php echo e($groups->links('pagination::tailwind')); ?>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        function openEditModal(id, name, email) {
            ...
            setAction(form, "<?php echo e(route('groups.update', ':id')); ?>", id);
        ...
        function openPermissionsModal(id) {
            ...
            setAction(form, "<?php echo e(route('groups.assignPermissions', ':id')); ?>", id);

            const list = document.getElementById('permissionsList');
            list.innerHTML = '<div class="text-sm text-neutral-300">Loading…</div>';

            fetch("<?php echo e(route('groups.getPermissions', ':id')); ?>".replace(':id', id), {
                    headers: {
    ...
    `;
        ...
        const routes = {
            destroy: "<?php echo e(url('admin/groups')); ?>/__ID__",
        };
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\xampp\htdocs\balantro\resources\views\admin\groups\group_list.blade.php ENDPATH**/ ?>