<div class="container mx-auto" data-controller="manager--client--allocate-supervisor-deo manager--client--set-company-id">
  <div class="flex justify-between items-center mb-6">
    <h6 class="font-semibold mb-0 dark:text-white"><?php echo e(__('managers.clients.index.title')); ?></h6>
  </div>
        ...
        <div class="card-header border-b border-neutral-200 dark:border-neutral-600 bg-white dark:bg-neutral-700 p-4 sm:p-6">
          <div class="flex flex-col gap-3">
            <div class="flex flex-col sm:flex-row gap-3 w-full">
              <form method="GET" action="<?php echo e(route('managers.clients.index')); ?>" class="w-full">
                <?php echo csrf_field(); ?>
                <div class="flex flex-col md:flex-row md:flex-wrap gap-3 w-full">
                  ...
                  <div class="w-full md:w-[calc(50%-0.375rem)] lg:w-[250px]">
                    <select name="supervisor_id"
                      ...
                      <option value=""><?php echo e(__('dropdowns.supervisor')); ?></option>
                      <?php $__currentLoopData = $supervisors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supervisor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($supervisor->id); ?>" <?php echo e(request()->supervisor_id == $supervisor->id ? 'selected' : ''); ?>>
                  ...
                  <div class="w-full md:w-[calc(50%-0.375rem)] lg:w-[250px]">
                    <select name="data_entry_operator_id"
                      ...
                      <?php $__currentLoopData = $data_entry_operators; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($deo->id); ?>" <?php echo e(request()->data_entry_operator_id == $deo->id ? 'selected' : ''); ?>>
                          <?php echo e($deo->name); ?>
                  ...
                  <?php if(request()->query || request()->supervisor_id || request()->data_entry_operator_id): ?>
                    <a href="<?php echo e(route('managers.clients.index')); ?>"
        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="table bordered-table mb-0">
              <thead>
                <tr>
                  <th scope="col"><?php echo e(__('managers.clients.index.table_headers.name')); ?></th>
                  <th scope="col"><?php echo e(__('managers.clients.index.table_headers.email')); ?></th>
                  <th scope="col"><?php echo e(__('managers.clients.index.table_headers.supervisor')); ?></th>
                  <th scope="col"><?php echo e(__('managers.clients.index.table_headers.data_entry_operator')); ?></th>
                  <th scope="col"><?php echo e(__('managers.clients.index.table_headers.company_id')); ?></th>
                  <th scope="col" class="!text-center"><?php echo e(__('managers.clients.index.table_headers.actions')); ?></th>
                </tr>
              </thead>
              <tbody>
                <?php if($clients && $clients->count()): ?>
                  <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php echo $__env->make('managers.clients.client', ['client' => $client], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php else: ?>
                  <tr>
                    <td colspan="6" class="px-6 py-12 text-center text-neutral-500 dark:text-neutral-400">
                      <div class="flex flex-col items-center justify-center">
                        <iconify-icon icon="heroicons-outline:document-magnifying-glass" class="text-4xl text-neutral-400 mb-3" title="<?php echo e(__('managers.clients.index.no_client_found.icon_title')); ?>"></iconify-icon>
                        <p class="text-lg font-medium mb-1"><?php echo e(__('managers.clients.index.no_client_found.message')); ?></p>
                      </div>
                    </td>
                  </tr>
                <?php endif; ?>
  ...
  <div id="setCompanyIdModal" data-manager--client--set-company-id-target="modal" class="hidden fixed top-0 right-0 left-0 z-50 flex justify-center items-center w-full overflow-x-hidden overflow-y-auto md:inset-0 h-screen bg-black/50 dark:bg-white/30">
    <?php echo $__env->make('managers.clients.set_company_id_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  </div>
</div><?php /**PATH D:\xampp\htdocs\balantro\resources\views\managers\clients\index.blade.php ENDPATH**/ ?>