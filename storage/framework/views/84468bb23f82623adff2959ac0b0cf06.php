...
<?php $__env->startSection('content'); ?>
    ...
    <section class="inner-hero-vh relative overflow-hidden">
        <div class="absolute inset-0 z-0 bg-[#02040a]">
            ...
            <div class="absolute top-1/4 left-1/4 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-[#34d399]/20 rounded-full blur-[120px] pointer-events-none animate-pulse"
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <div data-aos="fade-up">
                        <h3 class="text-2xl font-display font-bold text-white mb-6 border-b border-white/10 pb-4">GST &
                            Compliance</h3>
                        <div class="space-y-4">
                            ...
                            <a href="#"
                                ...
                                <div class="text-[10px] font-bold tracking-widest uppercase text-[#34d399] mb-2">Checklist
                                </div>
                                <h4 class="text-lg font-bold text-slate-200 group-hover:text-white mb-2">"GST for Business
                                    Owners: What Actually Matters"</h4>
                                <div
                                    class="text-sm font-medium text-slate-500 group-hover:text-[#34d399] flex items-center transition-colors">
                                    Download Resource <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                            ...
                            <a href="#"
                                class="group block p-6 rounded-2xl bg-white/[0.02] border border-white/10 hover:bg-white/[0.05] hover:border-[#34d399]/40 transition-all duration-300">
                                <div class="text-[10px] font-bold tracking-widest uppercase text-[#34d399] mb-2">Guide
                                </div>
                                <h4 class="text-lg font-bold text-slate-200 group-hover:text-white mb-2">GST return process
                                    explained</h4>
                                <div
                                    class="text-sm font-medium text-slate-500 group-hover:text-[#34d399] flex items-center transition-colors">
                                    Read Guide <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                                    </svg>
                            ...
                            <a href="#"
                                class="group block p-6 rounded-2xl bg-white/[0.02] border border-white/10 hover:bg-white/[0.05] hover:border-[#34d399]/40 transition-all duration-300">
                                <div class="text-[10px] font-bold tracking-widest uppercase text-[#34d399] mb-2">Article
                                </div>
                                <h4 class="text-lg font-bold text-slate-200 group-hover:text-white mb-2">Common GST
                                    mistakes to avoid</h4>
                                <div
                                    class="text-sm font-medium text-slate-500 group-hover:text-[#34d399] flex items-center transition-colors">
                    ...
                    <div data-aos="fade-up" data-aos-delay="100">
                        <h3 class="text-2xl font-display font-bold text-white mb-6 border-b border-white/10 pb-4">
                            Accounting Basics</h3>
                        <div class="space-y-4">
                            ...
                            <a href="#"
                                ...
                                <div class="text-[10px] font-bold tracking-widest uppercase text-balantro-primary mb-2">
                                    Process Guide</div>
                                <h4 class="text-lg font-bold text-slate-200 group-hover:text-white mb-2">How monthly
                                    closing works</h4>
                                <div
                                    class="text-sm font-medium text-slate-500 group-hover:text-balantro-primary flex items-center transition-colors">
                                    View Process <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                                    </svg>
                            ...
                            <a href="#"
                                class="group block p-6 rounded-2xl bg-white/[0.02] border border-white/10 hover:bg-white/[0.05] hover:border-balantro-primary/40 transition-all duration-300">
                                <div class="text-[10px] font-bold tracking-widest uppercase text-balantro-primary mb-2">PDF
                                    Manual</div>
                                <h4 class="text-lg font-bold text-slate-200 group-hover:text-white mb-2">Understanding P&L
                                    and cash flow</h4>
                                <div
                                    class="text-sm font-medium text-slate-500 group-hover:text-balantro-primary flex items-center transition-colors">
                                    Download Resource <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor"
                            ...
                            <a href="#"
                                ...
                                <div class="text-[10px] font-bold tracking-widest uppercase text-balantro-primary mb-2">
                                    Toolkit</div>
                                <h4 class="text-lg font-bold text-slate-200 group-hover:text-white mb-2">Reading financial
                                    reports effectively</h4>
                                <div
                                    class="text-sm font-medium text-slate-500 group-hover:text-balantro-primary flex items-center transition-colors">
                                    Access Toolkit <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                                    </svg>
                    ...
                    <div data-aos="fade-up" data-aos-delay="200">
                        <h3 class="text-2xl font-display font-bold text-white mb-6 border-b border-white/10 pb-4">Business
                            Control</h3>
                        <div class="space-y-4">
                            ...
                            <a href="#"
                                ...
                                <div class="text-[10px] font-bold tracking-widest uppercase text-[#a78bfa] mb-2">Article
                                </div>
                                <h4 class="text-lg font-bold text-slate-200 group-hover:text-white mb-2">Building financial
                                    discipline</h4>
                                <div
                            ...
                            <a href="#"
                                class="group block p-6 rounded-2xl bg-white/[0.02] border border-white/10 hover:bg-white/[0.05] hover:border-[#a78bfa]/40 transition-all duration-300">
                                <div class="text-[10px] font-bold tracking-widest uppercase text-[#a78bfa] mb-2">Checklist
                                </div>
                                <h4 class="text-lg font-bold text-slate-200 group-hover:text-white mb-2">Avoiding
                                    compliance chaos</h4>
                                <div
                                    class="text-sm font-medium text-slate-500 group-hover:text-[#a78bfa] flex items-center transition-colors">
                                    Download Checklist <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                                    </svg>
                            ...
                            <a href="#"
                                class="group block p-6 rounded-2xl bg-white/[0.02] border border-white/10 hover:bg-white/[0.05] hover:border-[#a78bfa]/40 transition-all duration-300">
                                <div class="text-[10px] font-bold tracking-widest uppercase text-[#a78bfa] mb-2">Manual
                                </div>
                                <h4 class="text-lg font-bold text-slate-200 group-hover:text-white mb-2">Preparing
                                    gracefully for audits</h4>
                                <div
                                    class="text-sm font-medium text-slate-500 group-hover:text-[#a78bfa] flex items-center transition-colors">
                                    Read Manual <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                                    </svg>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\balantro\resources\views\frontend copy\guides.blade.php ENDPATH**/ ?>