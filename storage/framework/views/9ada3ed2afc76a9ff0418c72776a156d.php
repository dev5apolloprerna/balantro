                    ...
                    <div class="rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden group-block">
                        ...
                        <button type="button"
                            ...
                            <span class="flex flex-wrap gap-x-4 gap-y-1 text-xs md:text-sm text-black-600 dark:text-gray-300">
                                <span>Opening: <strong><?php echo e(abs($gOp) > 0 ? $inr(abs($gOp)) . ' ' . ($gOp < 0 ? 'Dr' : 'Cr') : '0.00'); ?></strong></span>
                                <span>Debit: <strong><?php echo e($inr($gDr)); ?></strong></span>
                                <span>Credit: <strong><?php echo e($inr($gCr)); ?></strong></span>
                                <span>Closing: <strong><?php echo e(abs($gCl) > 0 ? $inr(abs($gCl)) . ' ' . ($gCl < 0 ? 'Dr' : 'Cr') : '0.00'); ?></strong></span>
                            </span>
                        </button>
