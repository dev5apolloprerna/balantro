<div class="mb-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <!-- Uploaded Card -->
        <a href="<?php echo e(route('documents.index', ['status' => 'uploaded'])); ?>" class="block">
            <div class="stat-card bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border-l-4 border-blue-500">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo e($uploaded_count); ?></p>
        ...
        <!-- Completed Card -->
        <a href="<?php echo e(route('documents.index', ['status' => 'approved'])); ?>" class="block">
            <div class="stat-card bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border-l-4 border-green-500">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo e($completed_count); ?></p>
        ...
        <!-- Accepted Card -->
        <a href="<?php echo e(route('documents.index', ['status' => 'accepted'])); ?>" class="block">
            <div class="stat-card bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border-l-4 border-teal-500">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo e($accepted_count); ?></p>
        ...
        <!-- In-progress Card -->
        <a href="<?php echo e(route('documents.index', ['status' => 'data_entry_in_progress'])); ?>" class="block">
            <div class="stat-card bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border-l-4 border-yellow-500">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-3xl font-bold text-gray-900 dark:text-white">
                            <?php echo e($data_entry_in_progress_count); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-6">
        <!-- Data Entered Card -->
        <a href="<?php echo e(route('documents.index', ['status' => 'data_entry_completed'])); ?>" class="block">
            <div class="stat-card bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border-l-4 border-indigo-500">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo e($data_entered_count); ?></p>
        ...
        <!-- Query Raised Card -->
        <a href="<?php echo e(route('documents.index', ['status' => 'query_raised'])); ?>" class="block">
            <div class="stat-card bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border-l-4 border-orange-500">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo e($query_raised_count); ?></p>
        ...
        <!-- Query Resolved Card -->
        <a href="<?php echo e(route('documents.index', ['status' => 'query_resolved'])); ?>" class="block">
            <div class="stat-card bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border-l-4 border-purple-500">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo e($query_resolved_count); ?></p>
        ...
        <!-- Rejected Card -->
        <a href="<?php echo e(route('documents.index', ['status' => 'rejected'])); ?>" class="block">
            <div class="stat-card bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border-l-4 border-red-500">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo e($rejected_count); ?></p>
...
<?php /**PATH D:\xampp\htdocs\balantro\resources\views\data_entry_operator_dashboard\dashboard\document_count.blade.php ENDPATH**/ ?>