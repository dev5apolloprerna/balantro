<div class="container mx-auto" data-controller="manager--data-entry-operator--allocate-supervisor">
  <div class="flex justify-between items-center mb-6">
    <h6 class="font-semibold mb-0 dark:text-white"><?php echo e(__('managers.data_entry_operators.index.title')); ?></h6>
  </div>
      ...
      <div class="card !border-0 overflow-hidden">
        <div class="card-header border-b border-neutral-200 dark:border-neutral-600 bg-white dark:bg-neutral-700 p-4 sm:p-6">
          <div class="flex flex-col gap-3">
            <div class="flex flex-col sm:flex-row gap-3 w-full">
              <form method="GET" action="<?php echo e(route('managers.data_entry_operators.index')); ?>" class="w-full">
                <div class="flex flex-col sm:flex-row gap-3 w-full">
                  <div class="relative">
                  ...
                  <?php if(request()->query || request()->supervisor_id): ?>
                    <a href="<?php echo e(route('managers.data_entry_operators.index')); ?>" class="w-full sm:w-auto items-center btn border border-danger-600 bg-hover-danger-200 !text-danger-500 h-10 px-4 rounded-lg text-[16px] whitespace-nowrap justify-center cursor-pointer">
        ...
        <div class="card-body">
          <div id="data-entry-operators-table">
            <?php echo $__env->make('managers.data_entry_operators.data_entry_operator_table', ['data_entry_operators' => $data_entry_operators], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
          </div>
...
</div><?php /**PATH D:\xampp\htdocs\balantro\resources\views\managers\data_entry_operators\index.blade.php ENDPATH**/ ?>