...
<section class="inner-hero-vh relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 flex flex-col items-center text-center">
        ...
        <p
            ...
            Our insights are written from years of working inside real businesses not from textbooks. We focus on clarity,
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="flex flex-wrap gap-3 justify-center mb-16" data-aos="fade-up">
                ...
                <a href="<?php echo e(route('insights')); ?>"
                    class="px-5 py-2 rounded-full border <?php echo e(request('category') ? 'border-white/10 bg-white/5 text-slate-300 hover:bg-white/10 hover:text-white' : 'border-balantro-primary bg-balantro-primary/10 text-white hover:bg-balantro-primary/20'); ?> text-sm font-medium transition-all">All
                    Themes</a>
                ...
                <!-- <button
                    ...
                    <a href="<?php echo e(route('insights', ['category' => $category->slugname])); ?>"
                    class="px-5 py-2 rounded-full border <?php echo e(request('category') === $category->slugname ? 'border-balantro-primary bg-balantro-primary/10 text-white' : 'border-white/10 bg-white/5 text-slate-300 hover:bg-white/10 hover:text-white'); ?> text-sm font-medium transition-all">
