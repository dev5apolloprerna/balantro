            ...
            <div class="shadow rounded-2xl overflow-hidden">
                <div class="">
                    <div id="manager-table" class="overflow-x-auto">
                        <?php echo $__env->make('admin.managers.manager_table', [
                            'managers' => $managers,
                            'groups' => $groups,
                        ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <?php echo $__env->make('admin.managers.assign_groups_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> 
                    <?php echo $__env->make('admin.managers.edit_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php echo $__env->make('admin.managers.permissions_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    
                    <?php echo $__env->make('admin.managers.create_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

                    <?php if($managers->count()): ?>
                        <div class="mt-4 ">
                            <?php echo e($managers->links('pagination::tailwind')); ?>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        function openEditModal(id, name, email) {
            ...
            setAction(form, "<?php echo e(route('managers.update', ':id')); ?>", id);
        ...
        function openGroupsModal(id) {
            ...
            setAction(form, "<?php echo e(route('managers.assignGroups', ':id')); ?>", id);

            const list = document.getElementById('groupsList');
            list.innerHTML = '<div class="text-sm text-neutral-300">Loading…</div>';

            fetch("<?php echo e(route('managers.getGroups', ':id')); ?>".replace(':id', id), {
                    headers: {
      ...
      `;
        ...
        function openPermissionsModal(id) {
            ...
            setAction(form, "<?php echo e(route('managers.assignPermissions', ':id')); ?>", id);

            const list = document.getElementById('permissionsList');
            list.innerHTML = '<div class="text-sm text-neutral-300">Loading…</div>';

            fetch("<?php echo e(route('managers.getPermissions', ':id')); ?>".replace(':id', id), {
                    headers: {
                        'X-Requested-With': 'XMLHttpRequest'
                    }
                })
    ...
    `;
        ...
        const routes = {
            destroy: "<?php echo e(url('admin/managers')); ?>/__ID__",
        };
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\xampp\htdocs\balantro\resources\views\admin\managers\manager_list.blade.php ENDPATH**/ ?>