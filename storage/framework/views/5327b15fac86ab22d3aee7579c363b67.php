<?php if($message->sender == auth()->user() || $message->sender == $selectedClient): ?>
    <div class="flex <?php echo e($message->sender == auth()->user() ? 'justify-end' : 'justify-start'); ?>"
        ...
        <div class="flex max-w-[85%] gap-2">
            ...
            <div class="flex-1 flex flex-col <?php echo e($message->sender == auth()->user() ? 'items-end' : 'items-start'); ?>">
                            ...
                            <div
                                ...
                                <div class="flex-1 min-w-0">
                                    <div
                                        ...
                                        <?php echo e($document->file->file_name); ?></div>
                ...
                <?php if($message->description): ?>
                    <div
                        class="px-3 py-2 rounded-lg <?php echo e($message->sender == auth()->user() ? 'bg-primary-500 text-white rounded-br-none' : 'bg-neutral-100 dark:bg-neutral-700 text-neutral-800 dark:text-neutral-200 rounded-bl-none'); ?>">
                        <p class="mb-0 break-all overflow-wrap-anywhere text-sm"><?php echo e($message->description); ?></p>
                    </div>
                <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH D:\xampp\htdocs\balantro\resources\views\managers\messages\_mobile_message.blade.php ENDPATH**/ ?>