<div class="flex <?php echo e($message->sender_id === auth()->id() ? 'justify-end' : 'justify-start'); ?>" id="message-<?php echo e($message->id); ?>">
    <div class="flex max-w-[80%] gap-3">
        ...
        <div class="flex flex-col <?php echo e($message->sender_id === auth()->id() ? 'items-end' : 'items-start'); ?>">
            ...
            <?php if($message->description): ?>
                <div class="px-4 py-3 rounded-2xl <?php echo e($message->sender_id === auth()->id() ? 'bg-primary-500 text-white rounded-br-none' : 'bg-neutral-100 dark:bg-neutral-700 text-neutral-800 dark:text-neutral-200 rounded-bl-none'); ?> ">
                    <p class="mb-0 whitespace-pre-wrap break-all tracking-wide"><?php echo e($message->description); ?></p>
                </div>
            <?php endif; ?>
...
</div><?php /**PATH D:\xampp\htdocs\balantro\resources\views\client\_messages\message_block.blade.php ENDPATH**/ ?>