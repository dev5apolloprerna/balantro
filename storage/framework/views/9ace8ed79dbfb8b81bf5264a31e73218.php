...
<div class="container py-3">
    <div class="mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <!-- Completed Card -->
            <a href="<?php echo e(route('documents.index', ['status' => 'processing'])); ?>" class="block">
                <div class="stat-card bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border-l-4 border-green-500">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo e($in_progress_count); ?></p>
...
<?php /**PATH D:\xampp\htdocs\balantro\resources\views\client_dashboard\document_count.blade.php ENDPATH**/ ?>