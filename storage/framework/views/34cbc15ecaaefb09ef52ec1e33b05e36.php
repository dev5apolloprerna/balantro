...
<div
    ...
    <div
        ...
        <a href="<?php echo e(url()->previous()); ?>" class="p-2 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600"
            aria-label="Back">
        ...
        <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="mt-2 flex <?php echo e($isMe ? 'justify-end' : 'justify-start'); ?>">
                <div class="mr-2 mt-0.5 shrink-0">
                    <div
                        class="w-7 h-7 rounded-full grid place-items-center text-[11px] font-semibold <?php echo e($isMe ? 'bg-indigo-600 text-white' : 'bg-gray-500 text-white dark:bg-gray-600'); ?>">
                ...
                <div
                    class="max-w-[85%] px-4 py-3 rounded-2xl leading-snug <?php echo e($isMe ? 'bg-indigo-600 text-white rounded-br-md' : 'bg-gray-100 text-gray-800 border border-gray-200 rounded-bl-md dark:bg-gray-700 dark:text-gray-100 dark:border-gray-600'); ?>">

                    
                    <?php if(!empty($body)): ?>
                        <div class="flex items-end justify-between gap-2">
                            <p class="break-words flex-1 leading-relaxed"><?php echo e($body); ?></p>
                            <span
                                class="text-[10px] opacity-70 shrink-0 ml-2 whitespace-nowrap <?php echo e($isMe ? 'text-indigo-100' : 'text-gray-500 dark:text-gray-400'); ?>">
                    ...
                    <?php if($attCount): ?>
                            ...
                            <?php $__currentLoopData = $attData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($a['isImg']): ?>
                                    <a href="<?php echo e($a['url']); ?>" target="_blank"
                                        ...
                                        <img src="<?php echo e($a['url']); ?>" alt="<?php echo e($a['name']); ?>" loading="lazy"
                                            class="w-full <?php echo e($singleBigImage ? 'max-h-[200px]' : 'h-20'); ?> object-cover">
                                    </a>
                                <?php elseif($a['isVid']): ?>
                                    <div
                                ...
                                <?php else: ?>
                                    <a href="<?php echo e($a['url']); ?>" target="_blank"
                                        ...
                                        <span
                                            class="text-xs truncate text-gray-700 dark:text-gray-300"><?php echo e($a['name']); ?></span>
                                    </a>
                                <?php endif; ?>
                        ...
                        <div
                            class="text-[10px] opacity-70 text-right mt-2 <?php echo e($isMe ? 'text-indigo-100' : 'text-gray-500 dark:text-gray-400'); ?>">
                            <?php echo e(\Carbon\Carbon::parse($msg->created_at)->format('H:i')); ?>
    ...
    <div class="flex-shrink-0 p-4 border-t border-gray-200 bg-gray-50 dark:bg-gray-800 dark:border-gray-600">
        <form id="mobile-message-form" action="<?php echo e(route('client.messages.store')); ?>" method="POST"
            enctype="multipart/form-data" class="flex gap-3">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="to_user_id" value="<?php echo e($selected_user->id ?? ''); ?>">
...
<?php /**PATH D:\xampp\htdocs\balantro\resources\views\__clients\messages\mobile_chat_content.blade.php ENDPATH**/ ?>