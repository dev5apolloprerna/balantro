...
<script>
 function editRow(id) {
    ...
    function rowHtml(item = {}, index = '') {
        ...
        ledgers.forEach(l => {
            let selected = (l.name.trim() === (item.ledger_name || '').trim()) ? 'selected' : '';
    ...
    function initLedgerSelect() {
        ...
        // 👉 FORCE TEXT REFRESH (VERY IMPORTANT)
...
//     $('.debit').each(function() {
//         dr += parseFloat($(this).val()) || 0;
//     });

//     $('.credit').each(function() {
//         cr += parseFloat($(this).val()) || 0;
//     });
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.super_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\balantro\resources\views\admin\transaction-processing\journal\preview.blade.php ENDPATH**/ ?>