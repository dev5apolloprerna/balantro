<footer class="bg-balantro-secondary text-black pt-8 pb-6 border-t border-black/10 relative overflow-hidden z-10 font-sans">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-x-8 gap-y-12 mb-6">
            <div class="lg:col-span-4" data-aos="fade-up" data-aos-delay="100">
                <a href="<?php echo e(route('homeindex')); ?>" class="inline-flex items-center gap-2 mb-5 text-3xl font-bold font-display tracking-tight text-black">
            ...
            <div class="lg:col-span-3" data-aos="fade-up" data-aos-delay="200">
                ...
                <ul class="space-y-4">
                    <li>
                        <a href="<?php echo e(route('services')); ?>" class="text-black hover:translate-x-1 transition-all block text-sm font-bold">Accounting</a>
                        <span class="text-[11px] text-black/70 block mt-1 max-w-xs">Complete accounting operations, managed end to end</span>
                    </li>
                    <li>
                         <a href="<?php echo e(route('services')); ?>" class="text-black hover:translate-x-1 transition-all block text-sm font-bold">Compliance Management</a>
                        <span class="text-[11px] text-black/70 block mt-1 max-w-xs">GST, Income Tax, TDS, payroll & statutory compliance</span>
                    </li>
                    <li>
                        <a href="<?php echo e(route('services')); ?>" class="text-black hover:translate-x-1 transition-all block text-sm font-bold">Financial Reports & Insights</a>
            ...
            <div class="lg:col-span-2" data-aos="fade-up" data-aos-delay="300">
                ...
                <ul class="space-y-4 text-sm">
                    <li><a href="<?php echo e(route('company')); ?>" class="text-black hover:translate-x-1 transition-all block">About Us</a></li>
                    <li><a href="<?php echo e(route('company')); ?>" class="text-black hover:translate-x-1 transition-all block">Our Team</a></li>
                    <li><a href="<?php echo e(route('company')); ?>" class="text-black hover:translate-x-1 transition-all block">How We Work</a></li>
                    <li><a href="<?php echo e(route('insights')); ?>" class="text-black hover:translate-x-1 transition-all block">Insights & Blogs</a></li>
                    <li><a href="<?php echo e(route('faqs')); ?>" class="text-black hover:translate-x-1 transition-all block">FAQs</a></li>
        ...
        <div class="pt-4 border-t border-black/10 flex flex-col md:flex-row justify-between items-center gap-6 relative z-20">
            <div class="flex flex-wrap justify-center md:justify-start gap-x-6 gap-y-2 text-xs font-bold order-1">
                ...
                <a href="<?php echo e(route('privacypolicy')); ?>" class="hover:opacity-70">Privacy Policy +</a>
...
</footer><?php /**PATH D:\xampp\htdocs\balantro\resources\views/includes/footer.blade.php ENDPATH**/ ?>