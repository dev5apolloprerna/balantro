<?php $__env->startSection('title', $blog->metaTitle ?: $blog->title); ?>
...
<section class="inner-hero-vh relative overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
        ...
        <nav
            ...
            <a href="<?php echo e(route('homeindex')); ?>" class="hover:text-balantro-secondary transition-colors">Home</a>
            <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
            </svg>
            <a href="<?php echo e(route('insights')); ?>" class="hover:text-balantro-secondary transition-colors">Insights</a>
            <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
            </svg>
            <span class="text-slate-400 truncate"><?php echo e($blog->title); ?></span>
        </nav>
        ...
        <div class="flex flex-wrap items-center gap-3 mb-6 opacity-0 animate-[fadeInUp_0.8s_ease-out_0.1s_forwards]">
            ...
            <span class="text-slate-400 text-sm"><?php echo e($readingTime); ?> min read</span>
             <?php if($publishedDate): ?>
            <span class="text-slate-500 text-sm">·</span>
            <span class="text-slate-400 text-sm"><?php echo e($publishedDate); ?></span>
            <?php endif; ?>
        </div>
        ...
        <h1
            ...
            <!-- <span class="relative inline-block mt-2">
                ...
                <span class="relative text-transparent bg-clip-text bg-gradient-to-r from-white via-blue-100 to-white">Profits
...
<section class="pb-24 relative z-10">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex gap-12 items-start">
            ...
            <article class="flex-1 min-w-0 prose-article" data-aos="fade-up">
                ...
                <div
                    ...
                    <?php else: ?>
                        ...
                        <div class="relative z-10 text-center">
                            ...
                            <p class="text-white/60 font-display font-medium text-lg"><?php echo e($blog->title); ?></p>
                        </div>
                    <?php endif; ?>
                ...
                <div class="flex flex-wrap gap-2 mt-12 pt-8 border-t border-white/10">
                    ...
                    <a href="<?php echo e(route('insights', array_filter(['category' => $blog->category->slugname ?? null]))); ?>"
                        class="px-3 py-1 rounded-full text-xs bg-white/5 border border-white/10 text-slate-400 hover:text-white hover:border-white/20 transition-all"><?php echo e($categoryName); ?></a>
                </div>
            ...
            <aside class="hidden lg:block w-72 flex-shrink-0 sticky top-32 space-y-6">
                <!-- TOC -->
                <div class="p-6 rounded-2xl bg-white/[0.03] border border-white/10 backdrop-blur-md" data-aos="fade-left">
                    <h3
                        class="font-display font-bold text-white text-sm uppercase tracking-widest mb-4 flex items-center gap-2">
                        <svg class="w-4 h-4 text-balantro-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 10h16M4 14h8" />
                        </svg>
                        Table of Contents
                    </h3>
                    <p class="text-slate-400 text-sm leading-relaxed"><?php echo e($summary); ?></p>
                </div>

                <!-- Quick Stats -->
                <div
                    class="p-6 rounded-2xl bg-gradient-to-br from-balantro-primary/10 to-transparent border border-balantro-primary/20"
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-balantro-secondary font-semibold text-sm"><?php echo e($readingTime); ?> min</span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-slate-400 text-xs">Category</span>
                            <span class="text-white font-semibold text-sm"><?php echo e($categoryName); ?></span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-slate-400 text-xs">Published</span>
                            <span class="text-white font-semibold text-sm"><?php echo e($publishedMonth ?: '—'); ?></span>
                        </div>
                    </div>
                </div>
        ...
        <!-- CTA STRIP -->
        <div
            class="inner-section-vh mt-20 p-10 rounded-3xl bg-gradient-to-br from-balantro-primary/10 via-white/[0.02] to-balantro-secondary/5 border border-white/10 text-center"
            data-aos="fade-up">
