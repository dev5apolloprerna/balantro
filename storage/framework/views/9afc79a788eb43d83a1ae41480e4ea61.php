...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/scrollable-select.css')); ?>">
    <script defer src="<?php echo e(asset('js/scrollable-select.js')); ?>"></script>
...
<body class="font-sans antialiased h-full bg-white dark:bg-black text-gray-900 dark:text-gray-100">
    <?php if (! (View::hasSection('field_validation_only'))): ?>
    ...
    <script>
        ...
        setInterval(function() {
            ...
            if (idleTime >= 60) { // 60 minute
                $.post("<?php echo e(route('logout.idle')); ?>", {
