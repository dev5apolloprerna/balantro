<div id="editModal" class="hidden fixed inset-0 z-50">
    ...
    <div class="relative mx-auto mt-24 w-[720px] max-w-[95%] rounded-2xl bg-neutral-900 text-white shadow-xl">
        ...
        <form id="editForm" method="POST" class="px-6 py-5 space-y-5"> <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?> <div> <label
...
<?php /**PATH D:\xampp\htdocs\balantro\resources\views\admin\groups\edit_modal.blade.php ENDPATH**/ ?>