<tr class="hover:bg-gray-50 dark:hover:bg-gray-700 text-center" id="document-<?php echo e($document->id); ?>">
  ...
  <td class="px-4 py-3 relative">
    <div class="inline-flex group">
      <span class="<?php echo e(document_status_classes($document->status)); ?> px-2 py-1 rounded-full text-sm font-semibold cursor-default">
  ...
  <td class="px-4 py-3">
    <div class="flex items-center justify-center gap-2 flex-wrap sm:flex-nowrap whitespace-nowrap">
      <?php if($document->file): ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('doc_activities', App\Http\Controllers\Supervisors\DocumentsController::class)): ?>
          <a href="<?php echo e(route('supervisors.documents.activities', $document)); ?>"
             title="<?php echo e(__("admin.documents.table.activities_btn_title")); ?>"
        ...
        <?php endif; ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('download', App\Http\Controllers\Supervisors\DocumentsController::class)): ?>
          <a href="<?php echo e(route('supervisors.documents.download', $document)); ?>"
        ...
        <?php endif; ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('verify', App\Http\Controllers\Supervisors\DocumentsController::class)): ?>
          <button
...
</tr><?php /**PATH D:\xampp\htdocs\balantro\resources\views\supervisors\documents\document.blade.php ENDPATH**/ ?>