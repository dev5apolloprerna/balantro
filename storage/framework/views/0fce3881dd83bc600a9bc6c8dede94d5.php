                    ...
                    <a href="<?php echo e(route('deo.messages.index', ['client' => $c->id])); ?>"
                        ...
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 rounded-full bg-indigo-600 text-white grid place-items-center font-semibold flex-shrink-0">
                                <?php echo e(strtoupper(substr($c->name ?? 'U', 0, 2))); ?>

                            </div>
                            <div class="flex-1 min-w-0">
                                <div class="font-medium text-base truncate <?php echo e($isActive ? 'text-indigo-900 dark:text-indigo-100' : 'text-gray-900 dark:text-white'); ?>">
                                    <?php echo e($c->name ?? 'Unknown Client'); ?>

                                </div>
                                <?php if(!empty($c->last_message)): ?>
                                    <div class="text-sm truncate mt-1 <?php echo e($isActive ? 'text-indigo-700 dark:text-indigo-300' : 'text-gray-500 dark:text-gray-400'); ?>">
    ...
    <?php endif; ?>
        ...
        <div class="hidden md:grid md:grid-cols-12 gap-6 h-[calc(100vh-140px)]">
            <aside class="md:col-span-4 h-full overflow-hidden">
                <?php echo $__env->make('data_entry_operators.messages.client_list', [
                    'clients' => $clients ?? collect(),
                    'selected_client' => $selected_client ?? null,
                ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </aside>
...
<?php echo $__env->make('layouts.super_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\balantro\resources\views\data_entry_operators\messages\index.blade.php ENDPATH**/ ?>