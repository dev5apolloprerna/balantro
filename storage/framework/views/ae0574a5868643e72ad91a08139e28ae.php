...
<body>
    ...
    <!-- <div class="header">
        ...
        <div class="subtitle">Ledger #<?php echo e($ledgerName ?? ''); ?> • Period: <?php echo e($from ? date('d-m-Y', strtotime($from)) : ''); ?> to
            <?php echo e($to ? date('d-m-Y', strtotime($to)) : ''); ?></div>
    </div> -->
    <div class="header">
        ...
        <div class="subtitle" style="margin-top:4px;">
            <?php echo e($ledgerName ?? ''); ?>

        </div>

        <div class="subtitle">
            <?php echo e($from ? date('d-M-y', strtotime($from)) : ''); ?>

            to
            <?php echo e($to ? date('d-M-y', strtotime($to)) : ''); ?>
    ...
    <table>
        ...
        <tbody>
            <?php $__currentLoopData = $processedRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                ?>
                <tr class="<?php echo e($isSpecialRow ? 'special-row' : ''); ?>">
                    <td><?php echo e(!empty($row->strVchDate) ? date('d-m-Y', strtotime($row->strVchDate)) : ''); ?></td>
                    <td><?php echo e($row->vchNo ?? ''); ?></td>
                    <td><?php echo e($row->vchType ?? ''); ?></td>
                    <td><?php echo e($row->trnAccount ?? ''); ?></td>
                    <td class="text-right"><?php echo e(number_format($opening, 2)); ?> <?php echo e($openingSide); ?></td>
                    <td class="text-right"><?php echo e($isSpecialRow ? '0.00' : number_format($drAmount, 2)); ?></td>
                    <td class="text-right"><?php echo e($isSpecialRow ? '0.00' : number_format($crAmount, 2)); ?></td>
                    <td class="text-right"><?php echo e(number_format($closing, 2)); ?> <?php echo e($closingSide); ?></td>
	...
	<div class="summary-section">
        <table class="summary-table">
            <tr>
                ...
                <td class="summary-value"><?php echo e(number_format(abs($openingBalance), 2)); ?> <?php echo e($openingSide); ?></td>
            </tr>
            <tr>
                <td><strong>Total Debit:</strong></td>
                <td class="summary-value"><?php echo e(number_format(abs($totalDr), 2)); ?></td>
            </tr>
            <tr>
                <td><strong>Total Credit:</strong></td>
                <td class="summary-value"><?php echo e(number_format(abs($totalCr), 2)); ?></td>
            </tr>
            <tr>
                <td><strong>Closing Balance:</strong></td>
                <td class="summary-value"><?php echo e(number_format(abs($closingBalance), 2)); ?> <?php echo e($closingSide); ?></td>
            </tr>
            <?php
            ...
            <tr>
                ...
                <td class="summary-value">
                    <?php echo e(number_format(abs($difference), 2)); ?>

                    <?php echo e($difference < 0 ? 'Cr' : 'Dr'); ?>
...
<?php /**PATH D:\xampp\htdocs\balantro\resources\views\reports\pdf\voucher_history_pdf.blade.php ENDPATH**/ ?>