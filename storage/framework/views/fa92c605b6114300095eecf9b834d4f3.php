<div class="container mx-auto px-4 py-8">
    <div class="max-w-3xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            <h6 class="font-semibold mb-0 dark:text-white">Assign Permissions to <?php echo e($user->email); ?></h6>
            <a href="<?php echo e(route('admin.users.show', $user)); ?>" class="text-indigo-600 hover:text-indigo-900">Back to User</a>
        </div>

        <div class="bg-white shadow-md rounded-lg p-6">
            <form action="<?php echo e(route('admin.users.assign_permissions', $user)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="space-y-4">
                            ...
                            <div class="flex items-center">
                                <label class="ml-3 block text-sm font-medium text-gray-700">
                                    ...
                                    <span class="text-gray-500 text-xs ml-1">
                                        (<?php echo e($permission->action); ?> on <?php echo e($permission->subject); ?>)
                                    </span>
                                </label>
                            </div>
                            <div class="flex items-center">
                                <?php if($groupPermissionIds->contains($permission->id)): ?>
                                    <input type="checkbox" name="negative_permission_ids[]" value="<?php echo e($permission->id); ?>" 
                                           <?php if($deniedPermissions->contains($permission->id)): ?> checked <?php endif; ?>
...
</div><?php /**PATH D:\xampp\htdocs\balantro\resources\views\admin\users\assign_permissions.blade.php ENDPATH**/ ?>