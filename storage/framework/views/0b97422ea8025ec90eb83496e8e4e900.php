  ...
  <div class="font-sans w-full lg:w-1/2 py-8 px-4 sm:px-6 flex flex-col justify-center">
    <div class="w-full max-w-md mx-auto lg:max-w-[464px] px-4 sm:px-6">
      <div class="text-center">
        ...
        <p class="mb-6 text-secondary-light text-base sm:text-lg"><?php echo e(__('Sign In')); ?></p>
        <?php if($errors->any()): ?>
      ...
      <form method="POST" action="<?php echo e(route('login')); ?>">
        ...
        <div class="relative mb-4 sm:mb-6">
          <div class="icon-field relative">
            ...
            <input type="email" name="email" value="<?php echo e(old('email')); ?>" required autofocus autocomplete="email" placeholder="<?php echo e(__('Email')); ?>"
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-4 sm:mb-6 relative">
          <div class="icon-field relative mt-2">
            ...
            <input type="password" name="password" required autocomplete="current-password" placeholder="<?php echo e(__('Password')); ?>" id="your-password"
        ...
        <div class="mt-5 sm:mt-7">
          <div class="flex justify-between items-center w-full gap-4">
            <div class="flex items-center shrink-0">
              ...
              <label for="remember" class="ps-2 text-neutral-600 dark:text-white text-sm sm:text-base whitespace-nowrap"><?php echo e(__('Remember Me')); ?></label>
            </div>
            <?php if(Route::has('password.request')): ?>
              <a href="<?php echo e(route('password.request')); ?>" class="text-primary-600 font-medium hover:underline text-sm sm:text-base whitespace-nowrap text-right"><?php echo e(__('Forgot Your Password?')); ?></a>
            <?php endif; ?>
          </div>
        </div>
        
        <button type="submit" class="btn btn-primary justify-center h-11 sm:h-13 w-full text-sm mt-6 sm:mt-8 cursor-pointer"><?php echo e(__('Sign In')); ?></button>
      </form>
      ...
      <div class="mt-6 sm:mt-8 text-center text-sm">
        <p class="mb-0">
          ...
          <?php if(Route::has('register')): ?>
            <a href="<?php echo e(route('register')); ?>" class="text-primary-600 font-semibold hover:underline"><?php echo e(__('Sign Up')); ?></a>
          <?php endif; ?>
        </p>
      </div>
    </div>
...
</script><?php /**PATH D:\xampp\htdocs\balantro\resources\views\users\sessions\new.blade.php ENDPATH**/ ?>