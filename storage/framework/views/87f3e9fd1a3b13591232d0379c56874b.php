        ...
        <div class="w-full max-w-md sm:max-w-lg">
            ...
            <div
                ...
                <div class="p-5 sm:p-6">
                    <form method="POST" action="<?php echo e(route('password.update')); ?>" x-data="{ sh1: false, sh2: false }" novalidate>
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="relative">
                            ...
                            <input id="email" type="email" name="email" value="<?php echo e($email ?? old('email')); ?>"
                                required autocomplete="email" placeholder="Email" class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                        ...
                        <div class="mt-4">
                            ...
                            <div class="relative">
                                ...
                                <input :type="sh1 ? 'text' : 'password'" id="password" name="password" required
                                    autocomplete="new-password" placeholder="New password" class="<?php echo \Illuminate\Support\Arr::toCssClasses([
...
<?php echo $__env->make('layouts.mailer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\balantro\resources\views\auth\passwords\reset.blade.php ENDPATH**/ ?>