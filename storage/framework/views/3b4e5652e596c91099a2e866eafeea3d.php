        ...
        <div
            ...
            <a href="<?php echo e(route('insights')); ?>"
                ...
                <div class="relative z-10 flex flex-col h-full">
                    ...
                    <p class="text-slate-400 text-sm mb-6 flex-grow">Short reads on accounting, compliance, and business
                        discipline written for owners, not accountants.</p>
                    <div
                        class="font-medium text-balantro-primary flex items-center group-hover:translate-x-2 transition-transform duration-300">
                        Read Insights <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- <a href="<?php echo e(route('guides')); ?>" class="group relative flex flex-col p-8 rounded-3xl bg-white/[0.03] border border-white/10 backdrop-blur-md hover:bg-white/[0.06] hover:border-[#34d399]/30 transition-all duration-300 text-left overflow-hidden h-full min-h-[250px]">
            <div class="relative z-10 flex flex-col h-full">
              ...
              <p class="text-slate-400 text-sm mb-6 flex-grow">Step-by-step guides to help you understand GST, accounting, and compliance in real-world terms.</p>
              <div class="font-medium text-[#34d399] flex items-center group-hover:translate-x-2 transition-transform duration-300">
                Explore Guides <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
              </div>
            </div>
          </a> -->
            ...
            <a href="<?php echo e(route('faqs')); ?>"
                ...
                <div class="relative z-10 flex flex-col h-full">
                    ...
                    <p class="text-slate-400 text-sm mb-6 flex-grow">Clear responses to common questions business owners
                        actually ask.</p>
                    <div
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\balantro\resources\views/frontend/resources.blade.php ENDPATH**/ ?>