<div class="container mx-auto" data-controller="edit" data-edit-url-value="/supervisors/data_entry_operators">
  <div class="flex justify-between items-center mb-6">
    <h6 class="font-semibold mb-0 dark:text-white"><?php echo e(__('supervisors.data_entry_operators.index.title')); ?></h6>
  </div>
        ...
        <div class="card-header border-b border-neutral-200 dark:border-neutral-600 bg-white dark:bg-neutral-700 p-4 sm:p-6">
          <div class="flex flex-col gap-3">
            <div class="flex flex-col sm:flex-row gap-3 w-full">
              <form action="<?php echo e(route('supervisors.data_entry_operators.index')); ?>" method="GET" class="w-full">
                <?php echo csrf_field(); ?>
                <div class="flex flex-col sm:flex-row gap-3 w-full">
                  <div class="relative">
                  ...
                  <?php if(request()->has('query') || request()->has('manager_id')): ?>
                    <a href="<?php echo e(route('supervisors.data_entry_operators.index')); ?>"
        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="table bordered-table mb-0">
              <thead>
                <tr>
                  <th scope="col"><?php echo e(__('supervisors.data_entry_operators.index.table_headers.name')); ?></th>
                  <th scope="col"><?php echo e(__('supervisors.data_entry_operators.index.table_headers.email')); ?></th>
                  <th scope="col"><?php echo e(__('supervisors.data_entry_operators.index.table_headers.manager')); ?></th>
                  
                </tr>
              </thead>
              <tbody>
                <?php if($data_entry_operators->count() > 0): ?>
                  <?php $__currentLoopData = $data_entry_operators; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php echo $__env->make('supervisors.data_entry_operators.data_entry_operator', ['deo' => $deo], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php else: ?>
                  <tr>
                    <td colspan="4" class="px-6 py-12 text-center text-neutral-500 dark:text-neutral-400">
                      <div class="flex flex-col items-center justify-center">
                        <iconify-icon icon="heroicons-outline:document-magnifying-glass" class="text-4xl text-neutral-400 mb-3" title="<?php echo e(__('supervisors.data_entry_operators.index.no_operators_found.icon_title')); ?>"></iconify-icon>
                        <p class="text-lg font-medium mb-1"><?php echo e(__('supervisors.data_entry_operators.index.no_operators_found.message')); ?></p>
                      </div>
                    </td>
                  </tr>
                <?php endif; ?>
          ...
          <?php echo $__env->make('shared.confirm_delete_modal', ['resource_name' => __('supervisors.data_entry_operators.shared.confirm_delete.resource_name')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
</div><?php /**PATH D:\xampp\htdocs\balantro\resources\views\supervisors\data_entry_operators\index.blade.php ENDPATH**/ ?>