  ...
  <div class="font-sans w-full lg:w-1/2 py-8 px-4 sm:px-6 flex flex-col justify-center">
    <div class="w-full max-w-md mx-auto lg:max-w-[464px] px-4 sm:px-6">
      <div class="text-center lg:text-left">
        ...
        <h6 class="mb-3"><?php echo e(__('Forgot Your Password?')); ?></h6>
        <p class="mb-6 text-secondary-light text-base sm:text-lg"><?php echo e(__('Enter your email to receive reset instructions')); ?></p>
...
</section><?php /**PATH D:\xampp\htdocs\balantro\resources\views\users\passwords\forgot-password.blade.php ENDPATH**/ ?>