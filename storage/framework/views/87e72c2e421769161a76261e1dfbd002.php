<div class="container mx-auto">
  <div class="flex justify-between items-center mb-6">
    <h6 class="font-semibold mb-0 dark:text-white"><?php echo e(__("index.title")); ?></h6>
  </div>
        ...
        <div class="card-header border-b border-neutral-200 dark:border-neutral-600 bg-white dark:bg-neutral-700 p-4 sm:p-6">
          <div class="flex flex-col gap-3">
            <div class="flex flex-col sm:flex-row gap-3 w-full">
              <form action="<?php echo e(route('data_entry_operators.clients.index')); ?>" method="GET" class="w-full">
                <?php echo csrf_field(); ?>
                <div class="flex flex-col md:flex-row md:flex-wrap gap-3 w-full">
                  ...
                  <div class="w-full md:w-[calc(50%-0.375rem)] lg:w-[250px]">
                    <select name="supervisor_id" class="custom-select-arrow bg-white dark:bg-neutral-800 text-neutral-800 dark:text-neutral-100 h-10 px-4 !rounded-lg focus:outline-none border border-neutral-300 dark:border-neutral-600 focus:ring-1 focus:ring-primary-500 focus:border-primary-500 text-[16px] w-full cursor-pointer">
                      ...
                      <?php $__currentLoopData = $supervisors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supervisor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($supervisor->id); ?>" <?php echo e(request('supervisor_id') == $supervisor->id ? 'selected' : ''); ?>><?php echo e($supervisor->name); ?></option>
                  ...
                  <?php if(request('query') || request('supervisor_id') || request('manager_id')): ?>
                    <a href="<?php echo e(route('data_entry_operators.clients.index')); ?>" class="w-full sm:w-auto items-center btn border border-danger-600 bg-hover-danger-200 !text-danger-500 h-10 px-4 rounded-lg text-[16px] whitespace-nowrap justify-center cursor-pointer">
        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="table bordered-table mb-0">
              <thead>
                <tr>
                  <th scope="col"><?php echo e(__("table.headers.name")); ?></th>
                  <th scope="col"><?php echo e(__("table.headers.email")); ?></th>
                  <th scope="col"><?php echo e(__("table.headers.supervisors")); ?></th>
                  <th scope="col"><?php echo e(__("table.headers.managers")); ?></th>
                </tr>
              </thead>
              <tbody>
                <?php if($clients && $clients->count()): ?>
                  <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php echo $__env->make('data_entry_operators.clients.client_row', ['client' => $client], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php else: ?>
                  <tr>
                    <td colspan="4" class="px-6 py-12 text-center text-neutral-500 dark:text-neutral-400">
                      <div class="flex flex-col items-center justify-center">
                        ...
                        <p class="text-lg font-medium mb-1"><?php echo e(__("index.no_clients_found.title")); ?></p>
                        <p class="text-sm"><?php echo e(__("index.no_clients_found.description")); ?></p>
                      </div>
                    </td>
                  </tr>
                <?php endif; ?>
...
</div><?php /**PATH D:\xampp\htdocs\balantro\resources\views\data_entry_operators\clients\_client_list.blade.php ENDPATH**/ ?>