<ul class="space-y-1 px-2">
    ...
    <li>
        <a href="<?php echo e(route('manager.messages.index')); ?>" title="Chat"
            class="nav-item flex items-center p-3 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 <?php echo e(Route::is('manager.*') ? 'active bg-gray-200 dark:bg-gray-600' : ''); ?>">
            <i class="fas fa-comment-dots menu-icon  text-xl mr-3"></i>
            <span class="nav-text flex-1">Chat</span>
        </a>
    </li>
</ul>
<?php /**PATH D:\xampp\htdocs\balantro\resources\views/navigations/manager_nav.blade.php ENDPATH**/ ?>