                        ...
                        <table class="min-w-full text-sm text-gray-700 dark:text-gray-200">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                                ...
                                <tr class="hover:bg-gray-100 dark:hover:bg-neutral-700 transition duration-150">
                                    ...
                                    <td class="px-3 py-3"><?php echo e($key+1); ?></td>
                                    <td class="px-3 py-3"><?php echo e($row->date); ?></td>
                                    <td class="px-3 py-3"><?php echo e($row->invoice_no); ?></td>
                                    <td class="px-3 py-3 text-blue-600">Sales</td>
                                    <td class="px-3 py-3"><?php echo e($row->party_name); ?></td>
                                    <td class="px-3 py-3">07ACBPN3269K1ZD</td>
                                    <td class="px-3 py-3 text-blue-600">Gujarat</td>
                                    <td class="px-3 py-3">28</td>
                                    <td class="px-3 py-3 text-right"><?php echo e($row->amount); ?></td>
                                    <td>
                                        <select>
...
<?php echo $__env->make('layouts.super_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\balantro\resources\views\admin\bulkupload\sales\bulkuploadcompletelist.blade.php ENDPATH**/ ?>