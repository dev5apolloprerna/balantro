<div class="container mx-auto"
     ...
     data-document-url-value="<?php echo e(route('supervisors.documents.index')); ?>"
     data-document-current-page-value="<?php echo e(request('page', 1)); ?>"
     data-document-bulk-update-url-value="<?php echo e(route('supervisors.documents.bulk_update')); ?>"
     data-document-bulk-update-current-page-value="<?php echo e(request('page', 1)); ?>">
  <div class="flex justify-between items-center mb-6">
    <h6 class="font-semibold mb-0 dark:text-white"><?php echo e(__('supervisors.documents.index.title')); ?></h6>
  </div>
        ...
        <div class="card-header border-b border-neutral-200 dark:border-neutral-600 bg-white dark:bg-neutral-700 p-4 sm:p-6">
          <div class="flex flex-col gap-3">
            <div class="flex flex-col sm:flex-row gap-3 w-full">
              <form action="<?php echo e(route('supervisors.documents.index')); ?>" method="GET" class="w-full">
                <?php echo csrf_field(); ?>
                <div class="flex flex-col md:flex-row md:flex-wrap gap-3 w-full">
                  ...
                  <?php if(request()->has('client_id') || request()->has('status') || request()->has('start_date') || request()->has('end_date')): ?>
                    <a href="<?php echo e(route('supervisors.documents.index')); ?>"
        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="table bordered-table mb-0">
              <thead>
                <tr>
                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('bulk_update', App\Http\Controllers\Supervisors\DocumentsController::class)): ?>
                          ...
                          <div class="relative z-50">
                            ...
                            <div
                              ...
                              <ul class="rounded-lg bg-white dark:bg-neutral-700 shadow p-1 text-sm text-gray-700 dark:text-gray-200">
                                <?php
                                  $excluded_statuses = ['rejected', 'query_raised', 'query_resolved'];
                                  $available_statuses = array_diff(Document::getAvailableStatusesFor(auth()->user()), $excluded_statuses);
                                ?>
                                <?php $__currentLoopData = $available_statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <li>
                                    <button
                                      type="button"
                  ...
                  <?php endif; ?>
                  <th scope="col" class="text-center"><?php echo e(__('supervisors.documents.index.table_headers.document_name')); ?></th>
                  <th scope="col" class="text-center"><?php echo e(__("admin.documents.table.upload_date")); ?></th>
                  <th scope="col" class="text-center"><?php echo e(__('supervisors.documents.index.table_headers.client_name')); ?></th>
                  <th scope="col" class="text-center"><?php echo e(__('supervisors.documents.index.table_headers.status')); ?></th>
                  <th scope="col" class="!text-center"><?php echo e(__('supervisors.documents.index.table_headers.actions')); ?></th>
                </tr>
              </thead>
              <tbody id="<?php echo e(auth()->user()->role); ?>_doc_listing">
                <?php if($documents->count() > 0): ?>
                  <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php echo $__env->make('supervisors.documents.document', ['document' => $document], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php else: ?>
                  <tr>
                    <td colspan="6" class="px-6 py-12 text-center text-neutral-500 dark:text-neutral-400">
                      <div class="flex flex-col items-center justify-center">
                        <iconify-icon icon="heroicons-outline:document-magnifying-glass" class="text-4xl text-neutral-400 mb-3" title="<?php echo e(__('supervisors.documents.index.no_documents_found.icon_title')); ?>"></iconify-icon>
                        <p class="text-lg font-medium mb-1"><?php echo e(__('supervisors.documents.index.no_documents_found.message')); ?></p>
                        <p class="text-sm">
                          <?php echo e(__("admin.documents.table.no_documents_description")); ?>
...
</div><?php /**PATH D:\xampp\htdocs\balantro\resources\views\supervisors\documents\index.blade.php ENDPATH**/ ?>