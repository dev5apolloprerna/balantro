        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
            ...
            <div class="flex flex-wrap items-center gap-3 mb-6 opacity-0 animate-[fadeInUp_0.8s_ease-out_0.1s_forwards]">
                <span
                    ...
                    <?php echo e($blog->category->name ?? 'Insight'); ?>
            ...
            <?php if($relatedBlogs->count() > 0): ?>
                ...
                <div class="mt-24" data-aos="fade-up">
                    <div class="flex items-center justify-between mb-8">
                        ...
                        <a href="<?php echo e(route('insights', ['category' => $blog->category->slugname ?? ''])); ?>"
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\balantro\resources\views\frontend copy\insight-detail.blade.php ENDPATH**/ ?>